...
*     .. External Subroutines ..
      EXTERNAL           AB_DAXPY, AB_DSCAL, AB_DSYR2, AB_DTRMV, AB_DTRS
     $V, AB_XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX
...
*
     ...
     $                        LDA )
                  CALL AB_DSYR2( UPLO, N-K, -ONE, A( K, K+1 ), LDA,
...
*
     ...
     $ )
                  CALL AB_DSYR2( UPLO, N-K, -ONE, A( K+1, K ), 1,
...
*
     ...
     $                     LDB, A( 1, K ), 1 )
               ...
               CALL AB_DSYR2( UPLO, K-1, ONE, A( 1, K ), 1, B( 1, K ), 1
     $,
     $                     A, LDA )
               CALL AB_DAXPY( K-1, CT, B( 1, K ), 1, A( 1, K ), 1 )
...
*
     ...
     $                     A( K, 1 ), LDA )
               ...
               CALL AB_DSYR2( UPLO, K-1, ONE, A( K, 1 ), LDA, B( K, 1 ),
     $                     LDB, A, LDA )
               CALL AB_DAXPY( K-1, CT, B( K, 1 ), LDB, A( K, 1 ), LDA )
