...
*> This subroutine is called by AB_CGBRFSX to perform iterative refinement.
...
*     .. External Subroutines ..
      EXTERNAL           AB_CAXPY, AB_CCOPY, AB_CGBTRS, AB_CGBMV, BLAS_C
     $GBMV_X,
     $                   BLAS_CGBMV2_X, AB_CLA_GBAMV, AB_CLA_WWADDW, SLA
     $MCH,
