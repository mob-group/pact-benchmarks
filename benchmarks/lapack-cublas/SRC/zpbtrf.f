...
*     .. External Subroutines ..
      EXTERNAL           AB_XERBLA, AB_ZGEMM, AB_ZHERK, AB_ZPBTF2, AB_ZP
     $OTF2, AB_ZTRSM
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MIN
...
*                    Update A22
*
                     CALL AB_ZHERK( 'Upper', 'Conjugate transpose', I2, 
     $IB,
...
*                    Update A33
*
                     CALL AB_ZHERK( 'Upper', 'Conjugate transpose', I3, 
     $IB,
     $                           -ONE, WORK, LDWORK, ONE,
     $                           AB( KD+1, I+KD ), LDAB-1 )
*
...
*                    Update A22
*
                     CALL AB_ZHERK( 'Lower', 'No transpose', I2, IB, -ON
     $E,
...
*                    Update A33
*
                     CALL AB_ZHERK( 'Lower', 'No transpose', I3, IB, -ON
     $E,
