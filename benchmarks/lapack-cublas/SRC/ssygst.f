...
*     .. External Subroutines ..
      EXTERNAL           AB_SSYGS2, AB_SSYMM, AB_SSYR2K, AB_STRMM, AB_ST
     $RSM, AB_XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
...
*
     ...
     $                           A( K, K+KB ), LDA )
                     CALL AB_SSYR2K( UPLO, 'Transpose', N-K-KB+1, KB, -O
     $NE,
...
*
     ...
     $                           A( K+KB, K ), LDA )
                     CALL AB_SSYR2K( UPLO, 'No transpose', N-K-KB+1, KB,
...
*
     ...
     $                        LDA, B( 1, K ), LDB, ONE, A( 1, K ), LDA )
                  CALL AB_SSYR2K( UPLO, 'No transpose', K-1, KB, ONE,
...
*
     ...
     $                        LDA, B( K, 1 ), LDB, ONE, A( K, 1 ), LDA )
                  CALL AB_SSYR2K( UPLO, 'Transpose', K-1, KB, ONE,
