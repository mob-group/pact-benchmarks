*> \brief <b> AB_DSYEVR_2STAGE computes the eigenvalues and, optionally, the left and/or right eigenvectors for SY matrices</b>
*
...
*
*> \htmlonly
*> Download AB_DSYEVR_2STAGE + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_DSYEVr_2stage.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_DSYEVr_2stage.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_DSYEVr_2stage.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_DSYEVR_2STAGE( JOBZ, RANGE, UPLO, N, A, LDA, VL, VU,
...
*> \verbatim
*>
*> AB_DSYEVR_2STAGE computes selected eigenvalues and, optionally, eigenvectors
*> of a real symmetric matrix A using the 2stage technique for
*> the reduction to tridiagonal.  Eigenvalues and eigenvectors can be
*> selected by specifying either a range of values or a range of
*> indices for the desired eigenvalues.
*>
*> AB_DSYEVR_2STAGE first reduces the matrix A to tridiagonal form T with a call
*> to AB_DSYTRD.  Then, whenever possible, AB_DSYEVR_2STAGE calls AB_DSTEMR to compute
...
*>
*>
*> Note 1 : AB_DSYEVR_2STAGE calls AB_DSTEMR when the full spectrum is requested
*> on machines which conform to the ieee-754 floating point standard.
*> AB_DSYEVR_2STAGE calls AB_DSTEBZ and AB_SSTEIN on non-ieee machines and
...
*     .. External Functions ..
      ...
      EXTERNAL           AB_LSAME, AB_DLAMCH, AB_DLANSY, AB_ILAENV, AB_ILAE
     $NV2STAGE
*     ..
*     .. External Subroutines ..
      EXTERNAL           AB_DCOPY, AB_DORMTR, AB_DSCAL, AB_DSTEBZ, AB_DS
     $TEMR, AB_DSTEIN,
     $                   AB_DSTERF, AB_DSWAP, AB_DSYTRD_2STAGE, AB_XERBL
     $A
*     ..
*     .. Intrinsic Functions ..
...
*
      IEEEOK = AB_ILAENV( 10, 'AB_DSYEVR', 'N', 1, 2, 3, 4 )
*
...
*
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_DSYEVR_2STAGE', -INFO )
         RETURN
      ELSE IF( LQUERY ) THEN
         RETURN
      END IF
...
*
*
      CALL AB_DSYTRD_2STAGE( JOBZ, UPLO, N, A, LDA, WORK( INDD ), 
