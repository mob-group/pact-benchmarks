...
*
*> \htmlonly
*> Download AB_SGGSVP3 + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_SGGSVP3.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_SGGSVP3.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_SGGSVP3.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_SGGSVP3( JOBU, JOBV, JOBQ, M, P, N, A, LDA, B, LDB,
...
*> \verbatim
*>
*> AB_SGGSVP3 computes orthogonal matrices U, V and Q such that
*>
*>                    N-K-L  K    L
...
*>
*>  AB_SGGSVP3 replaces the deprecated subroutine AB_SGGSVP.
*>
*> \endverbatim
*>
*  =====================================================================
...
*     .. External Subroutines ..
      EXTERNAL           AB_SGEQP3, AB_SGEQR2, AB_SGERQ2, AB_SLACPY, AB_
     $SLAPMT,
...
*
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_SGGSVP3', -INFO )
         RETURN
      END IF
      IF( LQUERY ) THEN
         RETURN
