*> \brief <b> AB_DSBEVX_2STAGE computes the eigenvalues and, optionally, the left and/or right eigenvectors for OTHER matrices</b>
*
...
*
*> \htmlonly
*> Download AB_DSBEVX_2STAGE + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_DSBEVx_2stage.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_DSBEVx_2stage.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_DSBEVx_2stage.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_DSBEVX_2STAGE( JOBZ, RANGE, UPLO, N, KD, AB, LDAB, Q,
...
*> \verbatim
*>
*> AB_DSBEVX_2STAGE computes selected eigenvalues and, optionally, eigenvectors
...
*
      IF( INFO.EQ.0 ) THEN
         IF( N.LE.1 ) THEN
            ...
            WORK( 1 ) = LWMIN
         ELSE
            IB    = AB_ILAENV2STAGE( 2, 'AB_DSYTRD_SB2ST', JOBZ,
     $                            N, KD, -1, -1 )
            LHTRD = AB_ILAENV2STAGE( 3, 'AB_DSYTRD_SB2ST', JOBZ,
     $                            N, KD, IB, -1 )
            LWTRD = AB_ILAENV2STAGE( 4, 'AB_DSYTRD_SB2ST', JOBZ,
     $                            N, KD, IB, -1 )
...
*
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_DSBEVX_2STAGE ', -INFO )
         RETURN
      ELSE IF( LQUERY ) THEN
         RETURN
      END IF
