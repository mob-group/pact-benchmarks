...
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_DTPMQRT.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_DTPMQRT.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_DTPMQRT.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_DTPMQRT( SIDE, TRANS, M, N, K, L, NB, V, LDV, T, LDT,
...
*
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_DTPMQRT', -INFO )
         RETURN
      END IF
*
...
*
         DO I = 1, K, NB
            ...
            ELSE
               LB = MB-M+L-I+1
            END IF
            CALL AB_DTPRFB( 'L', 'T', 'F', 'C', MB, N, IB, LB,
     $                   V( 1, I ), LDV, T( 1, I ), LDT,
...
*
         DO I = 1, K, NB
            ...
            ELSE
               LB = MB-N+L-I+1
            END IF
            CALL AB_DTPRFB( 'R', 'N', 'F', 'C', M, MB, IB, LB,
     $                   V( 1, I ), LDV, T( 1, I ), LDT,
...
*
         ...
         DO I = KF, 1, -NB
            ...
            ELSE
               LB = MB-M+L-I+1
            END IF
            CALL AB_DTPRFB( 'L', 'N', 'F', 'C', MB, N, IB, LB,
     $                   V( 1, I ), LDV, T( 1, I ), LDT,
     $                   A( I, 1 ), LDA, B, LDB, WORK, IB )
         END DO
*
...
*
         ...
         DO I = KF, 1, -NB
            ...
            ELSE
               LB = MB-N+L-I+1
            END IF
            CALL AB_DTPRFB( 'R', 'T', 'F', 'C', M, MB, IB, LB,
     $                   V( 1, I ), LDV, T( 1, I ), LDT,
     $                   A( 1, I ), LDA, B, LDB, WORK, M )
         END DO
*
