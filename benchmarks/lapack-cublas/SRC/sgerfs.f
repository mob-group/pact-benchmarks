...
*
*> \htmlonly
*> Download AB_SGERFS + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_SGERfs.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_SGERfs.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_SGERfs.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_SGERFS( TRANS, N, NRHS, A, LDA, AF, LDAF, IPIV, B, LDB,
...
*> \verbatim
*>
*> AB_SGERFS improves the computed solution to a system of linear
...
*
*  =====================================================================
      SUBROUTINE AB_SGERFS( TRANS, N, NRHS, A, LDA, AF, LDAF, IPIV, B, L
     $DB,
     $                   X, LDX, FERR, BERR, WORK, IWORK, INFO )
*
