...
*
*> \htmlonly
*> Download AB_DGGSVP3 + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_DGGSVP3.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_DGGSVP3.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_DGGSVP3.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_DGGSVP3( JOBU, JOBV, JOBQ, M, P, N, A, LDA, B, LDB,
...
*> \verbatim
*>
*> AB_DGGSVP3 computes orthogonal matrices U, V and Q such that
*>
*>                    N-K-L  K    L
...
*>
*>  AB_DGGSVP3 replaces the deprecated subroutine AB_DGGSVP.
*>
*> \endverbatim
*>
*  =====================================================================
...
*     .. External Subroutines ..
      EXTERNAL           AB_DGEQP3, AB_DGEQR2, AB_DGERQ2, AB_DLACPY, AB_
     $DLAPMT,
...
*
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_DGGSVP3', -INFO )
         RETURN
      END IF
      IF( LQUERY ) THEN
         RETURN
