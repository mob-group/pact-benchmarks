*> \brief <b> AB_DSYEVX_2STAGE computes the eigenvalues and, optionally, the left and/or right eigenvectors for SY matrices</b>
*
...
*
*> \htmlonly
*> Download AB_DSYEVX_2STAGE + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_DSYEVx_2stage.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_DSYEVx_2stage.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_DSYEVx_2stage.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_DSYEVX_2STAGE( JOBZ, RANGE, UPLO, N, A, LDA, VL, VU,
...
*> \verbatim
*>
*> AB_DSYEVX_2STAGE computes selected eigenvalues and, optionally, eigenvectors
...
*     .. External Functions ..
      ...
      EXTERNAL           AB_LSAME, AB_DLAMCH, AB_DLANSY, AB_ILAENV2STAGE
*     ..
...
*
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_DSYEVX_2STAGE', -INFO )
         RETURN
      ELSE IF( LQUERY ) THEN
         RETURN
      END IF
