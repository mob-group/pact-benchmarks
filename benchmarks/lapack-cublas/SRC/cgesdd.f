...
*     .. External Subroutines ..
      EXTERNAL           AB_CGEBRD, AB_CGELQF, AB_CGEMM, AB_CGEQRF, AB_C
     $LACP2, AB_CLACPY,
...
*
            CALL AB_CGEQRF( M, N, CDUM(1), M, CDUM(1), CDUM(1), -1, IERR
     $ )
...
*
            CALL AB_CGELQF( M, N, CDUM(1), M, CDUM(1), CDUM(1), -1, IERR
     $ )
...
*              RWorkspace: need   0
*
               CALL AB_CGEQRF( M, N, A, LDA, WORK( ITAU ), WORK( NWORK )
     $,
     $                      LWORK-NWORK+1, IERR )
*
*              Zero out below R
...
*              RWorkspace: need   0
*
               CALL AB_CGELQF( M, N, A, LDA, WORK( ITAU ), WORK( NWORK )
     $,
     $                      LWORK-NWORK+1, IERR )
*
*              Zero out above L
