...
!  Name of specs%method
   if (ab_mover%ionmov==2) then
     specs%method = 'Broyden-FletAB_CHER-Goldfard-Shanno method (forces)'
   else
     specs%method = 'Broyden-FletAB_CHER-Goldfard-Shanno method (forces,Tot energy)'
   end if
!  Number of history
   specs%nhist = 3
...
!  Values use in XML Output
   ...
   specs%crit4xml='tolmxf'
!  Name of specs%method
   specs%method = 'Limited-memory Broyden-FletAB_CHER-Goldfard-Shanno method'
!  Number of history
   specs%nhist = 3
