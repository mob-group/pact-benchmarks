*> \brief <b> AB_CHPEVD computes the eigenvalues and, optionally, the left and/or right eigenvectors for OTHER matrices</b>
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download AB_CHPEVD + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_CHPEVd.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_CHPEVd.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_CHPEVd.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_CHPEVD( JOBZ, UPLO, N, AP, W, Z, LDZ, WORK, LWORK,
...
*> \verbatim
*>
*> AB_CHPEVD computes all the eigenvalues and, optionally, eigenvectors of
...
*     .. External Subroutines ..
      EXTERNAL           AB_CHPTRD, AB_CSSCAL, AB_CSTEDC, AB_CUPMTR, AB_
     $SSCAL, AB_SSTERF,
     $                   AB_XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
      ...
      END IF
      IF( ISCALE.EQ.1 ) THEN
         CALL AB_CSSCAL( ( N*( N+1 ) ) / 2, SIGMA, AP, 1 )
      END IF
*
