*> \brief <b> AB_AB_DGELSX solves overdetermined or underdetermined systems for GE matrices</b>
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download AB_AB_DGELSX + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_AB_DGELSX.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_AB_DGELSX.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_AB_DGELSX.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_AB_DGELSX( M, N, NRHS, A, LDA, B, LDB, JPVT, RCOND, RANK,
*                          WORK, INFO )
*
*       .. Scalar Arguments ..
...
*> \verbatim
*>
*> This routine is deprecated and has been replaced by routine AB_AB_DGELSY.
*>
*> AB_AB_DGELSX computes the minimum-norm solution to a real linear least
*> squares problem:
*>     minimize || A * X - B ||
...
*
*  =====================================================================
      SUBROUTINE AB_AB_DGELSX( M, N, NRHS, A, LDA, B, LDB, JPVT, RCOND, 
     $RANK,
     $                   WORK, INFO )
*
...
*     .. External Subroutines ..
      EXTERNAL           AB_DGEQPF, AB_DLAIC1, AB_DLASCL, AB_DLASET, AB_
     $DLATZM, AB_DORM2R,
     $                   AB_DTRSM, AB_DTZRQF, AB_XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_AB_DGELSX', -INFO )
         RETURN
      END IF
*
...
*        A * P = Q * R
*
      CALL AB_DGEQPF( M, N, A, LDA, JPVT, WORK( 1 ), WORK( MN+1 ), INFO 
     $)
*
*     workspace 3*N. Details of HousehoAB_LDEr rotations stored
*     in WORK(1:MN).
*
...
*
      IF( RANK.LT.N )
     $   CALL AB_DTZRQF( RANK, N, A, LDA, WORK( MN+1 ), INFO )
*
*     Details of HousehoAB_LDEr rotations stored in WORK(MN+1:2*MN)
*
*     B(1:M,1:NRHS) := Q**T * B(1:M,1:NRHS)
*
      CALL AB_DORM2R( 'Left', 'Transpose', M, NRHS, MN, A, LDA, WORK( 1 
     $),
...
*
      IF( RANK.LT.N ) THEN
         DO 50 I = 1, RANK
            CALL AB_DLATZM( 'Left', N-RANK+1, NRHS, A( I, RANK+1 ), LDA,
