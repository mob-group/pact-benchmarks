...
*
*> \htmlonly
*> Download AB_DGGSVP + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_DGGSVP.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_DGGSVP.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_DGGSVP.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_DGGSVP( JOBU, JOBV, JOBQ, M, P, N, A, LDA, B, LDB,
...
*> \verbatim
*>
*> This routine is deprecated and has been replaced by routine AB_DGGSVP3.
*>
*> AB_DGGSVP computes orthogonal matrices U, V and Q such that
*>
*>                    N-K-L  K    L
...
*  =====================
*>
*>  The subroutine uses LAPACK subroutine AB_DGEQPF for the QR factorization
...
*     .. External Subroutines ..
      EXTERNAL           AB_DGEQPF, AB_DGEQR2, AB_DGERQ2, AB_DLACPY, AB_
     $DLAPMT, AB_DLASET,
     $                   AB_DORG2R, AB_DORM2R, AB_DORMR2, AB_XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
      DO 10 I = 1, N
         IWORK( I ) = 0
   10 CONTINUE
      CALL AB_DGEQPF( P, N, B, LDB, IWORK, TAU, WORK, INFO )
*
*     Update A := A*P
*
...
*
         CALL AB_DGERQ2( L, N, B, LDB, TAU, WORK, INFO )
*
*        Update A := A*Z**T
*
...
*
      DO 70 I = 1, N - L
         IWORK( I ) = 0
   70 CONTINUE
      CALL AB_DGEQPF( M, N-L, A, LDA, IWORK, TAU, WORK, INFO )
*
...
*
         CALL AB_DGERQ2( K, N-L, A, LDA, TAU, WORK, INFO )
*
         IF( WANTQ ) THEN
*
...
*
         CALL AB_DGEQR2( M-K, L, A( K+1, N-L+1 ), LDA, TAU, WORK, INFO )
*
         IF( WANTU ) THEN
*
