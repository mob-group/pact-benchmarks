*> \brief <b> AB_SSYEVR computes the eigenvalues and, optionally, the left and/or right eigenvectors for SY matrices</b>
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download AB_SSYEVR + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_SSYEVr.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_SSYEVr.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_SSYEVr.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_SSYEVR( JOBZ, RANGE, UPLO, N, A, LDA, VL, VU, IL, IU,
...
*> \verbatim
*>
*> AB_SSYEVR computes selected eigenvalues and, optionally, eigenvectors
*> of a real symmetric matrix A.  Eigenvalues and eigenvectors can be
*> selected by specifying either a range of values or a range of
*> indices for the desired eigenvalues.
*>
*> AB_SSYEVR first reduces the matrix A to tridiagonal form T with a call
*> to AB_SSYTRD.  Then, whenever possible, AB_SSYEVR calls AB_SSTEMR to compute
...
*>
*>
*> Note 1 : AB_SSYEVR calls AB_SSTEMR when the full spectrum is requested
*> on machines which conform to the ieee-754 floating point standard.
*> AB_SSYEVR calls AB_SSTEBZ and AB_SSTEIN on non-ieee machines and
...
*     .. External Functions ..
      ...
      EXTERNAL           AB_LSAME, AB_ILAENV, SLAMCH, AB_SLANSY
*     ..
