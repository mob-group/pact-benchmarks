*> \brief <b> AB_SSTEVR computes the eigenvalues and, optionally, the left and/or right eigenvectors for OTHER matrices</b>
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download AB_SSTEVR + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_SSTEVr.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_SSTEVr.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_SSTEVr.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_SSTEVR( JOBZ, RANGE, N, D, E, VL, VU, IL, IU, ABSTOL,
...
*> \verbatim
*>
*> AB_SSTEVR computes selected eigenvalues and, optionally, eigenvectors
*> of a real symmetric tridiagonal matrix T.  Eigenvalues and
*> eigenvectors can be selected by specifying either a range of values
*> or a range of indices for the desired eigenvalues.
*>
*> Whenever possible, AB_SSTEVR calls AB_SSTEMR to compute the
...
*>
*>
*> Note 1 : AB_SSTEVR calls AB_SSTEMR when the full spectrum is requested
*> on machines which conform to the ieee-754 floating point standard.
*> AB_SSTEVR calls AB_SSTEBZ and AB_SSTEIN on non-ieee machines and
...
*     .. External Functions ..
      ...
      EXTERNAL           AB_LSAME, AB_ILAENV, SLAMCH, AB_SLANST
*     ..
...
*
      IEEEOK = AB_ILAENV( 10, 'AB_SSTEVR', 'N', 1, 2, 3, 4 )
*
