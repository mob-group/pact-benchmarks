...
*
*> \htmlonly
*> Download AB_AB_SGBRFSX + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_AB_SGBRFSX.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_AB_SGBRFSX.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_AB_SGBRFSX.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_AB_SGBRFSX( TRANS, EQUED, N, KL, KU, NRHS, AB, LDAB, AFB,
...
*> \verbatim
*>
*>    AB_AB_SGBRFSX improves the computed solution to a system of linear
...
*
*  =====================================================================
      SUBROUTINE AB_AB_SGBRFSX( TRANS, EQUED, N, KL, KU, NRHS, AB, LDAB,
     $ AFB,
     $                    LDAFB, IPIV, R, C, B, LDB, X, LDX, RCOND,
     $                    BERR, N_ERR_BNDS, ERR_BNDS_NORM,
     $                    ERR_BNDS_COMP, NPARAMS, PARAMS, WORK, IWORK,
...
*     .. External Functions ..
      ...
      EXTERNAL           AB_SLAMCH, AB_SLANGB, AB_SLA_GBRCOND
      REAL               AB_SLAMCH, AB_SLANGB, AB_SLA_GBRCOND
      LOGICAL            AB_LSAME
...
*
     ...
     $         .NOT.AB_LSAME( EQUED, 'N' ) ) THEN
      ...
      END IF
      IF( INFO.NE.0 ) THEN
        CALL AB_XERBLA( 'AB_AB_SGBRFSX', -INFO )
        RETURN
      END IF
*
