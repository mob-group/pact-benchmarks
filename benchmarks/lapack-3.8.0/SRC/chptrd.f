...
*     .. External Subroutines ..
      EXTERNAL           AB_CAXPY, AB_CHPMV, AB_CHPR2, AB_CLARFG, AB_XER
     $BLA
*     ..
*     .. External Functions ..
      LOGICAL            AB_LSAME
...
*
            ALPHA = AP( I1+I-1 )
            CALL AB_CLARFG( I, ALPHA, AP( I1 ), 1, TAUI )
            E( I ) = ALPHA
*
...
*                 A := A - v * w**H - w * v**H
*
               CALL AB_CHPR2( UPLO, I, -ONE, AP( I1 ), 1, TAU, 1, AP )
*
            END IF
            AP( I1+I-1 ) = E( I )
            D( I+1 ) = AP( I1+I )
...
*
            ALPHA = AP( II+1 )
            CALL AB_CLARFG( N-I, ALPHA, AP( II+2 ), 1, TAUI )
            E( I ) = ALPHA
*
            IF( TAUI.NE.ZERO ) THEN
*
...
*                 A := A - v * w**H - w * v**H
*
               CALL AB_CHPR2( UPLO, N-I, -ONE, AP( II+1 ), 1, TAU( I ), 
     $1,
     $                     AP( I1I1 ) )
*
            END IF
