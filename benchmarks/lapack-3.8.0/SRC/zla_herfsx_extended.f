*> \brief \b AB_ZLA_HERFSX_EXTENDED improves the computed solution to a system of linear equations for Hermitian indefinite matrices by performing extra-precise iterative refinement and provides error bounds and backward error estimates for the solution.
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download AB_ZLA_HERFSX_EXTENDED + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_ZLA_HERFSX_EXTENDED.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_ZLA_HERFSX_EXTENDED.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_ZLA_HERFSX_EXTENDED.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_ZLA_HERFSX_EXTENDED( PREC_TYPE, UPLO, N, NRHS, A, LDA,
...
*> \verbatim
*>
*> AB_ZLA_HERFSX_EXTENDED improves the computed solution to a system of
*> linear equations by performing extra-precise iterative refinement
*> and provides error bounds and backward error estimates for the solution.
*> This subroutine is called by AB_AB_AB_ZHERFSX to perform iterative refinement.
...
*
*  =====================================================================
      SUBROUTINE AB_ZLA_HERFSX_EXTENDED( PREC_TYPE, UPLO, N, NRHS, A, LD
     $A,
     $                                AF, LDAF, IPIV, COLEQU, C, B, LDB,
     $                                Y, LDY, BERR_OUT, N_NORMS,
     $                                ERR_BNDS_NORM, ERR_BNDS_COMP, RES,
...
*     .. External Subroutines ..
      EXTERNAL           AB_ZAXPY, AB_ZCOPY, AB_ZHETRS, AB_ZHEMV, BLAS_A
     $B_ZHEMV_X,
...
*
            ...
            IF ( Y_PREC_STATE .EQ. BASE_RESIDUAL ) THEN
               CALL AB_ZHEMV( UPLO, N, DCMPLX(-1.0D+0), A, LDA, Y( 1, J 
     $),
...
!         XXX: RES is no longer needed.
            ...
            CALL AB_ZHETRS( UPLO, N, 1, AF, LDAF, IPIV, DY, N, INFO )
*
