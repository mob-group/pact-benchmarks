*> \brief <b> AB_CGGSVD3 computes the singular value decomposition (SVD) for OTHER matrices</b>
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download AB_CGGSVD3 + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_CGGSVD3.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_CGGSVD3.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_CGGSVD3.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_CGGSVD3( JOBU, JOBV, JOBQ, M, N, P, K, L, A, LDA, B,
...
*> \verbatim
*>
*> AB_CGGSVD3 computes the generalized singular value decomposition (GSVD)
...
*  =====================
*>
*>  AB_CGGSVD3 replaces the deprecated subroutine AB_CGGSVD.
*>
*  =====================================================================
      SUBROUTINE AB_CGGSVD3( JOBU, JOBV, JOBQ, M, N, P, K, L, A, LDA, B,
...
*     .. External Subroutines ..
      EXTERNAL           AB_CGGSVP3, AB_CTGSJA, AB_SCOPY, AB_XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
*     ..
...
*
      IF( INFO.EQ.0 ) THEN
         CALL AB_CGGSVP3( JOBU, JOBV, JOBQ, M, P, N, A, LDA, B, LDB, TOL
     $A,
...
*
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_CGGSVD3', -INFO )
         RETURN
      END IF
      IF( LQUERY ) THEN
         RETURN
...
*
      CALL AB_CGGSVP3( JOBU, JOBV, JOBQ, M, P, N, A, LDA, B, LDB, TOLA,
     $              TOLB, K, L, U, LDU, V, LDV, Q, LDQ, IWORK, RWORK,
