...
*
*> \htmlonly
*> Download AB_DGEEVX + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_DGEEVx.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_DGEEVx.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_DGEEVx.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_DGEEVX( BALANC, JOBVL, JOBVR, SENSE, N, A, LDA, WR, WI,
...
*> \verbatim
*>
*> AB_DGEEVX computes for an N-by-N real nonsymmetric matrix A, the
...
*
*  =====================================================================
      SUBROUTINE AB_DGEEVX( BALANC, JOBVL, JOBVR, SENSE, N, A, LDA, WR, 
     $WI,
     $                   VL, LDVL, VR, LDVR, ILO, IHI, SCALE, ABNRM,
     $                   RCONDE, RCONDV, WORK, LWORK, IWORK, INFO )
      implicit none
