*> \brief <b> AB_ZGTSVX computes the solution to system of linear equations A * X = B for GT matrices </b>
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download AB_ZGTSVX + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_ZGTSVx.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_ZGTSVx.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_ZGTSVx.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_ZGTSVX( FACT, TRANS, N, NRHS, DL, D, DU, DLF, DF, DUF,
...
*> \verbatim
*>
*> AB_ZGTSVX uses the LU factorization to compute the solution to a complex
...
*
*  =====================================================================
      SUBROUTINE AB_ZGTSVX( FACT, TRANS, N, NRHS, DL, D, DU, DLF, DF, DU
     $F,
     $                   DU2, IPIV, B, LDB, X, LDX, RCOND, FERR, BERR,
     $                   WORK, RWORK, INFO )
*
...
*     .. External Functions ..
      LOGICAL            AB_LSAME
      DOUBLE PRECISION   DLAMCH, AB_ZLANGT
      EXTERNAL           AB_LSAME, DLAMCH, AB_ZLANGT
*     ..
