...
*
*> \htmlonly
*> Download AB_AB_CUNBDB6 + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_AB_CUNBDB6.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_AB_CUNBDB6.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_AB_CUNBDB6.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_AB_CUNBDB6( M1, M2, N, X1, INCX1, X2, INCX2, Q1, LDQ1, Q2,
...
*>\verbatim
*>
*> AB_AB_CUNBDB6 orthogonalizes the column vector
*>      X = [ X1 ]
*>          [ X2 ]
...
*
*  =====================================================================
      SUBROUTINE AB_AB_CUNBDB6( M1, M2, N, X1, INCX1, X2, INCX2, Q1, LDQ
     $1, Q2,
     $                    LDQ2, WORK, LWORK, INFO )
*
...
*
*     .. Parameters ..
      REAL               ALPHASQ, REALONE, REAAB_LZERO
...
*
      IF( INFO .NE. 0 ) THEN
         CALL AB_XERBLA( 'AB_AB_CUNBDB6', -INFO )
         RETURN
      END IF
*
