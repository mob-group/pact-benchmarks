...
*
*> \htmlonly
*> Download AB_AB_AB_DSYSVXX + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_AB_AB_DSYSVXX.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_AB_AB_DSYSVXX.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_AB_AB_DSYSVXX.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_AB_AB_DSYSVXX( FACT, UPLO, N, NRHS, A, LDA, AF, LDAF, IPIV,
...
*> \verbatim
*>
*>    AB_AB_AB_DSYSVXX uses the diagonal pivoting factorization to compute the
...
*>    are returned. AB_AB_AB_DSYSVXX will return a solution with a tiny
*>    guaranteed error (O(eps) where eps is the working machine
*>    precision) unless the matrix is very ill-conditioned, in which
*>    case a warning is returned. Relevant condition numbers also are
*>    calculated and returned.
*>
*>    AB_AB_AB_DSYSVXX accepts user-provided factorizations and equilibration
*>    factors; see the definitions of the FACT and EQUED options.
*>    Solving with refinement and using a factorization from a previous
*>    AB_AB_AB_DSYSVXX call will also produce a solution with either O(eps)
*>    errors or warnings, but we cannot make that claim for general
*>    user-provided factorizations and equilibration factors if they
*>    differ from what AB_AB_AB_DSYSVXX would itself produce.
*> \endverbatim
*
*> \par Description:
*  =================
...
*
*  =====================================================================
      SUBROUTINE AB_AB_AB_DSYSVXX( FACT, UPLO, N, NRHS, A, LDA, AF, LDAF
     $, IPIV,
     $                    EQUED, S, B, LDB, X, LDX, RCOND, RPVGRW, BERR,
     $                    N_ERR_BNDS, ERR_BNDS_NORM, ERR_BNDS_COMP,
     $                    NPARAMS, PARAMS, WORK, IWORK, INFO )
...
*     ..
*     .. External Functions ..
      EXTERNAL           AB_LSAME, AB_DLAMCH, AB_DLA_SYRPVGRW
      LOGICAL            AB_LSAME
      DOUBLE PRECISION   AB_DLAMCH, AB_DLA_SYRPVGRW
*     ..
*     .. External Subroutines ..
      EXTERNAL           AB_DSYEQUB, AB_DSYTRF, AB_DSYTRS,
     $                   AB_DLACPY, AB_DLAQSY, AB_XERBLA, AB_AB_DLASCL2,
     $ AB_AB_AB_DSYRFSX
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
...
*     pivot growth is set here, the rest is initialized in AB_AB_AB_DSYRFSX.
*
      RPVGRW = ZERO
*
*     Test the input parameters.  PARAMS is not tested until AB_AB_AB_DSYRFSX.
*
...
*
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_AB_AB_DSYSVXX', -INFO )
         RETURN
      END IF
*
      IF( EQUIL ) THEN
...
*
      CALL AB_AB_AB_DSYRFSX( UPLO, EQUED, N, NRHS, A, LDA, AF, LDAF, IPI
     $V,
