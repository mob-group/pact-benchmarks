...
*>  AB_DLASWLQ (if the matrix is short-and-wide) or AB_AB_DGELQT to compute
...
*     .. External Subroutines ..
      EXTERNAL           AB_AB_DGELQT, AB_DLASWLQ, AB_XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
      IF( ( N.LE.M ) .OR. ( NB.LE.M ) .OR. ( NB.GE.N ) ) THEN
        CALL AB_AB_DGELQT( M, N, MB, A, LDA, T( 6 ), MB, WORK, INFO )
      ELSE
