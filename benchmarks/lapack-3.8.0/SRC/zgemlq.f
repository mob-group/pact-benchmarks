...
*>  AB_ZLASWLQ (if the matrix is wide-and-short) or AB_AB_ZGELQT to compute
*>  the LQ factorization.
*>  This version of AB_ZGEMLQ will use either AB_ZLAMSWLQ or AB_AB_ZGEMLQT to 
*>  multiply matrix Q by another matrix.
*>  Further Details in AB_ZLAMSWLQ or AB_AB_ZGEMLQT.
*> \endverbatim
*>
*  =====================================================================
...
*     .. External Subroutines ..
      EXTERNAL           AB_ZLAMSWLQ, AB_AB_ZGEMLQT, AB_XERBLA
*     ..
*     .. Intrinsic Functions ..
