...
*     .. External Subroutines ..
      EXTERNAL           AB_AB_AB_CHER2K, AB_CHETD2, AB_CLATRD, AB_XERBL
     $A
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX
...
*
            CALL AB_AB_AB_CHER2K( UPLO, 'No transpose', I-1, NB, -CONE,
...
*
            CALL AB_AB_AB_CHER2K( UPLO, 'No transpose', N-I-NB+1, NB, -C
     $ONE,
