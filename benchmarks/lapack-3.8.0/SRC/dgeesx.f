*> \brief <b> AB_DGEESX computes the eigenvalues, the Schur form, and, optionally, the matrix of Schur vectors for GE matrices</b>
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download AB_DGEESX + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_DGEESx.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_DGEESx.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_DGEESx.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_DGEESX( JOBVS, SORT, SELECT, SENSE, N, A, LDA, SDIM,
...
*> \verbatim
*>
*> AB_DGEESX computes for an N-by-N real nonsymmetric matrix A, the
...
*     .. External Functions ..
      ...
      EXTERNAL           AB_LSAME, AB_ILAENV, AB_DLABAD, AB_DLAMCH, AB_DLAN
     $GE
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, SQRT
