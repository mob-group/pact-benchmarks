...
*
*> \htmlonly
*> Download AB_AB_AB_ZSYRFSX + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_AB_AB_ZSYRFSX.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_AB_AB_ZSYRFSX.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_AB_AB_ZSYRFSX.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_AB_AB_ZSYRFSX( UPLO, EQUED, N, NRHS, A, LDA, AF, LDAF, IPIV,
...
*> \verbatim
*>
*>    AB_AB_AB_ZSYRFSX improves the computed solution to a system of linear
...
*
*  =====================================================================
      SUBROUTINE AB_AB_AB_ZSYRFSX( UPLO, EQUED, N, NRHS, A, LDA, AF, LDA
     $F, IPIV,
     $                    S, B, LDB, X, LDX, RCOND, BERR, N_ERR_BNDS,
     $                    ERR_BNDS_NORM, ERR_BNDS_COMP, NPARAMS, PARAMS,
     $                    WORK, RWORK, INFO )
...
*     .. External Subroutines ..
      EXTERNAL           AB_XERBLA, AB_ZSYCON, AB_ZLA_SYRFSX_EXTENDED
*     ..
*     .. Intrinsic Functions ..
...
*     .. External Functions ..
      ...
      EXTERNAL           AB_DLAMCH, AB_ZLANSY, AB_ZLA_SYRCOND_X, AB_ZLA_
     $SYRCOND_C
      DOUBLE PRECISION   AB_DLAMCH, AB_ZLANSY, AB_ZLA_SYRCOND_X, AB_ZLA_
     $SYRCOND_C
      LOGICAL            AB_LSAME
      INTEGER            AB_ILAPREC
*     ..
...
*
     ...
     $ THEN
      ...
      END IF
      IF( INFO.NE.0 ) THEN
        CALL AB_XERBLA( 'AB_AB_AB_ZSYRFSX', -INFO )
        RETURN
      END IF
*
...
*
      NORM = 'I'
      ANORM = AB_ZLANSY( NORM, UPLO, N, A, LDA, RWORK )
      CALL AB_ZSYCON( UPLO, N, AF, LDAF, IPIV, ANORM, RCOND, WORK,
     $     INFO )
*
...
*
      IF ( REF_TYPE .NE. 0 ) THEN
         ...
         CALL AB_ZLA_SYRFSX_EXTENDED( PREC_TYPE, UPLO,  N,
...
*
         IF ( RCEQU ) THEN
            RCOND_TMP = AB_ZLA_SYRCOND_C( UPLO, N, A, LDA, AF, LDAF, IPI
     $V,
...
*
     ...
     $     THEN
               RCOND_TMP = AB_ZLA_SYRCOND_X( UPLO, N, A, LDA, AF, LDAF,
