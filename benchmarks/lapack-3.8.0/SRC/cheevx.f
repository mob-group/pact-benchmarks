*> \brief <b> AB_AB_CHEEVX computes the eigenvalues and, optionally, the left and/or right eigenvectors for HE matrices</b>
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download AB_AB_CHEEVX + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_AB_CHEEVX.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_AB_CHEEVX.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_AB_CHEEVX.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_AB_CHEEVX( JOBZ, RANGE, UPLO, N, A, LDA, VL, VU, IL, IU,
...
*> \verbatim
*>
*> AB_AB_CHEEVX computes selected eigenvalues and, optionally, eigenvectors
...
*
*  =====================================================================
      SUBROUTINE AB_AB_CHEEVX( JOBZ, RANGE, UPLO, N, A, LDA, VL, VU, IL,
     $ IU,
     $                   ABSTOL, M, W, Z, LDZ, WORK, LWORK, RWORK,
     $                   IWORK, IFAIL, INFO )
*
...
*     .. External Functions ..
      ...
      EXTERNAL           AB_LSAME, AB_ILAENV, AB_SLAMCH, AB_CLANHE
*     ..
*     .. External Subroutines ..
      EXTERNAL           AB_SCOPY, AB_SSCAL, AB_SSTEBZ, AB_SSTERF, AB_XE
     $RBLA, AB_CAB_SSCAL,
     $                   AB_CHETRD, AB_CLACPY, AB_CSTEIN, AB_CSTEQR, AB_
     $CSWAP, AB_CUNGTR,
     $                   AB_CUNMTR
*     ..
*     .. Intrinsic Functions ..
...
*
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_AB_CHEEVX', -INFO )
         RETURN
      ELSE IF( LQUERY ) THEN
         RETURN
      END IF
...
*
      ...
      CALL AB_CHETRD( UPLO, N, A, LDA, RWORK( INDD ), RWORK( INDE ),
