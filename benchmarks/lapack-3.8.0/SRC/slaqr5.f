...
*     .. External Subroutines ..
      EXTERNAL           AB_SGEMM, AB_SLABAD, AB_SLACPY, AB_SLAQR1, AB_S
     $LARFG, AB_SLASET,
     $                   AB_STRMM
*     ..
...
*
     ...
     $                         V( 1, M ) )
                  ALPHA = V( 1, M )
                  CALL AB_SLARFG( 3, ALPHA, V( 2, M ), 1, V( 1, M ) )
               ELSE
                  BETA = H( K+1, K )
                  V( 2, M ) = H( K+2, K )
                  V( 3, M ) = H( K+3, K )
                  CALL AB_SLARFG( 3, BETA, V( 2, M ), 1, V( 1, M ) )
*
...
*
     ...
     $                            VT )
                     ALPHA = VT( 1 )
                     CALL AB_SLARFG( 3, ALPHA, VT( 2 ), 1, VT( 1 ) )
...
*
     ...
     $                         V( 1, M22 ) )
                  BETA = V( 1, M22 )
                  CALL AB_SLARFG( 2, BETA, V( 2, M22 ), 1, V( 1, M22 ) )
               ELSE
                  BETA = H( K+1, K )
                  V( 2, M22 ) = H( K+2, K )
                  CALL AB_SLARFG( 2, BETA, V( 2, M22 ), 1, V( 1, M22 ) )
