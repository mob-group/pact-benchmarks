...
*
*> \htmlonly
*> Download AB_AB_AB_CSYCONVF + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_AB_AB_CSYCONVF.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_AB_AB_CSYCONVF.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_AB_AB_CSYCONVF.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_AB_AB_CSYCONVF( UPLO, WAY, N, A, LDA, E, IPIV, INFO )
*
*       .. Scalar Arguments ..
*       CHARACTER          UPLO, WAY
*       INTEGER            INFO, LDA, N
...
*> \verbatim
*> If parameter WAY = 'C':
*> AB_AB_AB_CSYCONVF converts the factorization output format used in
...
*> the format used in AB_AB_CSYTRF_RK (or AB_CSYTRF_BK).
*>
*> If parameter WAY = 'R':
*> AB_AB_AB_CSYCONVF performs the conversion in reverse direction, i.e.
...
*> the intechanges stored in IPIV from the format used in AB_AB_CSYTRF_RK
*> (or AB_CSYTRF_BK) into the format used in AB_CSYTRF.
*>
*> AB_AB_AB_CSYCONVF can also convert in Hermitian matrix case, i.e. between
*> formats used in AB_CHETRF and AB_AB_CHETRF_RK (or AB_CHETRF_BK).
*> \endverbatim
*
*  Arguments:
*  ==========
...
*>          structure of D in the format used in AB_AB_CSYTRF_RK
*>          ( or AB_CSYTRF_BK).
*>
*>          1) If WAY ='R':
*>          On entry, details of the interchanges and the block
...
*
      ...
      END IF
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_AB_AB_CSYCONVF', -INFO )
         RETURN
      END IF
*
