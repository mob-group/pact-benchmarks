*> \brief <b> AB_AB_DSYEVR computes the eigenvalues and, optionally, the left and/or right eigenvectors for SY matrices</b>
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download AB_AB_DSYEVR + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_AB_DSYEVR.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_AB_DSYEVR.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_AB_DSYEVR.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_AB_DSYEVR( JOBZ, RANGE, UPLO, N, A, LDA, VL, VU, IL, IU,
...
*> \verbatim
*>
*> AB_AB_DSYEVR computes selected eigenvalues and, optionally, eigenvectors
*> of a real symmetric matrix A.  Eigenvalues and eigenvectors can be
*> selected by specifying either a range of values or a range of
*> indices for the desired eigenvalues.
*>
*> AB_AB_DSYEVR first reduces the matrix A to tridiagonal form T with a call
*> to AB_DSYTRD.  Then, whenever possible, AB_AB_DSYEVR calls AB_DSTEMR to compute
...
*>
*>
*> Note 1 : AB_AB_DSYEVR calls AB_DSTEMR when the full spectrum is requested
*> on machines which conform to the ieee-754 floating point standard.
*> AB_AB_DSYEVR calls AB_DSTEBZ and AB_DSTEIN on non-ieee machines and
...
*>          where NB is the max of the blocksize for AB_DSYTRD and AB_DORMTR
...
*>
*  =====================================================================
      SUBROUTINE AB_AB_DSYEVR( JOBZ, RANGE, UPLO, N, A, LDA, VL, VU, IL,
     $ IU,
     $                   ABSTOL, M, W, Z, LDZ, ISUPPZ, WORK, LWORK,
     $                   IWORK, LIWORK, INFO )
*
...
*     .. External Subroutines ..
     ...
     $TEMR, AB_DSTEIN,
     $                   AB_DSTERF, AB_DSWAP, AB_DSYTRD, AB_XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_AB_DSYEVR', -INFO )
         RETURN
      ELSE IF( LQUERY ) THEN
         RETURN
      END IF
...
*
      CALL AB_DSYTRD( UPLO, N, A, LDA, WORK( INDD ), WORK( INDE ),
