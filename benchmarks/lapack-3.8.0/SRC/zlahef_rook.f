* \brief \b AB_AB_ZLAHEF_ROOK computes a partial factorization of a complex Hermitian indefinite matrix using the bounded Bunch-Kaufman ("rook") diagonal pivoting method (blocked algorithm, calling Level 3 BLAS).
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download AB_AB_ZLAHEF_ROOK + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_AB_ZLAHEF_ROOK.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_AB_ZLAHEF_ROOK.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_AB_ZLAHEF_ROOK.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_AB_ZLAHEF_ROOK( UPLO, N, NB, KB, A, LDA, IPIV, W, LDW, INFO )
*
*       .. Scalar Arguments ..
*       CHARACTER          UPLO
...
*> \verbatim
*>
*> AB_AB_ZLAHEF_ROOK computes a partial factorization of a complex Hermitian
...
*>
*> AB_AB_ZLAHEF_ROOK is an auxiliary routine called by AB_AB_ZHETRF_ROOK. It uses
...
*
*  =====================================================================
      SUBROUTINE AB_AB_ZLAHEF_ROOK( UPLO, N, NB, KB, A, LDA, IPIV, W, LD
     $W,
     $                        INFO )
*
