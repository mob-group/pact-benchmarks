...
*     .. External Subroutines ..
      EXTERNAL           AB_XERBLA, AB_STFTRI, AB_SLAUUM, AB_STRMM, AB_A
     $B_SSYRK
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MOD
...
*
               ...
               CALL AB_AB_SSYRK( 'L', 'T', N1, N2, ONE, A( N1 ), N, ONE,
     $                     A( 0 ), N )
...
*
               ...
               CALL AB_AB_SSYRK( 'L', 'N', N1, N2, ONE, A( 0 ), N, ONE,
     $                     A( N2 ), N )
...
*
               ...
               CALL AB_AB_SSYRK( 'U', 'N', N1, N2, ONE, A( N1*N1 ), N1, 
     $ONE,
     $                     A( 0 ), N1 )
...
*
               ...
               CALL AB_AB_SSYRK( 'U', 'T', N1, N2, ONE, A( 0 ), N2, ONE,
     $                     A( N2*N2 ), N2 )
...
*
               ...
               CALL AB_AB_SSYRK( 'L', 'T', K, K, ONE, A( K+1 ), N+1, ONE
     $,
     $                     A( 1 ), N+1 )
...
*
               ...
               CALL AB_AB_SSYRK( 'L', 'N', K, K, ONE, A( 0 ), N+1, ONE,
     $                     A( K+1 ), N+1 )
...
*
               ...
               CALL AB_AB_SSYRK( 'U', 'N', K, K, ONE, A( K*( K+1 ) ), K,
     $ ONE,
     $                     A( K ), K )
...
*
               ...
               CALL AB_AB_SSYRK( 'U', 'T', K, K, ONE, A( 0 ), K, ONE,
     $                     A( K*( K+1 ) ), K )
