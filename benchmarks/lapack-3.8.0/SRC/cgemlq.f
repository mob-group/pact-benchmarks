...
*>                           CLASWQR or AB_AB_CGELQT
*>
*>  Depending on the matrix dimensions M and N, and row and column
*>  block sizes MB and NB returned by AB_ILAENV, AB_CGELQ will use either
*>  AB_CLASWLQ (if the matrix is wide-and-short) or AB_AB_CGELQT to compute
*>  the LQ factorization.
*>  This version of AB_CGEMLQ will use either AB_CLAMSWLQ or AB_AB_CGEMLQT to 
*>  multiply matrix Q by another matrix.
*>  Further Details in AB_CLAMSWLQ or AB_AB_CGEMLQT.
*> \endverbatim
*>
*  =====================================================================
...
*     .. External Subroutines ..
      EXTERNAL           AB_CLAMSWLQ, AB_AB_CGEMLQT, AB_XERBLA
*     ..
*     .. Intrinsic Functions ..
