*> \brief <b> AB_DGTSVX computes the solution to system of linear equations A * X = B for GT matrices </b>
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download AB_DGTSVX + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_DGTSVx.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_DGTSVx.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_DGTSVx.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_DGTSVX( FACT, TRANS, N, NRHS, DL, D, DU, DLF, DF, DUF,
...
*> \verbatim
*>
*> AB_DGTSVX uses the LU factorization to compute the solution to a real
...
*
*  =====================================================================
      SUBROUTINE AB_DGTSVX( FACT, TRANS, N, NRHS, DL, D, DU, DLF, DF, DU
     $F,
     $                   DU2, IPIV, B, LDB, X, LDX, RCOND, FERR, BERR,
     $                   WORK, IWORK, INFO )
*
...
*     .. External Functions ..
      LOGICAL            AB_LSAME
      DOUBLE PRECISION   DLAMCH, AB_DLANGT
      EXTERNAL           AB_LSAME, DLAMCH, AB_DLANGT
*     ..
