...
*
*> \htmlonly
*> Download AB_AB_AB_CSYTRI2X + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_AB_AB_CSYTRI2X.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_AB_AB_CSYTRI2X.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_AB_AB_CSYTRI2X.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_AB_AB_CSYTRI2X( UPLO, N, A, LDA, IPIV, WORK, NB, INFO )
*
*       .. Scalar Arguments ..
*       CHARACTER          UPLO
...
*> \verbatim
*>
*> AB_AB_AB_CSYTRI2X computes the inverse of a real symmetric indefinite matrix
...
*
*  =====================================================================
      SUBROUTINE AB_AB_AB_CSYTRI2X( UPLO, N, A, LDA, IPIV, WORK, NB, INF
     $O )
*
...
*     .. External Subroutines ..
      ...
      EXTERNAL           AB_CGEMM, AB_CTRMM, AB_CSYSWAPR
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX
*     ..
...
*
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_AB_AB_CSYTRI2X', -INFO )
         RETURN
      END IF
      IF( N.EQ.0 )
     $   RETURN
...
*
         CALL AB_CGEMM('T','N',NNB,NNB,CUT,ONE,A(1,CUT+1),LDA,
...
*
     ...
     $ )
               ELSE
                 ...
                 I=I+1
                 IF ( (I-1) .LT. IP)
     $                  CALL AB_CSYSWAPR( UPLO, N, A, LDA, I-1 ,IP )
                 IF ( (I-1) .GT. IP)
     $                  CALL AB_CSYSWAPR( UPLO, N, A, LDA, IP ,I-1 )
              ENDIF
               I=I+1
            END DO
      ELSE
...
*       L11**T*invD1*L11->L11
*
        CALL AB_CTRMM('L',UPLO,'T','U',NNB, NNB,
     $             ONE,A(CUT+1,CUT+1),LDA,WORK(U11+1,1),N+NB+1)
*
         DO I=1,NNB
            DO J=1,I
...
*
         CALL AB_CGEMM('T','N',NNB,NNB,N-NNB-CUT,ONE,A(CUT+NNB+1,CUT+1)
...
*        L01 =  L22**T*invD2*L21
*
         CALL AB_CTRMM('L',UPLO,'T','U', N-NNB-CUT, NNB,
...
*
     ...
     $ )
               ELSE
                 IP=-IPIV(I)
                 IF ( I .LT. IP) CALL AB_CSYSWAPR( UPLO, N, A, LDA, I ,I
     $P )
                 IF ( I .GT. IP) CALL AB_CSYSWAPR( UPLO, N, A, LDA, IP ,
     $I )
                 I=I-1
               ENDIF
               I=I-1
