...
*
*> \htmlonly
*> Download AB_AB_AB_CSYRFSX + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_AB_AB_CSYRFSX.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_AB_AB_CSYRFSX.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_AB_AB_CSYRFSX.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_AB_AB_CSYRFSX( UPLO, EQUED, N, NRHS, A, LDA, AF, LDAF, IPIV,
...
*> \verbatim
*>
*>    AB_AB_AB_CSYRFSX improves the computed solution to a system of linear
...
*
*  =====================================================================
      SUBROUTINE AB_AB_AB_CSYRFSX( UPLO, EQUED, N, NRHS, A, LDA, AF, LDA
     $F, IPIV,
     $                    S, B, LDB, X, LDX, RCOND, BERR, N_ERR_BNDS,
     $                    ERR_BNDS_NORM, ERR_BNDS_COMP, NPARAMS, PARAMS,
     $                    WORK, RWORK, INFO )
...
*     .. External Subroutines ..
      EXTERNAL           AB_XERBLA, AB_CSYCON, AB_CLA_SYRFSX_EXTENDED
*     ..
*     .. Intrinsic Functions ..
...
*     .. External Functions ..
      ...
      EXTERNAL           AB_SLAMCH, AB_CLANSY, AB_CLA_SYRCOND_X, AB_CLA_
     $SYRCOND_C
      REAL               AB_SLAMCH, AB_CLANSY, AB_CLA_SYRCOND_X, AB_CLA_
     $SYRCOND_C
      LOGICAL            AB_LSAME
      INTEGER            AB_ILAPREC
*     ..
...
*
     ...
     $ THEN
      ...
      END IF
      IF( INFO.NE.0 ) THEN
        CALL AB_XERBLA( 'AB_AB_AB_CSYRFSX', -INFO )
        RETURN
      END IF
*
...
*
      NORM = 'I'
      ANORM = AB_CLANSY( NORM, UPLO, N, A, LDA, RWORK )
      CALL AB_CSYCON( UPLO, N, AF, LDAF, IPIV, ANORM, RCOND, WORK,
     $     INFO )
*
...
*
      IF ( REF_TYPE .NE. 0 ) THEN
         ...
         CALL AB_CLA_SYRFSX_EXTENDED( PREC_TYPE, UPLO,  N,
...
*
         IF ( RCEQU ) THEN
            RCOND_TMP = AB_CLA_SYRCOND_C( UPLO, N, A, LDA, AF, LDAF, IPI
     $V,
...
*
     ...
     $     THEN
               RCOND_TMP = AB_CLA_SYRCOND_X( UPLO, N, A, LDA, AF, LDAF,
