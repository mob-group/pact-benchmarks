*> \brief <b> AB_AB_ZHBEV_2STAGE computes the eigenvalues and, optionally, the left and/or right eigenvectors for OTHER matrices</b>
*
...
*
*> \htmlonly
*> Download AB_AB_ZHBEV_2STAGE + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_AB_ZHBEV_2STAGE.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_AB_ZHBEV_2STAGE.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_AB_ZHBEV_2STAGE.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_AB_ZHBEV_2STAGE( JOBZ, UPLO, N, KD, AB, LDAB, W, Z, LDZ,
...
*> \verbatim
*>
*> AB_AB_ZHBEV_2STAGE computes all the eigenvalues and, optionally, eigenvectors of
...
*
*  =====================================================================
      SUBROUTINE AB_AB_ZHBEV_2STAGE( JOBZ, UPLO, N, KD, AB, LDAB, W, Z, 
     $LDZ,
     $                         WORK, LWORK, RWORK, INFO )
*
      IMPLICIT NONE
...
*     .. External Subroutines ..
     ...
     $STEQR,
     $                   AB_AB_ZHETRD_2STAGE, AB_ZHETRD_HB2ST
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          DBLE, SQRT
*     ..
...
*
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_AB_ZHBEV_2STAGE ', -INFO )
         RETURN
      ELSE IF( LQUERY ) THEN
         RETURN
      END IF
