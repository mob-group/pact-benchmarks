*> \brief <b> AB_AB_DSTEVX computes the eigenvalues and, optionally, the left and/or right eigenvectors for OTHER matrices</b>
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download AB_AB_DSTEVX + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_AB_DSTEVX.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_AB_DSTEVX.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_AB_DSTEVX.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_AB_DSTEVX( JOBZ, RANGE, N, D, E, VL, VU, IL, IU, ABSTOL,
...
*> \verbatim
*>
*> AB_AB_DSTEVX computes selected eigenvalues and, optionally, eigenvectors
...
*
*  =====================================================================
      SUBROUTINE AB_AB_DSTEVX( JOBZ, RANGE, N, D, E, VL, VU, IL, IU, ABS
     $TOL,
     $                   M, W, Z, LDZ, WORK, IWORK, IFAIL, INFO )
*
...
*     .. External Subroutines ..
      EXTERNAL           AB_DCOPY, AB_DSCAL, AB_DSTEBZ, AB_DSTEIN, AB_DS
     $TEQR, AB_DSTERF,
     $                   AB_DSWAP, AB_XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_AB_DSTEVX', -INFO )
         RETURN
      END IF
*
...
*     call AB_DSTERF or AB_SSTEQR.  If this fails for some eigenvalue, then
*     try AB_DSTEBZ.
*
      TEST = .FALSE.
      IF( INDEIG ) THEN
      ...
      IF( ( ALLEIG .OR. TEST ) .AND. ( ABSTOL.LE.ZERO ) ) THEN
         ...
         ELSE
            CALL AB_DSTEQR( 'I', N, W, WORK, Z, LDZ, WORK( INDWRK ), INF
     $O )
            IF( INFO.EQ.0 ) THEN
               DO 10 I = 1, N
                  IFAIL( I ) = 0
