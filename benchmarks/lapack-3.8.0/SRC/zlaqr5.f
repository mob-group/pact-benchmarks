...
*     .. External Subroutines ..
      EXTERNAL           AB_DLABAD, AB_ZGEMM, AB_ZLACPY, AB_ZLAQR1, AB_A
     $B_ZLARFG, AB_ZLASET,
     $                   AB_ZTRMM
*     ..
*     .. Statement Functions ..
...
*
     ...
     $                         S( 2*M ), V( 1, M ) )
                  ALPHA = V( 1, M )
                  CALL AB_AB_ZLARFG( 3, ALPHA, V( 2, M ), 1, V( 1, M ) )
               ELSE
                  BETA = H( K+1, K )
                  V( 2, M ) = H( K+2, K )
                  V( 3, M ) = H( K+3, K )
                  CALL AB_AB_ZLARFG( 3, BETA, V( 2, M ), 1, V( 1, M ) )
*
...
*
     ...
     $                            S( 2*M ), VT )
                     ALPHA = VT( 1 )
                     CALL AB_AB_ZLARFG( 3, ALPHA, VT( 2 ), 1, VT( 1 ) )
                     REFSUM = DCONJG( VT( 1 ) )*
     $                        ( H( K+1, K )+DCONJG( VT( 2 ) )*
     $                        H( K+2, K ) )
*
...
*
     ...
     $                         S( 2*M22 ), V( 1, M22 ) )
                  BETA = V( 1, M22 )
                  CALL AB_AB_ZLARFG( 2, BETA, V( 2, M22 ), 1, V( 1, M22 
     $) )
               ELSE
                  BETA = H( K+1, K )
                  V( 2, M22 ) = H( K+2, K )
