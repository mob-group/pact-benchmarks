...
*
*> \htmlonly
*> Download AB_ZTREVC3 + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_ZTREVC3.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_ZTREVC3.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_ZTREVC3.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_ZTREVC3( SIDE, HOWMNY, SELECT, N, T, LDT, VL, LDVL, VR,
...
*> \verbatim
*>
*> AB_ZTREVC3 computes some or all of the right and/or left eigenvectors of
...
*>
*  =====================================================================
      SUBROUTINE AB_ZTREVC3( SIDE, HOWMNY, SELECT, N, T, LDT, VL, LDVL, 
     $VR,
     $                    LDVR, MM, M, WORK, LWORK, RWORK, LRWORK, INFO)
      IMPLICIT NONE
*
...
*     .. External Functions ..
      ...
      EXTERNAL           AB_LSAME, AB_ILAENV, AB_IZAMAX, AB_DLAMCH, AB_DZAS
     $UM
*     ..
...
*
      ...
      END IF
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_ZTREVC3', -INFO )
         RETURN
      ELSE IF( LQUERY ) THEN
         RETURN
      END IF
...
*                 normalize vectors
                  DO K = IV, NB
                     ...
                     CALL AB_ZDSCAL( N, REMAX, WORK( 1 + (NB+K)*N ), 1 )
                  END DO
