...
*     .. External Subroutines ..
      EXTERNAL           AB_DGEMM, AB_DPBTF2, AB_DPOTF2, AB_AB_DSYRK, AB
     $_DTRSM, AB_XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MIN
...
*                    Update A22
*
                     CALL AB_AB_DSYRK( 'Upper', 'Transpose', I2, IB, -ON
     $E,
...
*                    Update A33
*
                     CALL AB_AB_DSYRK( 'Upper', 'Transpose', I3, IB, -ON
     $E,
...
*                    Update A22
*
                     CALL AB_AB_DSYRK( 'Lower', 'No Transpose', I2, IB, 
     $-ONE,
...
*                    Update A33
*
                     CALL AB_AB_DSYRK( 'Lower', 'No Transpose', I3, IB, 
     $-ONE,
