...
*     .. External Subroutines ..
      EXTERNAL   AB_AB_CGEMQRT, AB_CTPMQRT, AB_XERBLA
*     ..
...
*
      IF((MB.LE.K).OR.(MB.GE.MAX(M,N,K))) THEN
        CALL AB_AB_CGEMQRT( SIDE, TRANS, M, N, K, NB, A, LDA,
...
*
         CALL AB_AB_CGEMQRT('L','N',MB , N, K, NB, A(1,1), LDA, T
...
*
         ...
         II=M-KK+1
         CTR = 1
         CALL AB_AB_CGEMQRT('L','C',MB , N, K, NB, A(1,1), LDA, T
     $            ,LDT ,C(1,1), LDC, WORK, INFO )
*
...
*
          CALL AB_AB_CGEMQRT('R','C',M , MB, K, NB, A(1,1), LDA, T
     $              ,LDT ,C(1,1), LDC, WORK, INFO )
*
...
*
         ...
         II=N-KK+1
         CTR = 1
         CALL AB_AB_CGEMQRT('R','N', M, MB , K, NB, A(1,1), LDA, T
     $              ,LDT ,C(1,1), LDC, WORK, INFO )
*
         DO I=MB+1,II-MB+K,(MB-K)
*
