*> \brief <b> AB_ZGGAB_LSE solves overdetermined or underdetermined systems for OTHER matrices</b>
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download AB_ZGGAB_LSE + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_ZGGAB_LSE.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_ZGGAB_LSE.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_ZGGAB_LSE.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_ZGGAB_LSE( M, N, P, A, LDA, B, LDB, C, D, X, WORK, LWORK,
*                          INFO )
*
*       .. Scalar Arguments ..
...
*> \verbatim
*>
*> AB_ZGGAB_LSE solves the linear equality-constrained least squares (AB_LSE)
*> problem:
*>
...
*>          AB_AB_ZGEQRF, AB_CGERQF, AB_ZUNMQR and AB_CUNMRQ.
*>
...
*
*  =====================================================================
      SUBROUTINE AB_ZGGAB_LSE( M, N, P, A, LDA, B, LDB, C, D, X, WORK, L
     $WORK,
     $                   INFO )
*
...
*
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_ZGGAB_LSE', -INFO )
         RETURN
      ELSE IF( LQUERY ) THEN
         RETURN
      END IF
