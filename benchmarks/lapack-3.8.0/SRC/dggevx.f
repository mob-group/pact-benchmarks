*> \brief <b> AB_AB_DGGEVX computes the eigenvalues and, optionally, the left and/or right eigenvectors for GE matrices</b>
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download AB_AB_DGGEVX + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_AB_DGGEVX.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_AB_DGGEVX.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_AB_DGGEVX.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_AB_DGGEVX( BALANC, JOBVL, JOBVR, SENSE, N, A, LDA, B, LDB,
...
*> \verbatim
*>
*> AB_AB_DGGEVX computes for a pair of N-by-N real nonsymmetric matrices (A,B)
...
*>
*  =====================================================================
      SUBROUTINE AB_AB_DGGEVX( BALANC, JOBVL, JOBVR, SENSE, N, A, LDA, B
     $, LDB,
     $                   ALPHAR, ALPHAI, BETA, VL, LDVL, VR, LDVR, ILO,
     $                   IHI, LSCALE, RSCALE, ABNRM, BBNRM, RCONDE,
     $                   RCONDV, WORK, LWORK, IWORK, BWORK, INFO )
...
*
      IF( INFO.EQ.0 ) THEN
         ...
         ELSE
            ...
            MAXWRK = MINWRK
            MAXWRK = MAX( MAXWRK,
     $                    N + N*AB_ILAENV( 1, 'AB_AB_DGEQRF', ' ', N, 1,
     $ N, 0 ) )
            MAXWRK = MAX( MAXWRK,
...
*
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_AB_DGGEVX', -INFO )
         RETURN
      ELSE IF( LQUERY ) THEN
         RETURN
      END IF
