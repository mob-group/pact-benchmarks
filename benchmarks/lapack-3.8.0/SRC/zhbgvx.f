...
*
*> \htmlonly
*> Download AB_AB_ZHBGVX + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_AB_ZHBGVX.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_AB_ZHBGVX.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_AB_ZHBGVX.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_AB_ZHBGVX( JOBZ, RANGE, UPLO, N, KA, KB, AB, LDAB, BB,
...
*> \verbatim
*>
*> AB_AB_ZHBGVX computes all the eigenvalues, and optionally, the eigenvectors
...
*
*  =====================================================================
      SUBROUTINE AB_AB_ZHBGVX( JOBZ, RANGE, UPLO, N, KA, KB, AB, LDAB, B
     $B,
     $                   LDBB, Q, LDQ, VL, VU, IL, IU, ABSTOL, M, W, Z,
     $                   LDZ, WORK, RWORK, IWORK, IFAIL, INFO )
*
...
*     .. External Subroutines ..
      EXTERNAL           AB_DCOPY, AB_DSTEBZ, AB_DSTERF, AB_XERBLA, AB_Z
     $COPY, AB_ZGEMV,
     $                   AB_ZHBGST, AB_ZHBTRD, AB_ZLACPY, AB_ZPBSTF, AB_
     $ZSTEIN, AB_ZSTEQR,
     $                   AB_ZSWAP
*     ..
*     .. Intrinsic Functions ..
...
*
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_AB_ZHBGVX', -INFO )
         RETURN
      END IF
*
...
*
      CALL AB_ZHBGST( JOBZ, UPLO, N, KA, KB, AB, LDAB, BB, LDBB, Q, LDQ,
     $             WORK, RWORK, IINFO )
*
...
*
      ...
      ELSE
         VECT = 'N'
      END IF
      CALL AB_ZHBTRD( VECT, UPLO, N, KA, AB, LDAB, RWORK( INDD ),
