*> \brief <b> AB_SGBSVX computes the solution to system of linear equations A * X = B for GB matrices</b>
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download AB_SGBSVX + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_SGBSVx.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_SGBSVx.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_SGBSVx.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_SGBSVX( FACT, TRANS, N, KL, KU, NRHS, AB, LDAB, AFB,
...
*> \verbatim
*>
*> AB_SGBSVX uses the LU factorization to compute the solution to a real
...
*     .. External Functions ..
      LOGICAL            AB_LSAME
      REAL               SLAMCH, AB_SLANGB, AB_SLANTB
      EXTERNAL           AB_LSAME, SLAMCH, AB_SLANGB, AB_SLANTB
*     ..
