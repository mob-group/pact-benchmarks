...
*     .. External Subroutines ..
      EXTERNAL           AB_CGEMM, AB_CHERK, AB_CPBTF2, AB_CPOTF2, AB_CT
     $RSM, AB_XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MIN
...
*                    Update A22
*
                     CALL AB_CHERK( 'Upper', 'Conjugate transpose', I2, 
     $IB,
...
*                    Update A33
*
                     CALL AB_CHERK( 'Upper', 'Conjugate transpose', I3, 
     $IB,
     $                           -ONE, WORK, LDWORK, ONE,
     $                           AB( KD+1, I+KD ), LDAB-1 )
*
...
*                    Update A22
*
                     CALL AB_CHERK( 'Lower', 'No transpose', I2, IB, -ON
     $E,
...
*                    Update A33
*
                     CALL AB_CHERK( 'Lower', 'No transpose', I3, IB, -ON
     $E,
