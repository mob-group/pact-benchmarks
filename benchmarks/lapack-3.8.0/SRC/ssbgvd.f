...
*
*> \htmlonly
*> Download AB_AB_SSBGVD + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_AB_SSBGVD.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_AB_SSBGVD.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_AB_SSBGVD.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_AB_SSBGVD( JOBZ, UPLO, N, KA, KB, AB, LDAB, BB, LDBB, W,
...
*> \verbatim
*>
*> AB_AB_SSBGVD computes all the eigenvalues, and optionally, the eigenvectors
...
*
*  =====================================================================
      SUBROUTINE AB_AB_SSBGVD( JOBZ, UPLO, N, KA, KB, AB, LDAB, BB, LDBB
     $, W,
     $                   Z, LDZ, WORK, LWORK, IWORK, LIWORK, INFO )
*
...
*
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_AB_SSBGVD', -INFO )
         RETURN
      ELSE IF( LQUERY ) THEN
         RETURN
      END IF
