...
*
*> \htmlonly
*> Download AB_CGERFSX + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_CGERFSx.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_CGERFSx.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_CGERFSx.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_CGERFSX( TRANS, EQUED, N, NRHS, A, LDA, AF, LDAF, IPIV,
...
*> \verbatim
*>
*>    AB_CGERFSX improves the computed solution to a system of linear
...
*
*  =====================================================================
      SUBROUTINE AB_CGERFSX( TRANS, EQUED, N, NRHS, A, LDA, AF, LDAF, IP
     $IV,
     $                    R, C, B, LDB, X, LDX, RCOND, BERR, N_ERR_BNDS,
     $                    ERR_BNDS_NORM, ERR_BNDS_COMP, NPARAMS, PARAMS,
     $                    WORK, RWORK, INFO )
...
*     .. External Functions ..
      ...
      EXTERNAL           AB_SLAMCH, AB_CLANGE, AB_CLA_GERCOND_X, AB_CLA_GER
     $COND_C
      REAL               AB_SLAMCH, AB_CLANGE, AB_CLA_GERCOND_X, AB_CLA_GER
     $COND_C
      LOGICAL            AB_LSAME
...
*
     ...
     $         .NOT.AB_LSAME( EQUED, 'N' ) ) THEN
      ...
      END IF
      IF( INFO.NE.0 ) THEN
        CALL AB_XERBLA( 'AB_CGERFSX', -INFO )
        RETURN
      END IF
*
