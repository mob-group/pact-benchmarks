*> \brief \b AB_ZGSVJ1 pre-processor for the routine AB_ZGESVj, applies Jacobi rotations targeting only particular pivots.
*
*  =========== DOCUMENTATION ===========
*
...
*> \verbatim
*>
*> AB_ZGSVJ1 is called from AB_ZGESVJ as a pre-processor and that is its main
