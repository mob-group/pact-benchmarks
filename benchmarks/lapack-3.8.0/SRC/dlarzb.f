*> \brief \b AB_AB_DLARZB applies a block reflector or its transpose to a general matrix.
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download AB_AB_DLARZB + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_AB_DLARZB.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_AB_DLARZB.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_AB_DLARZB.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_AB_DLARZB( SIDE, TRANS, DIRECT, STOREV, M, N, K, L, V,
...
*> \verbatim
*>
*> AB_AB_DLARZB applies a real block reflector H or its transpose H**T to
...
*>
*  =====================================================================
      SUBROUTINE AB_AB_DLARZB( SIDE, TRANS, DIRECT, STOREV, M, N, K, L, 
     $V,
     $                   LDV, T, LDT, C, LDC, WORK, LDWORK )
*
...
*
      ...
      END IF
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_AB_DLARZB', -INFO )
         RETURN
      END IF
*
