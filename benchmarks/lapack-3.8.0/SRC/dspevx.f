*> \brief <b> AB_AB_DSPEVX computes the eigenvalues and, optionally, the left and/or right eigenvectors for OTHER matrices</b>
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download AB_AB_DSPEVX + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_AB_DSPEVX.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_AB_DSPEVX.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_AB_DSPEVX.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_AB_DSPEVX( JOBZ, RANGE, UPLO, N, AP, VL, VU, IL, IU,
...
*> \verbatim
*>
*> AB_AB_DSPEVX computes selected eigenvalues and, optionally, eigenvectors
...
*     .. External Subroutines ..
      EXTERNAL           AB_DCOPY, AB_DOPGTR, AB_DOPMTR, AB_DSCAL, AB_DS
     $PTRD, AB_DSTEBZ,
...
*
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_AB_DSPEVX', -INFO )
         RETURN
      END IF
*
...
*
      ...
      INDD = INDE + N
      INDWRK = INDD + N
      CALL AB_DSPTRD( UPLO, N, AP, WORK( INDD ), WORK( INDE ),
     $             WORK( INDTAU ), IINFO )
*
*     If all eigenvalues are desired and ABSTOL is less than or equal
*     to zero, then call AB_DSTERF or AB_DOPGTR and AB_SSTEQR.  If this fails
...
*
         CALL AB_DOPMTR( 'L', UPLO, 'N', N, M, AP, WORK( INDTAU ), Z, LD
     $Z,
     $                WORK( INDWRK ), IINFO )
      END IF
*
