...
*  ===========
*
*      SUBROUTINE AB_SGEMLQ( SIDE, TRANS, M, N, K, A, LDA, T,
...
*> \verbatim
*>
*>     AB_SGEMLQ overwrites the general real M-by-N matrix C with
*>
*>                    SIDE = 'L'     SIDE = 'R'
*>    TRANS = 'N':      Q * C          C * Q
*>    TRANS = 'T':      Q**T * C       C * Q**T
...
*>                               (LDA,M) if SIDE = 'L',
*>                               (LDA,N) if SIDE = 'R'
*>          Part of the data structure to represent Q as returned by AB_DGELQ.
*> \endverbatim
*>
*> \param[in] LDA
*> \verbatim
...
*>          Part of the data structure to represent Q as returned by AB_SGELQ.
*> \endverbatim
*>
*> \param[in] TSIZE
*> \verbatim
...
*>  AB_SLASWLQ (if the matrix is wide-and-short) or AB_AB_SGELQT to compute
*>  the LQ factorization.
*>  This version of AB_SGEMLQ will use either AB_SLAMSWLQ or AB_AB_SGEMLQT to 
*>  multiply matrix Q by another matrix.
*>  Further Details in AB_SLAMSWLQ or AB_AB_SGEMLQT.
*> \endverbatim
*>
*  =====================================================================
      SUBROUTINE AB_SGEMLQ( SIDE, TRANS, M, N, K, A, LDA, T, TSIZE,
...
*     .. External Subroutines ..
      EXTERNAL           AB_SLAMSWLQ, AB_AB_SGEMLQT, AB_XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
     ...
     $     .OR. ( NB.LE.K ) .OR. ( NB.GE.MAX( M, N, K ) ) ) THEN
        CALL AB_AB_SGEMLQT( SIDE, TRANS, M, N, K, MB, A, LDA,
     $                T( 6 ), MB, C, LDC, WORK, INFO )
      ELSE
        CALL AB_SLAMSWLQ( SIDE, TRANS, M, N, K, MB, NB, A, LDA, T( 6 ),
