C> \brief \b AB_CPOTRF VARIANT: top-looking block version of the algorit
...
C>\verbatim
C>
C> AB_CPOTRF computes the Cholesky factorization of a real symmetric
...
*
     ...
     $                      A( 1, J ), LDA )
               ...
               CALL AB_AB_CHERK( 'Upper', 'Conjugate Transpose', JB, J-1
     $,
...
*
     ...
     $                     A( J, 1 ), LDA )
               ...
               CALL AB_AB_CHERK( 'Lower', 'No Transpose', JB, J-1,
     $                     -ONE, A( J, 1 ), LDA,
     $                     ONE, A( J, J ), LDA )
*
*              Update and factorize the current diagonal block and test
