C> \brief \b AB_DPOTRF VARIANT: top-looking block version of the algorit
...
*
     ...
     $                      A( 1, J ), LDA )
               ...
               CALL AB_AB_DSYRK( 'Upper', 'Transpose', JB, J-1, -ONE,
     $                      A( 1, J ), LDA,
     $                      ONE, A( J, J ), LDA )
*
...
*
     ...
     $                     A( J, 1 ), LDA )
               ...
               CALL AB_AB_DSYRK( 'Lower', 'No Transpose', JB, J-1,
     $                     -ONE, A( J, 1 ), LDA,
     $                     ONE, A( J, J ), LDA )
