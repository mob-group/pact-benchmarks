C> \brief \b AB_SGETRF VARIANT: left-looking Level 3 BLAS version of the
     $ algorithm.
*
*  =========== DOCUMENTATION ===========
*
...
*     .. External Subroutines ..
      EXTERNAL           AB_SGEMM, AB_SGETF2, AB_SLASWP, AB_STRSM, AB_XE
     $RBLA
*     ..
*     .. External Functions ..
      INTEGER            AB_ILAENV
...
*        Use unblocked code.
*
         CALL AB_SGETF2( M, N, A, LDA, IPIV, INFO )
...
*
               CALL AB_SLASWP( JB, A(1, J), LDA, K, K+NB-1, IPIV, 1 )
*
...
*
               CALL AB_SGEMM( 'No transpose', 'No transpose',
     $                    M-K-NB+1, JB, NB, -ONE,
...
*           singularity.
*
            CALL AB_SGETF2( M-J+1, JB, A( J, J ), LDA, IPIV( J ), IINFO 
     $)
*
...
*
         DO 40 K = 1, MIN( M, N ), NB
            CALL AB_SLASWP( K-1, A( 1, 1 ), LDA, K,
...
*
         IF ( N.GT.M ) THEN
            ...
            CALL AB_SLASWP( N-M, A(1, M+1), LDA, 1, M, IPIV, 1 )
