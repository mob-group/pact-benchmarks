C> \brief \b AB_CGEQRF VARIANT: left-looking Level 3 BLAS version of the
     $ algorithm.
*
*  =========== DOCUMENTATION ===========
*
...
C>\verbatim
C>
C> AB_CGEQRF computes a QR factorization of a real M-by-N matrix A:
C> A = Q * R.
C>
...
C>                   NX = MAX( 0, AB_ILAENV( 3, 'AB_CGEQRF', ' ', M, N, 
     $-1, -1 ) )
C> \endverbatim
C> \verbatim
...
*
               CALL AB_CLARFB( 'Left', 'Transpose', 'Forward',
...
*           A(I:M,I:I+IB-1)
*
            CALL AB_CGEQR2( M-I+1, IB, A( I, I ), LDA, TAU( I ),
...
30           CONTINUE
             ...
             CALL AB_CGEQR2( M-I+1, K-I+1, A( I, I ), LDA, TAU( I ),
     $                   WORK(LBWORK*NB+NT*NT+1),IINFO )
...
*        Use unblocked code to factor the last or only block.
*
         CALL AB_CGEQR2( M-I+1, N-I+1, A( I, I ), LDA, TAU( I ),
     $               WORK,IINFO )
...
*
          IF ( NT .LE. NB ) THEN
               CALL AB_CLARFT( 'Forward', 'Columnwise', M-I+1, K-I+1,
