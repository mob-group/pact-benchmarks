...
*  ===========
*
*       RECURSIVE SUBROUTINE AB_SGELQT3( M, N, A, LDA, T, LDT, INFO )
*
*       .. Scalar Arguments ..
...
*
      ...
      END IF
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_SGELQT3', -INFO )
         RETURN
      END IF
*
      IF( M.EQ.1 ) THEN
...
*
         CALL AB_SLARFG( N, A, A( 1, MIN( 2, N ) ), LDA, T )
*
      ELSE
*
...
*
         CALL AB_SGELQT3( M1, N, A, LDA, T, LDT, IINFO )
*
...
*
         CALL AB_SGELQT3( M2, N-M1, A( I1, I1 ), LDA,
     &                T( I1, I1 ), LDT, IINFO )
*
