*> \brief <b> AB_CGGES computes the eigenvalues, the Schur form, and, optionally, the matrix of Schur vectors for GE matrices</b>
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download AB_CGGES + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_CGGES.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_CGGES.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_CGGES.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_CGGES( JOBVSL, JOBVSR, SORT, SELCTG, N, A, LDA, B, LDB,
...
*> \verbatim
*>
*> AB_CGGES computes for a pair of N-by-N complex nonsymmetric matrices
...
*>          output by AB_CGGES. The  BETA(j) will be non-negative real.
*>
...
*
*  =====================================================================
      SUBROUTINE AB_CGGES( JOBVSL, JOBVSR, SORT, SELCTG, N, A, LDA, B, L
     $DB,
     $                  SDIM, ALPHA, BETA, VSL, LDVSL, VSR, LDVSR, WORK,
     $                  LWORK, RWORK, BWORK, INFO )
*
...
*
      IF( INFO.EQ.0 ) THEN
         LWKMIN = MAX( 1, 2*N )
         LWKOPT = MAX( 1, N + N*AB_ILAENV( 1, 'AB_AB_CGEQRF', ' ', N, 1,
     $ N, 0 ) )
         LWKOPT = MAX( LWKOPT, N +
     $                 N*AB_ILAENV( 1, 'AB_CUNMQR', ' ', N, 1, N, -1 ) )
         IF( ILVSL ) THEN
            LWKOPT = MAX( LWKOPT, N +
     $                    N*AB_ILAENV( 1, 'AB_CUNGQR', ' ', N, 1, N, -1 
     $) )
         END IF
         WORK( 1 ) = LWKOPT
*
