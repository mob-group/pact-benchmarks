...
*> \verbatim
*>          N2 is INTEGER
*>          The order of the AB_SECOND block (A22, B22). N2 = 0, 1 or 2.
*> \endverbatim
*>
*> \param[out] WORK
*> \verbatim
...
*     .. External Subroutines ..
      EXTERNAL           AB_SGEMM, AB_AB_SGEQR2, AB_AB_SGERQ2, AB_SLACPY
     $, AB_SLAGV2, AB_SLARTG,
...
*
         DO 10 I = 1, N2
            ...
            LI( N1+I, I ) = SCALE
   10    CONTINUE
         CALL AB_AB_SGEQR2( M, N2, LI, LDST, TAUL, WORK, LINFO )
         IF( LINFO.NE.0 )
     $      GO TO 70
...
*
         DO 20 I = 1, N1
            IR( N2+I, I ) = SCALE
   20    CONTINUE
         CALL AB_AB_SGERQ2( N1, M, IR( N2+1, 1 ), LDST, TAUR, WORK, LINF
     $O )
         IF( LINFO.NE.0 )
     $      GO TO 70
...
*
         CALL AB_AB_SGERQ2( M, M, T, LDST, TAUR, WORK, LINFO )
         IF( LINFO.NE.0 )
     $      GO TO 70
...
*
         CALL AB_AB_SGEQR2( M, M, TCPY, LDST, TAUL, WORK, LINFO )
         IF( LINFO.NE.0 )
     $      GO TO 70
