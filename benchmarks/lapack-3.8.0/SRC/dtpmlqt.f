...
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_DTPMLQT.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_DTPMLQT.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_DTPMLQT.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_DTPMLQT( SIDE, TRANS, M, N, K, L, MB, V, LDV, T, LDT,
...
*     .. External Subroutines ..
      EXTERNAL           AB_XERBLA, AB_AB_DLARFB, AB_DTPRFB
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
*     ..
...
*
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_DTPMLQT', -INFO )
         RETURN
      END IF
*
...
*
         DO I = 1, K, MB
            ...
            ELSE
               LB = 0
            END IF
            CALL AB_DTPRFB( 'L', 'T', 'F', 'R', NB, N, IB, LB,
     $                   V( I, 1 ), LDV, T( 1, I ), LDT,
...
*
         DO I = 1, K, MB
            ...
            ELSE
               LB = NB-N+L-I+1
            END IF
            CALL AB_DTPRFB( 'R', 'N', 'F', 'R', M, NB, IB, LB,
     $                   V( I, 1 ), LDV, T( 1, I ), LDT,
...
*
         ...
         DO I = KF, 1, -MB
            ...
            ELSE
               LB = 0
            END IF
            CALL AB_DTPRFB( 'L', 'N', 'F', 'R', NB, N, IB, LB,
     $                   V( I, 1 ), LDV, T( 1, I ), LDT,
     $                   A( I, 1 ), LDA, B, LDB, WORK, IB )
         END DO
*
...
*
         ...
         DO I = KF, 1, -MB
            ...
            ELSE
               LB = NB-N+L-I+1
            END IF
            CALL AB_DTPRFB( 'R', 'T', 'F', 'R', M, NB, IB, LB,
     $                   V( I, 1 ), LDV, T( 1, I ), LDT,
     $                   A( 1, I ), LDA, B, LDB, WORK, M )
         END DO
*
