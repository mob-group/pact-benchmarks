...
*
*> \htmlonly
*> Download AB_AB_AB_DSYCONVF + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_AB_AB_DSYCONVF.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_AB_AB_DSYCONVF.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_AB_AB_DSYCONVF.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_AB_AB_DSYCONVF( UPLO, WAY, N, A, LDA, E, IPIV, INFO )
*
*       .. Scalar Arguments ..
*       CHARACTER          UPLO, WAY
*       INTEGER            INFO, LDA, N
...
*> \verbatim
*> If parameter WAY = 'C':
*> AB_AB_AB_DSYCONVF converts the factorization output format used in
...
*> the format used in AB_AB_DSYTRF_RK (or AB_DSYTRF_BK).
*>
*> If parameter WAY = 'R':
*> AB_AB_AB_DSYCONVF performs the conversion in reverse direction, i.e.
...
*> the intechanges stored in IPIV from the format used in AB_AB_DSYTRF_RK
...
*>          structure of D in the format used in AB_AB_DSYTRF_RK
*>          ( or AB_DSYTRF_BK).
*>
*>          1) If WAY ='R':
*>          On entry, details of the interchanges and the block
...
*
      ...
      END IF
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_AB_AB_DSYCONVF', -INFO )
         RETURN
      END IF
*
