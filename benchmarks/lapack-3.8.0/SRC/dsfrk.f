...
*     .. External Subroutines ..
      EXTERNAL           AB_XERBLA, AB_DGEMM, AB_AB_DSYRK
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX
*     ..
...
*     done (it is in AB_AB_DSYRK for example) and left in the general case.
*
...
*
                  CALL AB_AB_DSYRK( 'L', 'N', N1, K, ALPHA, A( 1, 1 ), L
     $DA,
     $                        BETA, C( 1 ), N )
                  CALL AB_AB_DSYRK( 'U', 'N', N2, K, ALPHA, A( N1+1, 1 )
     $, LDA,
     $                        BETA, C( N+1 ), N )
...
*
                  CALL AB_AB_DSYRK( 'L', 'T', N1, K, ALPHA, A( 1, 1 ), L
     $DA,
     $                        BETA, C( 1 ), N )
                  CALL AB_AB_DSYRK( 'U', 'T', N2, K, ALPHA, A( 1, N1+1 )
     $, LDA,
     $                        BETA, C( N+1 ), N )
...
*
     ...
     $DA,
     $                        BETA, C( N2+1 ), N )
                  CALL AB_AB_DSYRK( 'U', 'N', N2, K, ALPHA, A( N2, 1 ), 
     $LDA,
     $                        BETA, C( N1+1 ), N )
...
*
     ...
     $DA,
     $                        BETA, C( N2+1 ), N )
                  CALL AB_AB_DSYRK( 'U', 'T', N2, K, ALPHA, A( 1, N2 ), 
     $LDA,
     $                        BETA, C( N1+1 ), N )
...
*
                  CALL AB_AB_DSYRK( 'U', 'N', N1, K, ALPHA, A( 1, 1 ), L
     $DA,
     $                        BETA, C( 1 ), N1 )
                  CALL AB_AB_DSYRK( 'L', 'N', N2, K, ALPHA, A( N1+1, 1 )
     $, LDA,
     $                        BETA, C( 2 ), N1 )
                  CALL AB_DGEMM( 'N', 'T', N1, N2, K, ALPHA, A( 1, 1 ),
...
*
                  CALL AB_AB_DSYRK( 'U', 'T', N1, K, ALPHA, A( 1, 1 ), L
     $DA,
     $                        BETA, C( 1 ), N1 )
                  CALL AB_AB_DSYRK( 'L', 'T', N2, K, ALPHA, A( 1, N1+1 )
     $, LDA,
     $                        BETA, C( 2 ), N1 )
                  CALL AB_DGEMM( 'T', 'N', N1, N2, K, ALPHA, A( 1, 1 ),
...
*
                  CALL AB_AB_DSYRK( 'L', 'N', NK, K, ALPHA, A( 1, 1 ), L
     $DA,
     $                        BETA, C( 2 ), N+1 )
                  CALL AB_AB_DSYRK( 'U', 'N', NK, K, ALPHA, A( NK+1, 1 )
     $, LDA,
     $                        BETA, C( 1 ), N+1 )
...
*
                  CALL AB_AB_DSYRK( 'L', 'T', NK, K, ALPHA, A( 1, 1 ), L
     $DA,
     $                        BETA, C( 2 ), N+1 )
                  CALL AB_AB_DSYRK( 'U', 'T', NK, K, ALPHA, A( 1, NK+1 )
     $, LDA,
     $                        BETA, C( 1 ), N+1 )
...
*
                  CALL AB_AB_DSYRK( 'U', 'N', NK, K, ALPHA, A( 1, 1 ), L
     $DA,
     $                        BETA, C( NK+1 ), NK )
                  CALL AB_AB_DSYRK( 'L', 'N', NK, K, ALPHA, A( NK+1, 1 )
     $, LDA,
     $                        BETA, C( 1 ), NK )
                  CALL AB_DGEMM( 'N', 'T', NK, NK, K, ALPHA, A( 1, 1 ),
...
*
                  CALL AB_AB_DSYRK( 'U', 'T', NK, K, ALPHA, A( 1, 1 ), L
     $DA,
     $                        BETA, C( NK+1 ), NK )
                  CALL AB_AB_DSYRK( 'L', 'T', NK, K, ALPHA, A( 1, NK+1 )
     $, LDA,
     $                        BETA, C( 1 ), NK )
                  CALL AB_DGEMM( 'T', 'N', NK, NK, K, ALPHA, A( 1, 1 ),
