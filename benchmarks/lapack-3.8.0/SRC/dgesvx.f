*> \brief <b> AB_AB_DGESVX computes the solution to system of linear equations A * X = B for GE matrices</b>
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download AB_AB_DGESVX + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_AB_DGESVX.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_AB_DGESVX.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_AB_DGESVX.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_AB_DGESVX( FACT, TRANS, N, NRHS, A, LDA, AF, LDAF, IPIV,
...
*> \verbatim
*>
*> AB_AB_DGESVX uses the LU factorization to compute the solution to a real
...
*
*  =====================================================================
      SUBROUTINE AB_AB_DGESVX( FACT, TRANS, N, NRHS, A, LDA, AF, LDAF, I
     $PIV,
     $                   EQUED, R, C, B, LDB, X, LDX, RCOND, FERR, BERR,
     $                   WORK, IWORK, INFO )
*
...
*     .. External Subroutines ..
      EXTERNAL           AB_DGECON, AB_DGEEQU, AB_AB_DGERFS, AB_DGETRF, 
     $AB_DGETRS, AB_DLACPY,
     $                   AB_DLAQGE, AB_XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_AB_DGESVX', -INFO )
         RETURN
      END IF
*
      IF( EQUIL ) THEN
...
*
      CALL AB_AB_DGERFS( TRANS, N, NRHS, A, LDA, AF, LDAF, IPIV, B, LDB,
     $ X,
