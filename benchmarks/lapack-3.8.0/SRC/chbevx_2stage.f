*> \brief <b> AB_AB_AB_CHBEVX_2STAGE computes the eigenvalues and, optionally, the left and/or right eigenvectors for OTHER matrices</b>
*
*  @generated from AB_AB_AB_ZHBEVX_2STAGE.f, fortran z -> c, Sat Nov  5 23:18:22 2016
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download AB_AB_AB_CHBEVX_2STAGE + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_AB_AB_CHBEVX_2STAGE.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_AB_AB_CHBEVX_2STAGE.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_AB_AB_CHBEVX_2STAGE.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_AB_AB_CHBEVX_2STAGE( JOBZ, RANGE, UPLO, N, KD, AB, LDAB,
...
*> \verbatim
*>
*> AB_AB_AB_CHBEVX_2STAGE computes selected eigenvalues and, optionally, eigenvectors
...
*
*  =====================================================================
      SUBROUTINE AB_AB_AB_CHBEVX_2STAGE( JOBZ, RANGE, UPLO, N, KD, AB, L
     $DAB,
     $                          Q, LDQ, VL, VU, IL, IU, ABSTOL, M, W,
     $                          Z, LDZ, WORK, LWORK, RWORK, IWORK, 
     $                          IFAIL, INFO )
...
*     .. External Subroutines ..
     ...
     $RBLA, AB_CCOPY,
     $                   AB_CGEMV, AB_CLACPY, AB_CLASCL, AB_CSTEIN, AB_C
     $STEQR,
     $                   AB_CSWAP, AB_CHETRD_HB2ST
*     ..
*     .. Intrinsic Functions ..
...
*
      IF( INFO.EQ.0 ) THEN
         IF( N.LE.1 ) THEN
            ...
            WORK( 1 ) = LWMIN
         ELSE
            IB    = AB_AB_ILAENV2STAGE( 2, 'AB_CHETRD_HB2ST', JOBZ,
     $                            N, KD, -1, -1 )
            LHTRD = AB_AB_ILAENV2STAGE( 3, 'AB_CHETRD_HB2ST', JOBZ, 
     $                            N, KD, IB, -1 )
            LWTRD = AB_AB_ILAENV2STAGE( 4, 'AB_CHETRD_HB2ST', JOBZ, 
     $                            N, KD, IB, -1 )
            LWMIN = LHTRD + LWTRD
            WORK( 1 )  = LWMIN
         ENDIF
...
*
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_AB_AB_CHBEVX_2STAGE', -INFO )
         RETURN
      ELSE IF( LQUERY ) THEN
         RETURN
      END IF
...
*
      CALL AB_CHETRD_HB2ST( 'N', JOBZ, UPLO, N, KD, AB, LDAB,
