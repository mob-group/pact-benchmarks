...
*
*> \htmlonly
*> Download AB_AB_CHETRS_AA + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_AB_CHETRS_AA.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_AB_CHETRS_AA.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_AB_CHETRS_AA.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_AB_CHETRS_AA( UPLO, N, NRHS, A, LDA, IPIV, B, LDB,
*                             WORK, LWORK, INFO )
*
*       .. Scalar Arguments ..
*       CHARACTER          UPLO
...
*> \verbatim
*>
*> AB_AB_CHETRS_AA solves a system of linear equations A*X = B with a complex
*> hermitian matrix A using the factorization A = U*T*U**H or
*> A = L*T*L**H computed by AB_AB_CHETRF_AA.
*> \endverbatim
*
*  Arguments:
*  ==========
...
*>          Details of factors computed by AB_AB_CHETRF_AA.
*> \endverbatim
*>
*> \param[in] LDA
*> \verbatim
...
*>          Details of the interchanges as computed by AB_AB_CHETRF_AA.
*> \endverbatim
*>
*> \param[in,out] B
*> \verbatim
...
*
      ...
      END IF
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_AB_CHETRS_AA', -INFO )
         RETURN
      ELSE IF( LQUERY ) THEN
         LWKOPT = (3*N-2)
         WORK( 1 ) = LWKOPT
