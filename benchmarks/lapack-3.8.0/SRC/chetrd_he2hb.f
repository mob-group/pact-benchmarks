*> \brief \b AB_AB_CHETRD_HE2HB
*
*  @generated from AB_AB_ZHETRD_HE2HB.f, fortran z -> c, Wed Dec  7 08:22:40 2016
*      
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download AB_AB_CHETRD_HE2HB + dependencies 
...
*  ===========
*
*       SUBROUTINE AB_AB_CHETRD_HE2HB( UPLO, N, KD, A, LDA, AB, LDAB, TAU, 
*                              WORK, LWORK, INFO )
*
*       IMPLICIT NONE
*
...
*> \verbatim
*>
*> AB_AB_CHETRD_HE2HB reduces a complex Hermitian matrix A to complex Hermitian
...
*     .. External Subroutines ..
      EXTERNAL           AB_XERBLA, AB_AB_AB_CHER2K, AB_CHEMM, AB_CGEMM,
     $ AB_CCOPY,
     $                   AB_AB_CLARFT, AB_AB_CGELQF, AB_AB_CGEQRF, AB_CL
     $ASET
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MIN, MAX
...
*
      ...
      LQUERY = ( LWORK.EQ.-1 )
      LWMIN  = AB_ILAENV( 20, 'AB_AB_CHETRD_HE2HB', '', N, KD, -1, -1 )
...
*        
             CALL AB_AB_CGELQF( KD, PN, A( I, I+KD ), LDA,
...
*            Form the matrix T
*        
             CALL AB_AB_CLARFT( 'Forward', 'Rowwise', PN, PK,
     $                    A( I, I+KD ), LDA, TAU( I ), 
     $                    WORK( TPOS ), LDT )
*        
*            Compute W:
...
*        
             CALL AB_AB_AB_CHER2K( UPLO, 'Conjugate', PN, PK,
     $                    -ONE, A( I, I+KD ), LDA,
     $                          WORK( WPOS ), LDW,
...
*        
             CALL AB_AB_CGEQRF( PN, KD, A( I+KD, I ), LDA,
     $                    TAU( I ), WORK( S2POS ), LS2, IINFO )
*        
*            Copy the upper portion of A into AB 
*        
...
*            Form the matrix T
*        
             CALL AB_AB_CLARFT( 'Forward', 'Columnwise', PN, PK,
     $                    A( I+KD, I ), LDA, TAU( I ), 
     $                    WORK( TPOS ), LDT )
*        
*            Compute W:
...
*            an update of the form:  A := A - V*W' - W*V'
*        
             CALL AB_AB_AB_CHER2K( UPLO, 'No transpose', PN, PK,
     $                    -ONE, A( I+KD, I ), LDA,
     $                           WORK( WPOS ), LDW,
     $                    RONE, A( I+KD, I+KD ), LDA )
*            ==================================================================
