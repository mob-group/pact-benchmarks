...
*
*> \htmlonly
*> Download AB_AB_ZHETRF_AA + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_AB_ZHETRF_AA.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_AB_ZHETRF_AA.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_AB_ZHETRF_AA.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_AB_ZHETRF_AA( UPLO, N, A, LDA, IPIV, WORK, LWORK, INFO )
*
*       .. Scalar Arguments ..
*       CHARACTER    UPLO
...
*> \verbatim
*>
*> AB_AB_ZHETRF_AA computes the factorization of a complex hermitian matrix A
...
*
*  =====================================================================
      SUBROUTINE AB_AB_ZHETRF_AA( UPLO, N, A, LDA, IPIV, WORK, LWORK, IN
     $FO)
*
...
*     .. External Subroutines ..
      EXTERNAL     AB_AB_ZLAHEF_AA, AB_ZGEMM, AB_ZGEMV, AB_ZCOPY, AB_ZSC
     $AL, AB_ZSWAP, AB_XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
      NB = AB_ILAENV( 1, 'AB_AB_ZHETRF_AA', UPLO, N, -1, -1, -1 )
*
...
*
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_AB_ZHETRF_AA', -INFO )
         RETURN
      ELSE IF( LQUERY ) THEN
         RETURN
      END IF
...
*        Panel factorization
*
         CALL AB_AB_ZLAHEF_AA( UPLO, 2-K1, N-J, JB,
     $                      A( MAX(1, J), J+1 ), LDA,
