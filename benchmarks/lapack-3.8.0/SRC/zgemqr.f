...
*>                           AB_ZLATSQR or AB_AB_ZGEQRT
*>
*>  Depending on the matrix dimensions M and N, and row and column
*>  block sizes MB and NB returned by AB_ILAENV, AB_ZGEQR will use either
*>  AB_ZLATSQR (if the matrix is tall-and-skinny) or AB_AB_ZGEQRT to compute
*>  the QR factorization.
*>  This version of AB_ZGEMQR will use either AB_ZLAMTSQR or AB_AB_ZGEMQRT to
*>  multiply matrix Q by another matrix.
*>  Further Details in AB_ZLAMTSQR or AB_AB_ZGEMQRT.
*>
*> \endverbatim
*>
*  =====================================================================
...
*     .. External Subroutines ..
      EXTERNAL           AB_AB_ZGEMQRT, AB_ZLAMTSQR, AB_XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
     ...
     $     .OR. ( MB.LE.K ) .OR. ( MB.GE.MAX( M, N, K ) ) ) THEN
        CALL AB_AB_ZGEMQRT( SIDE, TRANS, M, N, K, NB, A, LDA, T( 6 ),
     $                NB, C, LDC, WORK, INFO )
      ELSE
