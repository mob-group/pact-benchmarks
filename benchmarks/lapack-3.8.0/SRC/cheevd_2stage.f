*> \brief <b> AB_CHEEVD_2STAGE computes the eigenvalues and, optionally, the left and/or right eigenvectors for HE matrices</b>
*
*  @generated from AB_ZHEEVd_2stage.f, fortran z -> c, Sat Nov  5 23:18:14 2016
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download AB_CHEEVD_2STAGE + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_CHEEVd_2stage.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_CHEEVd_2stage.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_CHEEVd_2stage.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_CHEEVD_2STAGE( JOBZ, UPLO, N, A, LDA, W, WORK, LWORK,
...
*> \verbatim
*>
*> AB_CHEEVD_2STAGE computes all eigenvalues and, optionally, eigenvectors of a
...
*     .. External Subroutines ..
     ...
     $LASCL,
     $                   AB_CSTEDC, AB_CUNMTR, AB_CHETRD_2STAGE
*     ..
*     .. Intrinsic Functions ..
...
*
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_CHEEVD_2STAGE', -INFO )
         RETURN
      ELSE IF( LQUERY ) THEN
         RETURN
      END IF
