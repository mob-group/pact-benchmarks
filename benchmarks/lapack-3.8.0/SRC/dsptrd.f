...
*     .. External Subroutines ..
      EXTERNAL           AB_DAXPY, AB_AB_DLARFG, AB_DSPMV, AB_AB_DSPR2, 
     $AB_XERBLA
*     ..
*     .. External Functions ..
      LOGICAL            AB_LSAME
...
*
            CALL AB_AB_DLARFG( I, AP( I1+I-1 ), AP( I1 ), 1, TAUI )
            E( I ) = AP( I1+I-1 )
*
...
*                 A := A - v * w**T - w * v**T
*
               CALL AB_AB_DSPR2( UPLO, I, -ONE, AP( I1 ), 1, TAU, 1, AP 
     $)
*
               AP( I1+I-1 ) = E( I )
            END IF
...
*
            CALL AB_AB_DLARFG( N-I, AP( II+1 ), AP( II+2 ), 1, TAUI )
            E( I ) = AP( II+1 )
*
            IF( TAUI.NE.ZERO ) THEN
*
...
*                 A := A - v * w**T - w * v**T
*
               CALL AB_AB_DSPR2( UPLO, N-I, -ONE, AP( II+1 ), 1, TAU( I 
     $), 1,
     $                     AP( I1I1 ) )
*
               AP( II+1 ) = E( I )
