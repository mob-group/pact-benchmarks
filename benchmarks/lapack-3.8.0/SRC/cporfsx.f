...
*
*> \htmlonly
*> Download AB_AB_CPORFSX + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_AB_CPORFSX.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_AB_CPORFSX.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_AB_CPORFSX.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_AB_CPORFSX( UPLO, EQUED, N, NRHS, A, LDA, AF, LDAF, S, B,
...
*> \verbatim
*>
*>    AB_AB_CPORFSX improves the computed solution to a system of linear
...
*
*  =====================================================================
      SUBROUTINE AB_AB_CPORFSX( UPLO, EQUED, N, NRHS, A, LDA, AF, LDAF, 
     $S, B,
     $                    LDB, X, LDX, RCOND, BERR, N_ERR_BNDS,
     $                    ERR_BNDS_NORM, ERR_BNDS_COMP, NPARAMS, PARAMS,
     $                    WORK, RWORK, INFO )
...
*     .. External Subroutines ..
      EXTERNAL           AB_XERBLA, AB_CPOCON, AB_CLA_PORFSX_EXTENDED
*     ..
*     .. Intrinsic Functions ..
...
*     .. External Functions ..
      ...
      EXTERNAL           AB_SLAMCH, AB_CLANHE, AB_CLA_PORCOND_X, AB_CLA_
     $PORCOND_C
      REAL               AB_SLAMCH, AB_CLANHE, AB_CLA_PORCOND_X, AB_CLA_
     $PORCOND_C
      LOGICAL            AB_LSAME
      INTEGER            AB_ILAPREC
*     ..
...
*
     ...
     $THEN
      ...
      END IF
      IF( INFO.NE.0 ) THEN
        CALL AB_XERBLA( 'AB_AB_CPORFSX', -INFO )
        RETURN
      END IF
*
...
*
      ...
      CALL AB_CPOCON( UPLO, N, AF, LDAF, ANORM, RCOND, WORK, RWORK,
     $     INFO )
*
...
*
      IF ( REF_TYPE .NE. 0 ) THEN
         ...
         CALL AB_CLA_PORFSX_EXTENDED( PREC_TYPE, UPLO, N,
...
*
         IF ( RCEQU ) THEN
            RCOND_TMP = AB_CLA_PORCOND_C( UPLO, N, A, LDA, AF, LDAF,
...
*
     ...
     $     THEN
               RCOND_TMP = AB_CLA_PORCOND_X( UPLO, N, A, LDA, AF, LDAF,
