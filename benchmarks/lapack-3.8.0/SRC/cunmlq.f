...
*     .. External Subroutines ..
      EXTERNAL           AB_AB_CLARFB, AB_AB_CLARFT, AB_CUNML2, AB_XERBL
     $A
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
...
*
            CALL AB_AB_CLARFT( 'Forward', 'Rowwise', NQ-I+1, IB, A( I, I
     $ ),
...
*           Apply H or H**H
*
            CALL AB_AB_CLARFB( SIDE, TRANST, 'Forward', 'Rowwise', MI, N
     $I, IB,
