...
*
*> \htmlonly
*> Download AB_AB_DSPRFS + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_AB_DSPRFS.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_AB_DSPRFS.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_AB_DSPRFS.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_AB_DSPRFS( UPLO, N, NRHS, AP, AFP, IPIV, B, LDB, X, LDX,
...
*> \verbatim
*>
*> AB_AB_DSPRFS improves the computed solution to a system of linear
...
*
*  =====================================================================
      SUBROUTINE AB_AB_DSPRFS( UPLO, N, NRHS, AP, AFP, IPIV, B, LDB, X, 
     $LDX,
     $                   FERR, BERR, WORK, IWORK, INFO )
*
...
*
      ...
      END IF
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_AB_DSPRFS', -INFO )
         RETURN
      END IF
*
