...
*
*> \htmlonly
*> Download AB_AB_AB_DSYTRI_3X + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_AB_AB_DSYTRI_3X.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_AB_AB_DSYTRI_3X.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_AB_AB_DSYTRI_3X.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_AB_AB_DSYTRI_3X( UPLO, N, A, LDA, E, IPIV, WORK, NB, INFO )
*
*       .. Scalar Arguments ..
*       CHARACTER          UPLO
...
*>
*> \verbatim
*> AB_AB_AB_DSYTRI_3X computes the inverse of a real symmetric indefinite
*> matrix A using the factorization computed by AB_AB_DSYTRF_RK or AB_DSYTRF_BK:
*>
...
*>          factors U or L as computed by AB_AB_DSYTRF_RK and AB_DSYTRF_BK:
...
*>          as determined by AB_AB_DSYTRF_RK or AB_DSYTRF_BK.
*> \endverbatim
*>
*> \param[out] WORK
*> \verbatim
...
*
*  =====================================================================
      SUBROUTINE AB_AB_AB_DSYTRI_3X( UPLO, N, A, LDA, E, IPIV, WORK, NB,
     $ INFO )
*
...
*     .. External Subroutines ..
      EXTERNAL           AB_DGEMM, AB_DSYSWAPR, AB_DTRTRI, AB_DTRMM, AB_
     $XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_AB_AB_DSYTRI_3X', -INFO )
         RETURN
      END IF
      IF( N.EQ.0 )
     $   RETURN
...
*
            CALL AB_DGEMM( 'T', 'N', NNB, NNB, CUT, ONE, A( 1, CUT+1 ),
...
*           L11**T * invD1 * L11 -> L11
*
            CALL AB_DTRMM( 'L', UPLO, 'T', 'U', NNB, NNB, ONE,
...
*
               CALL AB_DGEMM( 'T', 'N', NNB, NNB, N-NNB-CUT, ONE,
...
*              L01 =  L22**T * invD2 * L21
*
               CALL AB_DTRMM( 'L', UPLO, 'T', 'U', N-NNB-CUT, NNB, ONE,
