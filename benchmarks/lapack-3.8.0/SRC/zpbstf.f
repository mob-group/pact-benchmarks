...
*
            CALL ZAB_DSCAL( KM, ONE / AJJ, AB( KD+1-KM, J ), 1 )
...
*
            IF( KM.GT.0 ) THEN
               CALL ZAB_DSCAL( KM, ONE / AJJ, AB( KD, J+1 ), KLD )
...
*           trailing submatrix within the band.
*
            CALL ZAB_DSCAL( KM, ONE / AJJ, AB( KM+1, J-KM ), KLD )
...
*
            IF( KM.GT.0 ) THEN
               CALL ZAB_DSCAL( KM, ONE / AJJ, AB( 2, J ), 1 )
