...
*  ===========
*
*       SUBROUTINE AB_AB_SGEMLQT( SIDE, TRANS, M, N, K, MB, V, LDV, T, LDT,
*                          C, LDC, WORK, INFO )
*
*       .. Scalar Arguments ..
...
*
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_AB_SGEMLQT', -INFO )
         RETURN
      END IF
*
...
*
         DO I = 1, K, MB
            IB = MIN( MB, K-I+1 )
            CALL AB_AB_SLARFB( 'L', 'T', 'F', 'R', M-I+1, N, IB,
     $                   V( I, I ), LDV, T( 1, I ), LDT,
...
*
         DO I = 1, K, MB
            IB = MIN( MB, K-I+1 )
            CALL AB_AB_SLARFB( 'R', 'N', 'F', 'R', M, N-I+1, IB,
     $                   V( I, I ), LDV, T( 1, I ), LDT,
...
*
         ...
         DO I = KF, 1, -MB
            IB = MIN( MB, K-I+1 )
            CALL AB_AB_SLARFB( 'L', 'N', 'F', 'R', M-I+1, N, IB,
     $                   V( I, I ), LDV, T( 1, I ), LDT,
     $                   C( I, 1 ), LDC, WORK, LDWORK )
         END DO
*
...
*
         ...
         DO I = KF, 1, -MB
            IB = MIN( MB, K-I+1 )
            CALL AB_AB_SLARFB( 'R', 'T', 'F', 'R', M, N-I+1, IB,
     $                   V( I, I ), LDV, T( 1, I ), LDT,
     $                   C( 1, I ), LDC, WORK, LDWORK )
         END DO
*
