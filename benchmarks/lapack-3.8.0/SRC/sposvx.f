*> \brief <b> AB_SPOSVX computes the solution to system of linear equations A * X = B for PO matrices</b>
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download AB_SPOSVX + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_SPOSVx.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_SPOSVx.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_SPOSVx.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_SPOSVX( FACT, UPLO, N, NRHS, A, LDA, AF, LDAF, EQUED,
...
*> \verbatim
*>
*> AB_SPOSVX uses the Cholesky factorization A = U**T*U or A = L*L**T to
...
*     .. External Functions ..
      ...
      EXTERNAL           AB_LSAME, SLAMCH, AB_SLANSY
*     ..
