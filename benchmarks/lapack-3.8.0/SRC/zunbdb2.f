...
*
*> \htmlonly
*> Download AB_ZUNBDB2 + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_ZUNBDB2.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_ZUNBDB2.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_ZUNBDB2.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_ZUNBDB2( M, P, Q, X11, LDX11, X21, LDX21, THETA, PHI,
...
*>\verbatim
*>
*> AB_ZUNBDB2 simultaneously bidiagonalizes the blocks of a tall and skinny
...
*> Q, or M-Q. Routines AB_ZUNBDB1, AB_ZUNBDB3, and AB_ZUNBDB4 handle cases in
...
*
      ...
      END IF
      IF( INFO .NE. 0 ) THEN
         CALL AB_XERBLA( 'AB_ZUNBDB2', -INFO )
         RETURN
      ELSE IF( LQUERY ) THEN
         RETURN
      END IF
...
*
         IF( I .GT. 1 ) THEN
            CALL AB_ZDROT( Q-I+1, X11(I,I), LDX11, X21(I-1,I), LDX21, C,
     $                  S )
         END IF
     ...
     $           + AB_DZNRM2( M-P-I+1, X21(I,I), 1 )**2 )
         THETA(I) = ATAN2( S, C )
*
         CALL AB_ZUNBDB5( P-I, M-P-I+1, Q-I, X11(I+1,I), 1, X21(I,I), 1,
     ...
     $                 WORK(IORBDB5), LORBDB5, CHILDINFO )
         ...
         IF( I .LT. P ) THEN
            CALL AB_ZLARFGP( P-I, X11(I+1,I), X11(I+2,I), 1, TAUP1(I) )
