...
*
*> \htmlonly
*> Download AB_DSYTRI2X + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_DSYTRI2x.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_DSYTRI2x.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_DSYTRI2x.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_DSYTRI2X( UPLO, N, A, LDA, IPIV, WORK, NB, INFO )
*
*       .. Scalar Arguments ..
*       CHARACTER          UPLO
...
*> \verbatim
*>
*> AB_DSYTRI2X computes the inverse of a real symmetric indefinite matrix
...
*     .. External Subroutines ..
      EXTERNAL           AB_DSYCONV, AB_XERBLA, AB_DTRTRI
...
*
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_DSYTRI2X', -INFO )
         RETURN
      END IF
      IF( N.EQ.0 )
     $   RETURN
...
*
      CALL AB_DSYCONV( UPLO, 'C', N, A, LDA, IPIV, WORK, IINFO )
*
