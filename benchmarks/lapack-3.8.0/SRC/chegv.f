...
*
*> \htmlonly
*> Download AB_CHEGV + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_CHEGV.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_CHEGV.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_CHEGV.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_CHEGV( ITYPE, JOBZ, UPLO, N, A, LDA, B, LDB, W, WORK,
*                         LWORK, RWORK, INFO )
*
*       .. Scalar Arguments ..
*       CHARACTER          JOBZ, UPLO
...
*> \verbatim
*>
*> AB_CHEGV computes all the eigenvalues, and optionally, the eigenvectors
...
*     .. External Subroutines ..
      EXTERNAL           AB_CHEEV, AB_CHEGST, AB_CPOTRF, AB_CTRMM, AB_CT
     $RSM, AB_XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX
