*> \brief <b> AB_ZHEEVX_2STAGE computes the eigenvalues and, optionally, the left and/or right eigenvectors for HE matrices</b>
*
...
*
*> \htmlonly
*> Download AB_ZHEEVX_2STAGE + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_ZHEEVx_2stage.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_ZHEEVx_2stage.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_ZHEEVx_2stage.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_ZHEEVX_2STAGE( JOBZ, RANGE, UPLO, N, A, LDA, VL, VU,
...
*> \verbatim
*>
*> AB_ZHEEVX_2STAGE computes selected eigenvalues and, optionally, eigenvectors
...
*     .. External Functions ..
      ...
      EXTERNAL           AB_LSAME, AB_DLAMCH, AB_ZLANHE, AB_ILAENV2STAGE
*     ..
...
*
      IF( INFO.EQ.0 ) THEN
         IF( N.LE.1 ) THEN
            ...
            WORK( 1 ) = LWMIN
         ELSE
            KD    = AB_ILAENV2STAGE( 1, 'AB_ZHETRD_2STAGE', JOBZ,
     $                            N, -1, -1, -1 )
            IB    = AB_ILAENV2STAGE( 2, 'AB_ZHETRD_2STAGE', JOBZ,
     $                            N, KD, -1, -1 )
            LHTRD = AB_ILAENV2STAGE( 3, 'AB_ZHETRD_2STAGE', JOBZ,
     $                            N, KD, IB, -1 )
            LWTRD = AB_ILAENV2STAGE( 4, 'AB_ZHETRD_2STAGE', JOBZ,
     $                            N, KD, IB, -1 )
            LWMIN = N + LHTRD + LWTRD
            WORK( 1 )  = LWMIN
         END IF
...
*
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_ZHEEVX_2STAGE', -INFO )
         RETURN
      ELSE IF( LQUERY ) THEN
         RETURN
      END IF
...
*
      CALL AB_ZHETRD_2STAGE( JOBZ, UPLO, N, A, LDA, RWORK( INDD ),
