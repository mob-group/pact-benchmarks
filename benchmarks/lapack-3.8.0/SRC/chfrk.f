...
*     .. External Subroutines ..
      EXTERNAL           AB_CGEMM, AB_AB_CHERK, AB_XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, CMPLX
*     ..
...
*     done (it is in AB_AB_CHERK for example) and left in the general case.
*
...
*
                  CALL AB_AB_CHERK( 'L', 'N', N1, K, ALPHA, A( 1, 1 ), L
     $DA,
     $                        BETA, C( 1 ), N )
                  CALL AB_AB_CHERK( 'U', 'N', N2, K, ALPHA, A( N1+1, 1 )
     $, LDA,
     $                        BETA, C( N+1 ), N )
...
*
                  CALL AB_AB_CHERK( 'L', 'C', N1, K, ALPHA, A( 1, 1 ), L
     $DA,
     $                        BETA, C( 1 ), N )
                  CALL AB_AB_CHERK( 'U', 'C', N2, K, ALPHA, A( 1, N1+1 )
     $, LDA,
     $                        BETA, C( N+1 ), N )
...
*
     ...
     $DA,
     $                        BETA, C( N2+1 ), N )
                  CALL AB_AB_CHERK( 'U', 'N', N2, K, ALPHA, A( N2, 1 ), 
     $LDA,
     $                        BETA, C( N1+1 ), N )
...
*
     ...
     $DA,
     $                        BETA, C( N2+1 ), N )
                  CALL AB_AB_CHERK( 'U', 'C', N2, K, ALPHA, A( 1, N2 ), 
     $LDA,
     $                        BETA, C( N1+1 ), N )
...
*
                  CALL AB_AB_CHERK( 'U', 'N', N1, K, ALPHA, A( 1, 1 ), L
     $DA,
     $                        BETA, C( 1 ), N1 )
                  CALL AB_AB_CHERK( 'L', 'N', N2, K, ALPHA, A( N1+1, 1 )
     $, LDA,
     $                        BETA, C( 2 ), N1 )
                  CALL AB_CGEMM( 'N', 'C', N1, N2, K, CALPHA, A( 1, 1 ),
...
*
                  CALL AB_AB_CHERK( 'U', 'C', N1, K, ALPHA, A( 1, 1 ), L
     $DA,
     $                        BETA, C( 1 ), N1 )
                  CALL AB_AB_CHERK( 'L', 'C', N2, K, ALPHA, A( 1, N1+1 )
     $, LDA,
     $                        BETA, C( 2 ), N1 )
                  CALL AB_CGEMM( 'C', 'N', N1, N2, K, CALPHA, A( 1, 1 ),
...
*
                  CALL AB_AB_CHERK( 'L', 'N', NK, K, ALPHA, A( 1, 1 ), L
     $DA,
     $                        BETA, C( 2 ), N+1 )
                  CALL AB_AB_CHERK( 'U', 'N', NK, K, ALPHA, A( NK+1, 1 )
     $, LDA,
     $                        BETA, C( 1 ), N+1 )
...
*
                  CALL AB_AB_CHERK( 'L', 'C', NK, K, ALPHA, A( 1, 1 ), L
     $DA,
     $                        BETA, C( 2 ), N+1 )
                  CALL AB_AB_CHERK( 'U', 'C', NK, K, ALPHA, A( 1, NK+1 )
     $, LDA,
     $                        BETA, C( 1 ), N+1 )
...
*
                  CALL AB_AB_CHERK( 'U', 'N', NK, K, ALPHA, A( 1, 1 ), L
     $DA,
     $                        BETA, C( NK+1 ), NK )
                  CALL AB_AB_CHERK( 'L', 'N', NK, K, ALPHA, A( NK+1, 1 )
     $, LDA,
     $                        BETA, C( 1 ), NK )
                  CALL AB_CGEMM( 'N', 'C', NK, NK, K, CALPHA, A( 1, 1 ),
...
*
                  CALL AB_AB_CHERK( 'U', 'C', NK, K, ALPHA, A( 1, 1 ), L
     $DA,
     $                        BETA, C( NK+1 ), NK )
                  CALL AB_AB_CHERK( 'L', 'C', NK, K, ALPHA, A( 1, NK+1 )
     $, LDA,
     $                        BETA, C( 1 ), NK )
                  CALL AB_CGEMM( 'C', 'N', NK, NK, K, CALPHA, A( 1, 1 ),
