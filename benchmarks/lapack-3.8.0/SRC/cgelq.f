...
*>                           AB_CLASWLQ or AB_CGELQT
*>
*>  Depending on the matrix dimensions M and N, and row and column
*>  block sizes MB and NB returned by AB_ILAENV, AB_CGELQ will use either
*>  AB_CLASWLQ (if the matrix is short-and-wide) or AB_CGELQT to compute
...
*     .. External Subroutines ..
      EXTERNAL           AB_CGELQT, AB_CLASWLQ, AB_XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
      IF( ( N.LE.M ) .OR. ( NB.LE.M ) .OR. ( NB.GE.N ) ) THEN
        CALL AB_CGELQT( M, N, MB, A, LDA, T( 6 ), MB, WORK, INFO )
      ELSE
