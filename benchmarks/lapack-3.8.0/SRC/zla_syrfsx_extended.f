...
*> This subroutine is called by AB_ZSYRFSX to perform iterative refinement.
...
*     .. External Subroutines ..
      EXTERNAL           AB_ZAXPY, AB_ZCOPY, AB_ZSYTRS, AB_ZSYMV, BLAS_Z
     $SYMV_X,
     $                   BLAS_ZSYMV2_X, AB_ZLA_SYAMV, AB_ZLA_WWADDW,
     $                   AB_ZLA_LIN_BERR
