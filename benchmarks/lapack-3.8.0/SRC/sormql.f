...
*     .. External Subroutines ..
      EXTERNAL           AB_AB_SLARFB, AB_AB_SLARFT, AB_SORM2L, AB_XERBL
     $A
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
...
*
            CALL AB_AB_SLARFT( 'Backward', 'Columnwise', NQ-K+I+IB-1, IB
     $,
...
*           Apply H or H**T
*
            CALL AB_AB_SLARFB( SIDE, TRANS, 'Backward', 'Columnwise', MI
     $, NI,
