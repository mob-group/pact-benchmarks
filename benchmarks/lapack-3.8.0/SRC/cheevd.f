*> \brief <b> AB_AB_CHEEVD computes the eigenvalues and, optionally, the left and/or right eigenvectors for HE matrices</b>
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download AB_AB_CHEEVD + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_AB_CHEEVD.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_AB_CHEEVD.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_AB_CHEEVD.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_AB_CHEEVD( JOBZ, UPLO, N, A, LDA, W, WORK, LWORK, RWORK,
...
*> \verbatim
*>
*> AB_AB_CHEEVD computes all eigenvalues and, optionally, eigenvectors of a
...
*>
*  =====================================================================
      SUBROUTINE AB_AB_CHEEVD( JOBZ, UPLO, N, A, LDA, W, WORK, LWORK, RW
     $ORK,
     $                   LRWORK, IWORK, LIWORK, INFO )
*
...
*
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_AB_CHEEVD', -INFO )
         RETURN
      ELSE IF( LQUERY ) THEN
         RETURN
      END IF
