...
*     .. External Subroutines ..
      EXTERNAL           AB_STPMLQT, AB_AB_SGEMLQT, AB_XERBLA
*     ..
...
*
          CALL AB_AB_SGEMLQT('L','T',NB , N, K, MB, A(1,1), LDA, T
...
*
         ...
         II=M-KK+1
         CTR = 1
         CALL AB_AB_SGEMLQT('L','N',NB , N, K, MB, A(1,1), LDA, T
     $              ,LDT ,C(1,1), LDC, WORK, INFO )
*
...
*
          CALL AB_AB_SGEMLQT('R','N',M , NB, K, MB, A(1,1), LDA, T
     $            ,LDT ,C(1,1), LDC, WORK, INFO )
*
...
*
         ...
         II=N-KK+1
         CTR = 1
         CALL AB_AB_SGEMLQT('R','T',M , NB, K, MB, A(1,1), LDA, T
     $            ,LDT ,C(1,1), LDC, WORK, INFO )
*
         DO I=NB+1,II-NB+K,(NB-K)
*
