*> \brief <b> AB_AB_AB_ZSYSVXX computes the solution to system of linear equations A * X = B for SY matrices</b>
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download AB_AB_AB_ZSYSVXX + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_AB_AB_ZSYSVXX.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_AB_AB_ZSYSVXX.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_AB_AB_ZSYSVXX.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_AB_AB_ZSYSVXX( FACT, UPLO, N, NRHS, A, LDA, AF, LDAF, IPIV,
...
*> \verbatim
*>
*>    AB_AB_AB_ZSYSVXX uses the diagonal pivoting factorization to compute the
*>    solution to a complex*16 system of linear equations A * X = B, where
*>    A is an N-by-N symmetric matrix and X and B are N-by-NRHS
*>    matrices.
*>
*>    If requested, both normwise and maximum componentwise error bounds
*>    are returned. AB_AB_AB_ZSYSVXX will return a solution with a tiny
*>    guaranteed error (O(eps) where eps is the working machine
*>    precision) unless the matrix is very ill-conditioned, in which
*>    case a warning is returned. Relevant condition numbers also are
*>    calculated and returned.
*>
*>    AB_AB_AB_ZSYSVXX accepts user-provided factorizations and equilibration
*>    factors; see the definitions of the FACT and EQUED options.
*>    Solving with refinement and using a factorization from a previous
*>    AB_AB_AB_ZSYSVXX call will also produce a solution with either O(eps)
*>    errors or warnings, but we cannot make that claim for general
*>    user-provided factorizations and equilibration factors if they
*>    differ from what AB_AB_AB_ZSYSVXX would itself produce.
*> \endverbatim
*
*> \par Description:
*  =================
...
*
*  =====================================================================
      SUBROUTINE AB_AB_AB_ZSYSVXX( FACT, UPLO, N, NRHS, A, LDA, AF, LDAF
     $, IPIV,
     $                    EQUED, S, B, LDB, X, LDX, RCOND, RPVGRW, BERR,
     $                    N_ERR_BNDS, ERR_BNDS_NORM, ERR_BNDS_COMP,
     $                    NPARAMS, PARAMS, WORK, RWORK, INFO )
...
*     ..
*     .. External Functions ..
      EXTERNAL           AB_LSAME, AB_DLAMCH, AB_ZLA_SYRPVGRW
      LOGICAL            AB_LSAME
      DOUBLE PRECISION   AB_DLAMCH, AB_ZLA_SYRPVGRW
*     ..
*     .. External Subroutines ..
      EXTERNAL           AB_ZSYEQUB, AB_ZSYTRF, AB_ZSYTRS, AB_ZLACPY,
     $                   AB_ZLAQSY, AB_XERBLA, AB_AB_ZLASCL2, AB_AB_AB_Z
     $SYRFSX
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
...
*     pivot growth is set here, the rest is initialized in AB_AB_AB_ZSYRFSX.
*
      RPVGRW = ZERO
*
*     Test the input parameters.  PARAMS is not tested until AB_AB_AB_ZSYRFSX.
*
...
*
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_AB_AB_ZSYSVXX', -INFO )
         RETURN
      END IF
*
      IF( EQUIL ) THEN
...
*
      CALL AB_AB_AB_ZSYRFSX( UPLO, EQUED, N, NRHS, A, LDA, AF, LDAF, IPI
     $V,
