*> \brief <b> AB_SSYEVR_2STAGE computes the eigenvalues and, optionally, the left and/or right eigenvectors for SY matrices</b>
*
*  @generated from AB_DSYEVr_2stage.f, fortran d -> s, Sat Nov  5 23:50:10 2016
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download AB_SSYEVR_2STAGE + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_SSYEVr_2stage.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_SSYEVr_2stage.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_SSYEVr_2stage.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_SSYEVR_2STAGE( JOBZ, RANGE, UPLO, N, A, LDA, VL, VU,
...
*> \verbatim
*>
*> AB_SSYEVR_2STAGE computes selected eigenvalues and, optionally, eigenvectors
*> of a real symmetric matrix A using the 2stage technique for
*> the reduction to tridiagonal.  Eigenvalues and eigenvectors can be
*> selected by specifying either a range of values or a range of
*> indices for the desired eigenvalues.
*>
*> AB_SSYEVR_2STAGE first reduces the matrix A to tridiagonal form T with a call
*> to AB_SSYTRD.  Then, whenever possible, AB_SSYEVR_2STAGE calls AB_SSTEMR to compute
...
*>
*>
*> Note 1 : AB_SSYEVR_2STAGE calls AB_SSTEMR when the full spectrum is requested
*> on machines which conform to the ieee-754 floating point standard.
*> AB_SSYEVR_2STAGE calls AB_SSTEBZ and AB_SSTEIN on non-ieee machines and
...
*     .. External Functions ..
      ...
      EXTERNAL           AB_LSAME, AB_SLAMCH, AB_SLANSY, AB_ILAENV, AB_ILAE
     $NV2STAGE
*     ..
*     .. External Subroutines ..
      EXTERNAL           AB_SCOPY, AB_SORMTR, AB_SSCAL, AB_SSTEBZ, AB_SS
     $TEMR, AB_SSTEIN,
     $                   AB_SSTERF, AB_SSWAP, AB_SSYTRD_2STAGE, AB_XERBL
     $A
*     ..
*     .. Intrinsic Functions ..
...
*
      IEEEOK = AB_ILAENV( 10, 'AB_SSYEVR', 'N', 1, 2, 3, 4 )
*
...
*
      KD     = AB_ILAENV2STAGE( 1, 'AB_SSYTRD_2STAGE', JOBZ, N, -1, -1, 
     $-1 )
      IB     = AB_ILAENV2STAGE( 2, 'AB_SSYTRD_2STAGE', JOBZ, N, KD, -1, 
     $-1 )
      LHTRD  = AB_ILAENV2STAGE( 3, 'AB_SSYTRD_2STAGE', JOBZ, N, KD, IB, 
     $-1 )
      LWTRD  = AB_ILAENV2STAGE( 4, 'AB_SSYTRD_2STAGE', JOBZ, N, KD, IB, 
     $-1 )
...
*
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_SSYEVR_2STAGE', -INFO )
         RETURN
      ELSE IF( LQUERY ) THEN
         RETURN
      END IF
...
*
*     Call AB_SSYTRD_2STAGE to reduce symmetric matrix to tridiagonal form.
*
*
      CALL AB_SSYTRD_2STAGE( JOBZ, UPLO, N, A, LDA, WORK( INDD ), 
