*> \brief <b> AB_DGELSS solves overdetermined or underdetermined systems for GE matrices</b>
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download AB_DGELSS + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_DGELSs.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_DGELSs.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_DGELSs.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
...
*> \verbatim
*>
*> AB_DGELSS computes the minimum norm solution to a real linear least
*> squares problem:
*>
...
*     .. External Subroutines ..
      EXTERNAL           AB_DBDSQR, AB_DCOPY, AB_DGEBRD, AB_DGELQF, AB_D
     $GEMM, AB_DGEMV,
     $                   AB_DGEQRF, AB_DLABAD, AB_DLACPY, AB_DLASCL, AB_
     $DLASET, AB_DORGBR,
...
*
      IF( INFO.EQ.0 ) THEN
         ...
         IF( MINMN.GT.0 ) THEN
            MM = M
            MNTHR = AB_ILAENV( 6, 'AB_DGELSS', ' ', M, N, NRHS, -1 )
...
*              Compute space needed for AB_DGEQRF
               CALL AB_DGEQRF( M, N, A, LDA, DUM(1), DUM(1), -1, INFO )
               LWORK_DGEQRF=DUM(1)
...
*                 Compute space needed for AB_DGELQF
                  CALL AB_DGELQF( M, N, A, LDA, DUM(1), DUM(1),
     $                -1, INFO )
                  LWORK_DGELQF=DUM(1)
*                 Compute space needed for AB_DGEBRD
