...
*
*> \htmlonly
*> Download AB_ZGBRFSX + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_ZGBRFSx.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_ZGBRFSx.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_ZGBRFSx.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_ZGBRFSX( TRANS, EQUED, N, KL, KU, NRHS, AB, LDAB, AFB,
...
*> \verbatim
*>
*>    AB_ZGBRFSX improves the computed solution to a system of linear
...
*
*  =====================================================================
      SUBROUTINE AB_ZGBRFSX( TRANS, EQUED, N, KL, KU, NRHS, AB, LDAB, AF
     $B,
     $                    LDAFB, IPIV, R, C, B, LDB, X, LDX, RCOND,
     $                    BERR, N_ERR_BNDS, ERR_BNDS_NORM,
     $                    ERR_BNDS_COMP, NPARAMS, PARAMS, WORK, RWORK,
...
*     .. External Functions ..
      ...
      EXTERNAL           AB_DLAMCH, AB_ZLANGB, AB_ZLA_GBRCOND_X, AB_ZLA_GBR
     $COND_C
      DOUBLE PRECISION   AB_DLAMCH, AB_ZLANGB, AB_ZLA_GBRCOND_X, AB_ZLA_GBR
     $COND_C
      LOGICAL            AB_LSAME
...
*
     ...
     $         .NOT.AB_LSAME( EQUED, 'N' ) ) THEN
      ...
      END IF
      IF( INFO.NE.0 ) THEN
        CALL AB_XERBLA( 'AB_ZGBRFSX', -INFO )
        RETURN
      END IF
*
