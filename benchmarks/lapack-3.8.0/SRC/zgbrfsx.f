...
*
*> \htmlonly
*> Download AB_AB_ZGBRFSX + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_AB_ZGBRFSX.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_AB_ZGBRFSX.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_AB_ZGBRFSX.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_AB_ZGBRFSX( TRANS, EQUED, N, KL, KU, NRHS, AB, LDAB, AFB,
...
*> \verbatim
*>
*>    AB_AB_ZGBRFSX improves the computed solution to a system of linear
...
*
*  =====================================================================
      SUBROUTINE AB_AB_ZGBRFSX( TRANS, EQUED, N, KL, KU, NRHS, AB, LDAB,
     $ AFB,
     $                    LDAFB, IPIV, R, C, B, LDB, X, LDX, RCOND,
     $                    BERR, N_ERR_BNDS, ERR_BNDS_NORM,
     $                    ERR_BNDS_COMP, NPARAMS, PARAMS, WORK, RWORK,
...
*     .. External Subroutines ..
      EXTERNAL           AB_XERBLA, AB_ZGBCON, AB_ZLA_GBRFSX_EXTENDED
*     ..
*     .. Intrinsic Functions ..
...
*     .. External Functions ..
      ...
      EXTERNAL           AB_DLAMCH, AB_ZLANGB, AB_ZLA_GBRCOND_X, AB_ZLA_
     $GBRCOND_C
      DOUBLE PRECISION   AB_DLAMCH, AB_ZLANGB, AB_ZLA_GBRCOND_X, AB_ZLA_
     $GBRCOND_C
      LOGICAL            AB_LSAME
...
*
     ...
     $         .NOT.AB_LSAME( EQUED, 'N' ) ) THEN
      ...
      END IF
      IF( INFO.NE.0 ) THEN
        CALL AB_XERBLA( 'AB_AB_ZGBRFSX', -INFO )
        RETURN
      END IF
*
...
*
      IF ( REF_TYPE .NE. 0 .AND. INFO .EQ. 0 ) THEN
         ...
         IF ( NOTRAN ) THEN
            CALL AB_ZLA_GBRFSX_EXTENDED( PREC_TYPE, TRANS_TYPE,  N, KL, 
     $KU,
...
*
         IF ( COLEQU .AND. NOTRAN ) THEN
            RCOND_TMP = AB_ZLA_GBRCOND_C( TRANS, N, KL, KU, AB, LDAB, AF
     $B,
...
*
     ...
     $     THEN
               RCOND_TMP = AB_ZLA_GBRCOND_X( TRANS, N, KL, KU, AB, LDAB,
