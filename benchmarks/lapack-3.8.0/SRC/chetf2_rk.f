*> \brief \b AB_AB_CHETF2_RK computes the factorization of a complex Hermitian indefinite matrix using the bounded Bunch-Kaufman (rook) diagonal pivoting method (BLAS2 unblocked algorithm).
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download AB_AB_CHETF2_RK + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_AB_CHETF2_RK.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_AB_CHETF2_RK.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_AB_CHETF2_RK.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_AB_CHETF2_RK( UPLO, N, A, LDA, E, IPIV, INFO )
*
*       .. Scalar Arguments ..
*       CHARACTER          UPLO
*       INTEGER            INFO, LDA, N
...
*>
*> \verbatim
*> AB_AB_CHETF2_RK computes the factorization of a complex Hermitian matrix A
...
*
      ...
      EXTERNAL           AB_LSAME, AB_ICAMAX, AB_SLAMCH, AB_SLAPY2
*     ..
*     .. External Subroutines ..
      EXTERNAL           AB_XERBLA, AB_CAB_SSCAL, AB_CHER, AB_CSWAP
*     ..
*     .. Intrinsic Functions ..
...
*
      ...
      END IF
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_AB_CHETF2_RK', -INFO )
         RETURN
      END IF
*
...
*
                     D11 = ONE / REAL( A( K, K ) )
                     CALL AB_CHER( UPLO, K-1, -D11, A( 1, K ), 1, A, LDA
     $ )
*
*                    Store U(k) in column k
*
                     CALL AB_CAB_SSCAL( K-1, D11, A( 1, K ), 1 )
                  ELSE
*
...
*
                     D11 = ONE / REAL( A( K, K ) )
                     CALL AB_CHER( UPLO, N-K, -D11, A( K+1, K ), 1,
     $                          A( K+1, K+1 ), LDA )
*
*                    Store L(k) in column k
*
                     CALL AB_CAB_SSCAL( N-K, D11, A( K+1, K ), 1 )
                  ELSE
*
*                    Store L(k) in column k
*
