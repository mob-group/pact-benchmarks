*> \brief <b> AB_AB_DGGESX computes the eigenvalues, the Schur form, and, optionally, the matrix of Schur vectors for GE matrices</b>
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download AB_AB_DGGESX + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_AB_DGGESX.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_AB_DGGESX.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_AB_DGGESX.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_AB_DGGESX( JOBVSL, JOBVSR, SORT, SELCTG, SENSE, N, A, LDA,
...
*> \verbatim
*>
*> AB_AB_DGGESX computes for a pair of N-by-N real nonsymmetric matrices
...
*>
*  =====================================================================
      SUBROUTINE AB_AB_DGGESX( JOBVSL, JOBVSR, SORT, SELCTG, SENSE, N, A
     $, LDA,
     $                   B, LDB, SDIM, ALPHAR, ALPHAI, BETA, VSL, LDVSL,
     $                   VSR, LDVSR, RCONDE, RCONDV, WORK, LWORK, IWORK,
     $                   LIWORK, BWORK, INFO )
...
*
      IF( INFO.EQ.0 ) THEN
         IF( N.GT.0) THEN
            ...
            MAXWRK = MINWRK - N +
     $               N*AB_ILAENV( 1, 'AB_AB_DGEQRF', ' ', N, 1, N, 0 )
            MAXWRK = MAX( MAXWRK, MINWRK - N +
     $               N*AB_ILAENV( 1, 'AB_DORMQR', ' ', N, 1, N, -1 ) )
            IF( ILVSL ) THEN
               MAXWRK = MAX( MAXWRK, MINWRK - N +
     $                  N*AB_ILAENV( 1, 'AB_DORGQR', ' ', N, 1, N, -1 ) 
     $)
            END IF
            LWRK = MAXWRK
            IF( IJOB.GE.1 )
...
*
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_AB_DGGESX', -INFO )
         RETURN
      ELSE IF (LQUERY) THEN
         RETURN
      END IF
...
*
         CALL AB_DTGSEN( IJOB, ILVSL, ILVSR, BWORK, N, A, LDA, B, LDB,
     $                ALPHAR, ALPHAI, BETA, VSL, LDVSL, VSR, LDVSR,
