...
*
*> \htmlonly
*> Download AB_AB_CHBGVX + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_AB_CHBGVX.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_AB_CHBGVX.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_AB_CHBGVX.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_AB_CHBGVX( JOBZ, RANGE, UPLO, N, KA, KB, AB, LDAB, BB,
...
*> \verbatim
*>
*> AB_AB_CHBGVX computes all the eigenvalues, and optionally, the eigenvectors
...
*
*  =====================================================================
      SUBROUTINE AB_AB_CHBGVX( JOBZ, RANGE, UPLO, N, KA, KB, AB, LDAB, B
     $B,
     $                   LDBB, Q, LDQ, VL, VU, IL, IU, ABSTOL, M, W, Z,
     $                   LDZ, WORK, RWORK, IWORK, IFAIL, INFO )
*
...
*
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_AB_CHBGVX', -INFO )
         RETURN
      END IF
*
