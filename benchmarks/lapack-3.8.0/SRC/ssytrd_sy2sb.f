*> \brief \b AB_AB_SSYTRD_SY2SB
*
*  @generated from AB_AB_ZHETRD_HE2HB.f, fortran z -> s, Wed Dec  7 08:22:40 2016
*      
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download AB_AB_SSYTRD_SY2SB + dependencies 
...
*  ===========
*
*       SUBROUTINE AB_AB_SSYTRD_SY2SB( UPLO, N, KD, A, LDA, AB, LDAB, TAU, 
*                              WORK, LWORK, INFO )
*
*       IMPLICIT NONE
*
...
*> \verbatim
*>
*> AB_AB_SSYTRD_SY2SB reduces a real symmetric matrix A to real symmetric
...
*     .. External Subroutines ..
      EXTERNAL           AB_XERBLA, AB_AB_AB_SSYR2K, AB_SSYMM, AB_SGEMM,
     $ AB_SCOPY,
     $                   AB_AB_SLARFT, AB_AB_SGELQF, AB_AB_SGEQRF, AB_SL
     $ASET
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MIN, MAX
...
*
      ...
      LQUERY = ( LWORK.EQ.-1 )
      LWMIN  = AB_ILAENV( 20, 'AB_AB_SSYTRD_SY2SB', '', N, KD, -1, -1 )
...
*        
             CALL AB_AB_SGELQF( KD, PN, A( I, I+KD ), LDA,
...
*            Form the matrix T
*        
             CALL AB_AB_SLARFT( 'Forward', 'Rowwise', PN, PK,
     $                    A( I, I+KD ), LDA, TAU( I ), 
     $                    WORK( TPOS ), LDT )
*        
*            Compute W:
...
*        
             CALL AB_AB_AB_SSYR2K( UPLO, 'Conjugate', PN, PK,
     $                    -ONE, A( I, I+KD ), LDA,
     $                          WORK( WPOS ), LDW,
...
*        
             CALL AB_AB_SGEQRF( PN, KD, A( I+KD, I ), LDA,
     $                    TAU( I ), WORK( S2POS ), LS2, IINFO )
*        
*            Copy the upper portion of A into AB 
*        
...
*            Form the matrix T
*        
             CALL AB_AB_SLARFT( 'Forward', 'Columnwise', PN, PK,
     $                    A( I+KD, I ), LDA, TAU( I ), 
     $                    WORK( TPOS ), LDT )
*        
*            Compute W:
...
*            an update of the form:  A := A - V*W' - W*V'
*        
             CALL AB_AB_AB_SSYR2K( UPLO, 'No transpose', PN, PK,
     $                    -ONE, A( I+KD, I ), LDA,
     $                           WORK( WPOS ), LDW,
     $                    RONE, A( I+KD, I+KD ), LDA )
*            ==================================================================
