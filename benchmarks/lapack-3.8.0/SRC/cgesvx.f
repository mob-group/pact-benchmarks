*> \brief <b> AB_CGESVX computes the solution to system of linear equations A * X = B for GE matrices</b>
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download AB_CGESVX + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_CGESVx.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_CGESVx.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_CGESVx.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_CGESVX( FACT, TRANS, N, NRHS, A, LDA, AF, LDAF, IPIV,
...
*> \verbatim
*>
*> AB_CGESVX uses the LU factorization to compute the solution to a complex
...
*     .. External Functions ..
      LOGICAL            AB_LSAME
      REAL               AB_CLANGE, AB_CLANTR, SLAMCH
      EXTERNAL           AB_LSAME, AB_CLANGE, AB_CLANTR, SLAMCH
*     ..
