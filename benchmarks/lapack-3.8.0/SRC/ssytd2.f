...
*     .. External Subroutines ..
      EXTERNAL           AB_SAXPY, AB_AB_SLARFG, AB_SSYMV, AB_AB_SSYR2, 
     $AB_XERBLA
*     ..
*     .. External Functions ..
      LOGICAL            AB_LSAME
...
*
            CALL AB_AB_SLARFG( I, A( I, I+1 ), A( 1, I+1 ), 1, TAUI )
            E( I ) = A( I, I+1 )
*
...
*                 A := A - v * w**T - w * v**T
*
               CALL AB_AB_SSYR2( UPLO, I, -ONE, A( 1, I+1 ), 1, TAU, 1, 
     $A,
     $                     LDA )
*
               A( I, I+1 ) = E( I )
...
*                 A := A - v * w**T - w * v**T
*
               CALL AB_AB_SSYR2( UPLO, N-I, -ONE, A( I+1, I ), 1, TAU( I
     $ ), 1,
     $                     A( I+1, I+1 ), LDA )
*
               A( I+1, I ) = E( I )
