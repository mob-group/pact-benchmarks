...
*     .. External Subroutines ..
      EXTERNAL           AB_XERBLA, AB_ZAXPY, AB_ZHPMV, AB_AB_ZHPR2, AB_
     $AB_ZLARFG
*     ..
*     .. External Functions ..
      LOGICAL            AB_LSAME
...
*
            ALPHA = AP( I1+I-1 )
            CALL AB_AB_ZLARFG( I, ALPHA, AP( I1 ), 1, TAUI )
            E( I ) = ALPHA
*
...
*                 A := A - v * w**H - w * v**H
*
               CALL AB_AB_ZHPR2( UPLO, I, -ONE, AP( I1 ), 1, TAU, 1, AP 
     $)
*
            END IF
            AP( I1+I-1 ) = E( I )
...
*
            ALPHA = AP( II+1 )
            CALL AB_AB_ZLARFG( N-I, ALPHA, AP( II+2 ), 1, TAUI )
            E( I ) = ALPHA
*
            IF( TAUI.NE.ZERO ) THEN
*
...
*                 A := A - v * w**H - w * v**H
*
               CALL AB_AB_ZHPR2( UPLO, N-I, -ONE, AP( II+1 ), 1, TAU( I 
     $), 1,
     $                     AP( I1I1 ) )
*
            END IF
