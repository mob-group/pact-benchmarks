...
*  ===========
*
*       SUBROUTINE AB_SSTECH( N, A, B, EIG, TOL, WORK, INFO )
*
*       .. Scalar Arguments ..
*       INTEGER            INFO, N
*       REAL               TOL
...
*>    A(N) and offdiagonal entries B(1) ,..., B(N-1)).  AB_SSTECH checks to
...
*>    AB_SSTECT).  Here EPS = TOL*MACHEPS*MAXEIG, where MACHEPS is the
...
*
      CALL AB_SSTECT( N, A, B, LOWER, NUML )
      CALL AB_SSTECT( N, A, B, UPPER, NUMU )
      COUNT = NUMU - NUML
