...
*  ===========
*
*       SUBROUTINE AB_CDRGES( NSIZES, NN, NTYPES, DOTYPE, ISEED, THRESH,
...
*> \verbatim
*>
*> AB_CDRGES checks the nonsymmetric generalized eigenvalue (Schur form)
...
*> Schur forms.
*>
*> When AB_CDRGES is called, a number of matrix "sizes" ("N's") and a
...
*>          The Schur form matrix computed from A by AB_CGGES.  On exit, S
...
*>          The upper triangular matrix computed from B by AB_CGGES.
*> \endverbatim
*>
*> \param[out] Q
*> \verbatim
*>          Q is COMPLEX array, dimension (LDQ, max(NN))
*>          The (left) orthogonal matrix computed by AB_CGGES.
*> \endverbatim
*>
*> \param[in] LDQ
*> \verbatim
...
*>          The (right) orthogonal matrix computed by AB_CGGES.
*> \endverbatim
*>
*> \param[out] ALPHA
*> \verbatim
...
*>
*>          The generalized eigenvalues of (A,B) computed by AB_CGGES.
...
*     .. External Subroutines ..
      EXTERNAL           AB_ALASVM, AB_CGET51, AB_CGET54, AB_CGGES, AB_C
     $LACPY, AB_AB_CLARFG,
...
*
      RETURN
*
 9999 FORMAT( ' AB_CDRGES: ', A, ' returned INFO=', I6, '.', / 9X, 'N=',
     $      I6, ', JTYPE=', I6, ', ISEED=(', 4( I4, ',' ), I5, ')' )
*
 9998 FORMAT( ' AB_CDRGES: S not in Schur form at eigenvalue ', I6, '.',
...
*
 9997 FORMAT( / 1X, A3, ' -- Complex Generalized Schur from problem ',
     $      'driver' )
*
 9996 FORMAT( ' Matrix types (see AB_CDRGES for details): ' )
*
