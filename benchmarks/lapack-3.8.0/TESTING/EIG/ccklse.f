...
*  ===========
*
*       SUBROUTINE AB_CCKAB_LSE( NN, MVAL, PVAL, NVAL, NMATS, ISEED, THRESH,
...
*> \verbatim
*>
*> AB_CCKAB_LSE tests AB_CGGAB_LSE - a subroutine for solving linear equality
...
*
*  =====================================================================
      SUBROUTINE AB_CCKAB_LSE( NN, MVAL, PVAL, NVAL, NMATS, ISEED, THRES
     $H,
     $                   NMAX, A, AF, B, BF, X, WORK, RWORK, NIN, NOUT,
     $                   INFO )
*
...
*     .. External Subroutines ..
      EXTERNAL           AB_AB_ALAHDG, AB_ALAREQ, AB_ALASUM, AB_CLARHS, 
     $AB_CLATMS, AB_CAB_LSETS,
     $                   AB_SLATB9
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          ABS, MAX
...
*
            CALL AB_CLARHS( 'CGE', 'New solution', 'Upper', 'N', M, N,
     $                   MAX( M-1, 0 ), MAX( N-1, 0 ), 1, A, LDA,
     $                   X( 4*NMAX+1 ), MAX( N, 1 ), X, MAX( M, 1 ),
     $                   ISEED, IINFO )
*
            CALL AB_CLARHS( 'CGE', 'Computed', 'Upper', 'N', P, N,
...
*
            NT = 2
*
            CALL AB_CAB_LSETS( M, P, N, A, AF, LDA, B, BF, LDB, X,
...
*
 9999 FORMAT( ' AB_CLATMS in AB_CCKAB_LSE   INFO = ', I5 )
