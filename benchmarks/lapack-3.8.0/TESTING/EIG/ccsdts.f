...
*> \verbatim
*>
*> CCSDTS tests AB_cuncsd, which, given an M-by-M partitioned unitary
*> matrix X,
*>              Q  M-Q
*>       X = [ X11 X12 ] P   ,
*>           [ X21 X22 ] M-P
...
*>          Details of the CSD of X, as returned by AB_cuncsd;
*>          see AB_cuncsd for further details.
*> \endverbatim
*>
*> \param[in] LDX
*> \verbatim
...
*>          S are constructed from THETA; see subroutine AB_cuncsd for
*>          details.
*> \endverbatim
*>
*> \param[out] IWORK
...
*     Compute the CSD
*
      CALL AB_cuncsd( 'Y', 'Y', 'Y', 'Y', 'N', 'D', M, P, Q, XF(1,1), LD
     $X,
