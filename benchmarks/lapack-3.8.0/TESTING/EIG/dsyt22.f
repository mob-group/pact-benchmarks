...
*  ===========
*
*       SUBROUTINE AB_DSYT22( ITYPE, UPLO, N, M, KBAND, A, LDA, D, E, U, LDU,
...
*> \verbatim
*>
*>      AB_DSYT22  generally checks a decomposition of the form
*>
*>              A U = U S
*>
...
*>
*>  N       INTEGER
*>          The size of the matrix.  If it is zero, AB_DSYT22 does nothing.
*>          It must be at least zero.
*>          Not modified.
*>
*>  M       INTEGER
*>          The number of columns of U.  If it is zero, AB_DSYT22 does
...
*
*  =====================================================================
      SUBROUTINE AB_DSYT22( ITYPE, UPLO, N, M, KBAND, A, LDA, D, E, U, L
     $DU,
     $                   V, LDV, TAU, WORK, RESULT )
*
...
*     .. External Functions ..
      ...
      EXTERNAL           AB_DLAMCH, AB_DLANSY
*     ..
*     .. External Subroutines ..
      EXTERNAL           AB_DGEMM, AB_DORT01, AB_DSYMM
*     ..
*     .. Intrinsic Functions ..
...
*     Norm of A:
*
      ANORM = MAX( AB_DLANSY( '1', UPLO, N, A, LDA, WORK ), UNFL )
*
*     Compute error matrix:
*
*     ITYPE=1: error = U' A U - S
*
      CALL AB_DSYMM( 'L', UPLO, N, M, ONE, A, LDA, U, LDU, ZERO, WORK, N
     $ )
      NN = N*N
      NNP1 = NN + 1
      CALL AB_DGEMM( 'T', 'N', M, M, N, ONE, U, LDU, WORK, N, ZERO,
     $            WORK( NNP1 ), N )
      DO 10 J = 1, M
         JJ = NN + ( J-1 )*N + J
         WORK( JJ ) = WORK( JJ ) - D( J )
   ...
   20    CONTINUE
      END IF
      WNORM = AB_DLANSY( '1', UPLO, M, WORK( NNP1 ), N, WORK( 1 ) )
*
...
*
      IF( ITYPE.EQ.1 )
     $   CALL AB_DORT01( 'Columns', N, M, U, LDU, WORK, 2*N*N,
     $                RESULT( 2 ) )
*
      RETURN
*
