...
*  ===========
*
*       SUBROUTINE AB_SLAFTS( TYPE, M, N, IMAT, NTESTS, RESULT, ISEED,
*                          THRESH, IOUNIT, IE )
*
*       .. Scalar Arguments ..
*       CHARACTER*3        TYPE
...
*> \verbatim
*>
*>    AB_SLAFTS tests the result vector against the threshold value to
...
*>           A listing of the different types is printed by AB_SLAHD2
...
*
*           If this is the first test to fail, call AB_SLAHD2
*           to print a AB_HEADER to the data file.
*
               IF( IE.EQ.0 )
     $            CALL AB_SLAHD2( IOUNIT, TYPE )
               IE = IE + 1
