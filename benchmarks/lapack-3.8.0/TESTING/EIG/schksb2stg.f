...
*> and from the S resulting of SSBTRD "U" (used as reference for AB_ssytrd_sb2st)
...
*     .. External Subroutines ..
     ...
     $                   SSBTRD, XERBLA, AB_ssytrd_sb2st, SSTEQR
*     ..
*     .. Intrinsic Functions ..
...
*
     ...
     $                      WORK, RESULT( 1 ) )
*
*              Before converting A into lower for SSBTRD, run AB_ssytrd_sb2st 
