...
*> otherwise AB_DERRPO.f defines this subroutine.
*> \endverbatim
*
*  Arguments:
*  ==========
...
*     .. External Subroutines ..
     ...
     $DPPEQU, AB_DPPRFS,
     $                   AB_DPPTRF, AB_DPPTRI, AB_DPPTRS, AB_AB_DPOEQUB,
     $ AB_AB_DPORFSX
*     ..
*     .. Scalars in Common ..
      LOGICAL            LERR, OK
...
*
         N_ERR_BNDS = 3
         NPARAMS = 0
         SRNAMT = 'AB_AB_DPORFSX'
         INFOT = 1
         CALL AB_AB_DPORFSX( '/', EQ, 0, 0, A, 1, AF, 1, S, B, 1, X, 1,
     $        RCOND, BERR, N_ERR_BNDS, ERR_BNDS_N, ERR_BNDS_C, NPARAMS,
     $        PARAMS, W, IW, INFO )
         CALL AB_CHKXER( 'AB_AB_DPORFSX', INFOT, NOUT, LERR, OK )
         INFOT = 2
         CALL AB_AB_DPORFSX( 'U', "/", -1, 0, A, 1, AF, 1, S, B, 1, X, 1
     $,
     $        RCOND, BERR, N_ERR_BNDS, ERR_BNDS_N, ERR_BNDS_C, NPARAMS,
     $        PARAMS, W, IW, INFO )
         CALL AB_CHKXER( 'AB_AB_DPORFSX', INFOT, NOUT, LERR, OK )
         EQ = 'N'
         INFOT = 3
         CALL AB_AB_DPORFSX( 'U', EQ, -1, 0, A, 1, AF, 1, S, B, 1, X, 1,
     $        RCOND, BERR, N_ERR_BNDS, ERR_BNDS_N, ERR_BNDS_C, NPARAMS,
     $        PARAMS, W, IW, INFO )
         CALL AB_CHKXER( 'AB_AB_DPORFSX', INFOT, NOUT, LERR, OK )
         INFOT = 4
         CALL AB_AB_DPORFSX( 'U', EQ, 0, -1, A, 1, AF, 1, S, B, 1, X, 1,
     $        RCOND, BERR, N_ERR_BNDS, ERR_BNDS_N, ERR_BNDS_C, NPARAMS,
     $        PARAMS, W, IW, INFO )
         CALL AB_CHKXER( 'AB_AB_DPORFSX', INFOT, NOUT, LERR, OK )
         INFOT = 6
         CALL AB_AB_DPORFSX( 'U', EQ, 2, 1, A, 1, AF, 2, S, B, 2, X, 2,
     $        RCOND, BERR, N_ERR_BNDS, ERR_BNDS_N, ERR_BNDS_C, NPARAMS,
     $        PARAMS, W, IW, INFO )
         CALL AB_CHKXER( 'AB_AB_DPORFSX', INFOT, NOUT, LERR, OK )
         INFOT = 8
         CALL AB_AB_DPORFSX( 'U', EQ, 2, 1, A, 2, AF, 1, S, B, 2, X, 2,
     $        RCOND, BERR, N_ERR_BNDS, ERR_BNDS_N, ERR_BNDS_C, NPARAMS,
     $        PARAMS, W, IW, INFO )
         CALL AB_CHKXER( 'AB_AB_DPORFSX', INFOT, NOUT, LERR, OK )
         INFOT = 11
         CALL AB_AB_DPORFSX( 'U', EQ, 2, 1, A, 2, AF, 2, S, B, 1, X, 2,
     $        RCOND, BERR, N_ERR_BNDS, ERR_BNDS_N, ERR_BNDS_C, NPARAMS,
     $        PARAMS, W, IW, INFO )
         CALL AB_CHKXER( 'AB_AB_DPORFSX', INFOT, NOUT, LERR, OK )
         INFOT = 13
         CALL AB_AB_DPORFSX( 'U', EQ, 2, 1, A, 2, AF, 2, S, B, 2, X, 1,
     $        RCOND, BERR, N_ERR_BNDS, ERR_BNDS_N, ERR_BNDS_C, NPARAMS,
     $        PARAMS, W, IW, INFO )
         CALL AB_CHKXER( 'AB_AB_DPORFSX', INFOT, NOUT, LERR, OK )
*
...
*        AB_AB_DPOEQUB
*
         SRNAMT = 'AB_AB_DPOEQUB'
         INFOT = 1
         CALL AB_AB_DPOEQUB( -1, A, 1, R1, RCOND, ANRM, INFO )
         CALL AB_CHKXER( 'AB_AB_DPOEQUB', INFOT, NOUT, LERR, OK )
         INFOT = 3
         CALL AB_AB_DPOEQUB( 2, A, 1, R1, RCOND, ANRM, INFO )
         CALL AB_CHKXER( 'AB_AB_DPOEQUB', INFOT, NOUT, LERR, OK )
*
