...
*  ===========
*
*       SUBROUTINE AB_ZCHKSP( DOTYPE, NN, NVAL, NNS, NSVAL, THRESH, TSTERR,
...
*> \verbatim
*>
*> AB_ZCHKSP tests AB_ZSPTRF, -TRI, -TRS, -RFS, and -CON
*> \endverbatim
*
*  Arguments:
*  ==========
...
*     .. External Functions ..
      ...
      EXTERNAL           AB_LSAME, AB_DGET06, AB_ZLANSP
*     ..
*     .. External Subroutines ..
     ...
     $ZLATSP, AB_ZPPT05,
     $                   AB_ZSPCON, AB_AB_ZSPRFS, AB_ZSPT01, AB_ZSPT02, 
     $AB_ZSPT03, AB_ZSPTRF,
     $                   AB_ZSPTRI, AB_ZSPTRS
*     ..
*     .. Intrinsic Functions ..
...
*
  ...
  100             CONTINUE
               ...
               END IF
*
*              Check error code from AB_ZSPTRF.
*
               IF( INFO.NE.K )
     $            CALL AB_ALAERH( PATH, 'AB_ZSPTRF', INFO, K, UPLO, N, N
     $, -1,
...
*
               CALL AB_ZSPT01( UPLO, N, A, AFAC, IWORK, AINV, LDA, RWORK
     $,
     $                      RESULT( 1 ) )
               NT = 1
*
...
*
*              Check error code from AB_ZSPTRI.
*
                  IF( INFO.NE.0 )
     $               CALL AB_ALAERH( PATH, 'AB_ZSPTRI', INFO, 0, UPLO, N
     $, N,
     $                            -1, -1, -1, IMAT, NFAIL, NERRS, NOUT )
*
                  CALL AB_ZSPT03( UPLO, N, A, AINV, WORK, LDA, RWORK,
     $                         RCONDC, RESULT( 2 ) )
                  NT = 2
               END IF
*
...
*
                  SRNAMT = 'AB_ZSPTRS'
                  CALL AB_ZSPTRS( UPLO, N, NRHS, AFAC, IWORK, X, LDA,
     $                         INFO )
*
*              Check error code from AB_ZSPTRS.
*
                  IF( INFO.NE.0 )
     $               CALL AB_ALAERH( PATH, 'AB_ZSPTRS', INFO, 0, UPLO, N
     $, N,
...
*
                  SRNAMT = 'AB_AB_ZSPRFS'
                  CALL AB_AB_ZSPRFS( UPLO, N, NRHS, A, AFAC, IWORK, B, L
     $DA, X,
     $                         LDA, RWORK, RWORK( NRHS+1 ), WORK,
     $                         RWORK( 2*NRHS+1 ), INFO )
*
*              Check error code from AB_AB_ZSPRFS.
*
                  IF( INFO.NE.0 )
     $               CALL AB_ALAERH( PATH, 'AB_AB_ZSPRFS', INFO, 0, UPLO
     $, N, N,
     $                            -1, -1, NRHS, IMAT, NFAIL, NERRS,
     $                            NOUT )
*
...
*
  140          CONTINUE
               ...
               SRNAMT = 'AB_ZSPCON'
               CALL AB_ZSPCON( UPLO, N, AFAC, IWORK, ANORM, RCOND, WORK,
     $                      INFO )
*
*              Check error code from AB_ZSPCON.
*
               IF( INFO.NE.0 )
     $            CALL AB_ALAERH( PATH, 'AB_ZSPCON', INFO, 0, UPLO, N, N
     $, -1,
     $                         -1, -1, IMAT, NFAIL, NERRS, NOUT )
*
