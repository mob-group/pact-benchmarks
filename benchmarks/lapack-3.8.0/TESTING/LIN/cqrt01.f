...
*  ===========
*
*       SUBROUTINE AB_CQRT01( M, N, A, AF, Q, R, LDA, TAU, WORK, LWORK,
*                          RWORK, RESULT )
*
*       .. Scalar Arguments ..
...
*> \verbatim
*>
*> AB_CQRT01 tests AB_AB_CGEQRF, which computes the QR factorization of an m-by-n
*> matrix A, and partially tests AB_CUNGQR which forms the m-by-m
*> orthogonal matrix Q.
*>
*> AB_CQRT01 compares R with Q'*A, and checks that Q is orthogonal.
*> \endverbatim
*
*  Arguments:
*  ==========
...
*     .. External Subroutines ..
      EXTERNAL           AB_CGEMM, AB_AB_CGEQRF, AB_AB_CHERK, AB_CLACPY,
     $ AB_CLASET, AB_CUNGQR
*     ..
*     .. Intrinsic Functions ..
...
*
      SRNAMT = 'AB_AB_CGEQRF'
      CALL AB_AB_CGEQRF( M, N, AF, LDA, TAU, WORK, LWORK, INFO )
*
*     Copy details of Q
*
