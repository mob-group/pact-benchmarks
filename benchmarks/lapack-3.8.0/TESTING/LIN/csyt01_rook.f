...
*  ===========
*
*       SUBROUTINE AB_AB_CSYT01_ROOK( UPLO, N, A, LDA, AFAC, LDAFAC, IPIV, C, LDC,
*                          RWORK, RESID )
*
*       .. Scalar Arguments ..
*       CHARACTER          UPLO
...
*> \verbatim
*>
*> AB_AB_CSYT01_ROOK reconstructs a complex symmetric indefinite matrix A from its
...
*
*  =====================================================================
      SUBROUTINE AB_AB_CSYT01_ROOK( UPLO, N, A, LDA, AFAC, LDAFAC, IPIV,
     $ C,
     $                    LDC, RWORK, RESID )
*
...
*     .. External Functions ..
      ...
      EXTERNAL           AB_LSAME, AB_CLANSY, AB_SLAMCH
*     ..
*     .. External Subroutines ..
      EXTERNAL           AB_CLASET, AB_AB_CLAVSY_ROOK
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          REAL
*     ..
...
*
*     Call AB_AB_CLAVSY_ROOK to form the product D * U' (or D * L' ).
*
      CALL AB_AB_CLAVSY_ROOK( UPLO, 'Transpose', 'Non-unit', N, N, AFAC,
     $              LDAFAC, IPIV, C, LDC, INFO )
*
*     Call AB_AB_CLAVSY_ROOK again to multiply by U (or L ).
*
