*> \brief \b AB_AB_AB_CDRVSY_AA_2STAGE
*
*  =========== DOCUMENTATION ===========
*
...
*  ===========
*
*       SUBROUTINE AB_AB_AB_CDRVSY_AA_2STAGE(
...
*> \verbatim
*>
*> AB_AB_AB_CDRVSY_AA_2STAGE tests the driver routine AB_AB_AB_CSYSV_AA_2STAGE.
*> \endverbatim
*
*  Arguments:
*  ==========
...
*     .. External Subroutines ..
     ...
     $CLATMS,
     $                   AB_AB_AB_CSYSV_AA_2STAGE, AB_AB_CSYT01_AA, AB_C
     $SYT02,
...
*
                     ...
                     CALL AB_AB_AB_CSYSV_AA_2STAGE( UPLO, N, NRHS, AFAC,
     $ LDA,
     $                                 AINV, (3*NB+1)*N, 
     $                                 IWORK, IWORK( 1+N ),
...
*
     ...
     $                        CALL AB_ALADHD( NOUT, PATH )
                           WRITE( NOUT, FMT = 9999 )'AB_AB_AB_CSYSV_AA_2
     $STAGE ',
