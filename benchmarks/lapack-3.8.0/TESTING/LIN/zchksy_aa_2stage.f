*> \brief \b AB_AB_AB_ZCHKSY_AA_2STAGE
*
*  =========== DOCUMENTATION ===========
*
...
*  ===========
*
*       SUBROUTINE AB_AB_AB_ZCHKSY_AA_2STAGE( DOTYPE, NN, NVAL, NNB, NBVAL, 
...
*> \verbatim
*>
*> AB_AB_AB_ZCHKSY_AA_2STAGE tests AB_AB_AB_ZSYTRF_AA_2STAGE, -TRS_AA_2STAGE.
*> \endverbatim
*
*  Arguments:
*  ==========
...
*     .. External Subroutines ..
      EXTERNAL           AB_ALAERH, AB_ALAHD, AB_ALASUM, AB_CERRSY, AB_Z
     $LACPY, AB_ZLARHS,
     $                   AB_CLATB4, AB_ZLATMS, AB_ZSYT02, AB_ZSYT01, 
     $                   AB_AB_AB_ZSYTRF_AA_2STAGE, AB_AB_AB_ZSYTRS_AA_2
     $STAGE,
     $                   AB_XLAENV
*     ..
*     .. Intrinsic Functions ..
...
*
                  ...
                  CALL AB_AB_AB_ZSYTRF_AA_2STAGE( UPLO, N, AFAC, LDA, 
     $                                   AINV, (3*NB+1)*N, 
     $                                   IWORK, IWORK( 1+N ),
     $                                   WORK, LWORK,
     $                                   INFO )
...
*
                  IF( INFO.NE.K ) THEN
                     CALL AB_ALAERH( PATH, 'AB_AB_AB_ZSYTRF_AA_2STAGE', 
     $INFO, K,
...
*
c                  CALL AB_AB_ZSYT01_AA( UPLO, N, A, LDA, AFAC, LDA, IWO
     $RK,
...
*
                     ...
                     LWORK = MAX( 1, 3*N-2 )
                     CALL AB_AB_AB_ZSYTRS_AA_2STAGE( UPLO, N, NRHS, AFAC
     $, LDA,
...
*
                     IF( INFO.NE.0 ) THEN
                        IF( IZERO.EQ.0 ) THEN
                           CALL AB_ALAERH( PATH, 'AB_AB_AB_ZSYTRS_AA_2ST
     $AGE',
     $                                  INFO, 0, UPLO, N, N, -1, -1,
...
*
                        CALL AB_ZSYT02( UPLO, N, NRHS, A, LDA, X, LDA,
