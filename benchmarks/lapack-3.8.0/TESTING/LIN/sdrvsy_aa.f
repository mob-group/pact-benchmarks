...
*  ===========
*
*       SUBROUTINE AB_AB_SDRVSY_AA( DOTYPE, NN, NVAL, NRHS, THRESH, TSTERR, NMAX,
...
*> \verbatim
*>
*> AB_AB_SDRVSY_AA tests the driver routine AB_AB_SSYSV_AA.
*> \endverbatim
*
*  Arguments:
*  ==========
...
*
*  =====================================================================
      SUBROUTINE AB_AB_SDRVSY_AA( DOTYPE, NN, NVAL, NRHS, THRESH, TSTERR
     $,
...
*     ..
*     .. External Functions ..
      REAL               AB_DGET06, AB_SLANSY
      EXTERNAL           AB_DGET06, AB_SLANSY
*     ..
*     .. External Subroutines ..
     ...
     $SPOT02,
     $                   AB_AB_SSYSV_AA, AB_AB_SSYT01_AA, AB_AB_SSYTRF_A
     $A, AB_XLAENV
*     ..
*     .. Scalars in Common ..
      LOGICAL            LERR, OK
...
*
                     ...
                     CALL AB_AB_SSYSV_AA( UPLO, N, NRHS, AFAC, LDA, IWOR
     $K,
...
*                    residual.
*
                     CALL AB_AB_SSYT01_AA( UPLO, N, A, LDA, AFAC, LDA,
