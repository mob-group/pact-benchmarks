...
*  ===========
*
*       SUBROUTINE AB_AB_ZCHKSY_RK( DOTYPE, NN, NVAL, NNB, NBVAL, NNS, NSVAL,
...
*> \verbatim
*>
*> AB_AB_ZCHKSY_RK tests AB_AB_ZSYTRF_RK, -TRI_3, -TRS_3,
*> and -CON_3.
*> \endverbatim
*
*  Arguments:
...
*
*  =====================================================================
      SUBROUTINE AB_AB_ZCHKSY_RK( DOTYPE, NN, NVAL, NNB, NBVAL, NNS, NSV
     $AL,
     $                      THRESH, TSTERR, NMAX, A, AFAC, E, AINV, B,
     $                      X, XACT, WORK, RWORK, IWORK, NOUT )
*
...
*     ..
*     .. External Functions ..
      DOUBLE PRECISION   AB_DGET06, AB_ZLANGE, AB_ZLANSY
      EXTERNAL           AB_DGET06, AB_ZLANGE, AB_ZLANSY
*     ..
*     .. External Subroutines ..
      EXTERNAL           AB_ALAERH, AB_ALAHD, AB_ALASUM, AB_ZERRSY, AB_A
     $B_ZGESVD, AB_ZGET04,
     $                   AB_ZLACPY, AB_ZLARHS, AB_ZLATB4, AB_ZLATMS, AB_
     $ZLATSY, AB_ZSYT02,
     $                   AB_ZSYT03, AB_AB_ZSYCON_3, AB_AB_ZSYT01_3, AB_A
     $B_ZSYTRF_RK,
     $                   AB_AB_ZSYTRI_3, AB_AB_ZSYTRS_3, AB_XLAENV
*     ..
*     .. Intrinsic Functions ..
...
*
                  ...
                  CALL AB_AB_ZSYTRF_RK( UPLO, N, AFAC, LDA, E, IWORK, AI
     $NV,
     $                            LWORK, INFO )
*
...
*
  ...
  100                CONTINUE
                  ...
                  END IF
*
*                 Check error code from AB_AB_ZSYTRF_RK and handle error.
*
                  IF( INFO.NE.K)
     $               CALL AB_ALAERH( PATH, 'AB_AB_ZSYTRF_RK', INFO, K,
...
*
                  CALL AB_AB_ZSYT01_3( UPLO, N, A, LDA, AFAC, LDA, E, IW
     $ORK,
...
*                    is that AB_ZSYT03 produces RCONDC which is used later
*                    in TEST6 and TEST7.
*
                     LWORK = (N+NB+1)*(NB+3)
                     CALL AB_AB_ZSYTRI_3( UPLO, N, AINV, LDA, E, IWORK, 
     $WORK,
     $                              LWORK, INFO )
*
*                    Check error code from AB_AB_ZSYTRI_3 and handle error.
*
                     IF( INFO.NE.0 )
     $                  CALL AB_ALAERH( PATH, 'AB_AB_ZSYTRI_3', INFO, -1
     $,
     $                               UPLO, N, N, -1, -1, -1, IMAT,
     $                               NFAIL, NERRS, NOUT )
*
...
*
                     ...
                     CALL AB_AB_ZSYTRS_3( UPLO, N, NRHS, AFAC, LDA, E, I
     $WORK,
     $                              X, LDA, INFO )
*
*                    Check error code from AB_AB_ZSYTRS_3 and handle error.
*
                     IF( INFO.NE.0 )
     $                  CALL AB_ALAERH( PATH, 'AB_AB_ZSYTRS_3', INFO, 0,
...
*
  230             CONTINUE
                  ...
                  CALL AB_AB_ZSYCON_3( UPLO, N, AFAC, LDA, E, IWORK, ANO
     $RM,
     $                           RCOND, WORK, INFO )
*
*                 Check error code from AB_AB_ZSYCON_3 and handle error.
*
                  IF( INFO.NE.0 )
     $               CALL AB_ALAERH( PATH, 'AB_AB_ZSYCON_3', INFO, 0,
     $                            UPLO, N, N, -1, -1, -1, IMAT,
     $                            NFAIL, NERRS, NOUT )
*
