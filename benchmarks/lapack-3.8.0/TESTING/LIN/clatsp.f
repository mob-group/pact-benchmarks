...
*  ===========
*
*       SUBROUTINE AB_CLATSP( UPLO, N, X, ISEED )
*
*       .. Scalar Arguments ..
*       CHARACTER          UPLO
*       INTEGER            N
...
*> \verbatim
*>
*> AB_CLATSP generates a special test matrix for the complex symmetric
