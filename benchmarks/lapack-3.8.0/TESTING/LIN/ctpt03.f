...
*  ===========
*
*       SUBROUTINE AB_CTPT03( UPLO, TRANS, DIAG, N, NRHS, AP, SCALE, CNORM,
...
*> \verbatim
*>
*> AB_CTPT03 computes the residual for the solution to a scaled triangular
...
*     .. External Subroutines ..
      EXTERNAL           AB_CAXPY, AB_CCOPY, AB_CAB_SSCAL, AB_CTPMV
*     ..
*     .. Intrinsic Functions ..
...
*     norms already computed by AB_CLATPS.
*
      TNORM = 0.
