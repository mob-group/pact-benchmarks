...
*  ===========
*
*       SUBROUTINE AB_STBT02( UPLO, TRANS, DIAG, N, KD, NRHS, AB, LDAB, X,
...
*> \verbatim
*>
*> AB_STBT02 computes the residual for the computed solution to a
...
*     .. External Functions ..
      LOGICAL            AB_LSAME
      REAL               AB_SASUM, AB_SLAMCH, AB_SLANTB
      EXTERNAL           AB_LSAME, AB_SASUM, AB_SLAMCH, AB_SLANTB
*     ..
*     .. External Subroutines ..
      EXTERNAL           AB_SAXPY, AB_SCOPY, AB_STBMV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX
*     ..
...
*
      IF( AB_LSAME( TRANS, 'N' ) ) THEN
         ANORM = AB_SLANTB( '1', UPLO, DIAG, N, KD, AB, LDAB, WORK )
      ELSE
         ANORM = AB_SLANTB( 'I', UPLO, DIAG, N, KD, AB, LDAB, WORK )
      END IF
*
