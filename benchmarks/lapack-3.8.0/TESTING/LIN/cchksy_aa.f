...
*  ===========
*
*       SUBROUTINE AB_AB_CCHKSY_AA( DOTYPE, NN, NVAL, NNB, NBVAL, NNS, NSVAL,
...
*> \verbatim
*>
*> AB_AB_CCHKSY_AA tests AB_AB_CSYTRF_AA, -TRS_AA.
*> \endverbatim
*
*  Arguments:
*  ==========
...
*> \date November 2017
*
*  @generated from LIN/AB_AB_DCHKSY_AA.f, fortran d -> c, Wed Nov 16 21:34:18 2016
*
*> \ingroup complex_lin
*
*  =====================================================================
      SUBROUTINE AB_AB_CCHKSY_AA( DOTYPE, NN, NVAL, NNB, NBVAL, NNS, NSV
     $AL,
...
*     .. External Subroutines ..
     ...
     $LACPY, AB_CLARHS,
     $                   AB_CLATB4, AB_CLATMS, AB_CSYT02, AB_AB_CSYT01_A
     $A, AB_AB_CSYTRF_AA,
     $                   AB_AB_CSYTRS_AA, AB_XLAENV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
*     ..
...
*
               CALL AB_CLATB4( MATPATH, IMAT, N, N, TYPE, KL, KU,
...
*
                  ...
                  LWORK = MAX( 1, N*NB + N )
                  CALL AB_AB_CSYTRF_AA( UPLO, N, AFAC, LDA, IWORK, AINV,
     $                            LWORK, INFO )
*
...
*
                  IF( INFO.NE.K ) THEN
                     CALL AB_ALAERH( PATH, 'AB_AB_CSYTRF_AA', INFO, K, U
     $PLO,
...
*
                  CALL AB_AB_CSYT01_AA( UPLO, N, A, LDA, AFAC, LDA, IWOR
     $K,
...
*
                     ...
                     LWORK = MAX( 1, 3*N-2 )
                     CALL AB_AB_CSYTRS_AA( UPLO, N, NRHS, AFAC, LDA,
...
*
                     IF( INFO.NE.0 ) THEN
                        IF( IZERO.EQ.0 ) THEN
                           CALL AB_ALAERH( PATH, 'AB_AB_CSYTRS_AA', INFO
     $, 0,
     $                                  UPLO, N, N, -1, -1, NRHS, IMAT,
     $                                  NFAIL, NERRS, NOUT )
                        END IF
                     ELSE
                        CALL AB_CLACPY( 'Full', N, NRHS, B, LDA, WORK, L
     $DA
     $                               )
*
*                       Compute the residual for the solution
*
                        CALL AB_CSYT02( UPLO, N, NRHS, A, LDA, X, LDA,
