...
*     .. External Subroutines ..
     ...
     $                   AB_AB_ZHETRF_RK, AB_AB_ZHETRF_ROOK, AB_AB_ZHETR
     $F_AA, 
     $                   AB_AB_AB_ZHETRF_AA_2STAGE, AB_ZHETRI,
     $                   AB_AB_ZHETRI_3, AB_AB_AB_ZHETRI_3X, AB_AB_ZHETR
     $I_ROOK, AB_AB_ZHETRI2,
     $                   AB_AB_AB_ZHETRI2X, AB_ZHETRS, AB_AB_ZHETRS_3, A
     $B_AB_ZHETRS_ROOK,
     $                   AB_AB_ZHETRS_AA, AB_AB_AB_ZHETRS_AA_2STAGE, AB_
     $ZHPCON, AB_AB_ZHPRFS,
     $                   AB_ZHPTRF, AB_ZHPTRI, AB_ZHPTRS
*     ..
*     .. Scalars in Common ..
      LOGICAL            LERR, OK
      CHARACTER*32       SRNAMT
...
*        AB_AB_ZHETRF_AA
*
         SRNAMT = 'AB_AB_ZHETRF_AA'
         INFOT = 1
         CALL AB_AB_ZHETRF_AA( '/', 0, A, 1, IP, W, 1, INFO )
         CALL AB_CHKXER( 'AB_AB_ZHETRF_AA', INFOT, NOUT, LERR, OK )
         INFOT = 2
         CALL AB_AB_ZHETRF_AA( 'U', -1, A, 1, IP, W, 1, INFO )
         CALL AB_CHKXER( 'AB_AB_ZHETRF_AA', INFOT, NOUT, LERR, OK )
         INFOT = 4
         CALL AB_AB_ZHETRF_AA( 'U', 2, A, 1, IP, W, 4, INFO )
         CALL AB_CHKXER( 'AB_AB_ZHETRF_AA', INFOT, NOUT, LERR, OK )
         INFOT = 7
         CALL AB_AB_ZHETRF_AA( 'U', 0, A, 1, IP, W, 0, INFO )
         CALL AB_CHKXER( 'AB_AB_ZHETRF_AA', INFOT, NOUT, LERR, OK )
         INFOT = 7
         CALL AB_AB_ZHETRF_AA( 'U', 0, A, 1, IP, W, -2, INFO )
         CALL AB_CHKXER( 'AB_AB_ZHETRF_AA', INFOT, NOUT, LERR, OK )
*
*        AB_AB_ZHETRS_AA
*
         SRNAMT = 'AB_AB_ZHETRS_AA'
         INFOT = 1
         CALL AB_AB_ZHETRS_AA( '/', 0, 0, A, 1, IP, B, 1, W, 1, INFO )
         CALL AB_CHKXER( 'AB_AB_ZHETRS_AA', INFOT, NOUT, LERR, OK )
         INFOT = 2
         CALL AB_AB_ZHETRS_AA( 'U', -1, 0, A, 1, IP, B, 1, W, 1, INFO )
         CALL AB_CHKXER( 'AB_AB_ZHETRS_AA', INFOT, NOUT, LERR, OK )
         INFOT = 3
         CALL AB_AB_ZHETRS_AA( 'U', 0, -1, A, 1, IP, B, 1, W, 1, INFO )
         CALL AB_CHKXER( 'AB_AB_ZHETRS_AA', INFOT, NOUT, LERR, OK )
         INFOT = 5
         CALL AB_AB_ZHETRS_AA( 'U', 2, 1, A, 1, IP, B, 2, W, 1, INFO )
         CALL AB_CHKXER( 'AB_AB_ZHETRS_AA', INFOT, NOUT, LERR, OK )
         INFOT = 8
         CALL AB_AB_ZHETRS_AA( 'U', 2, 1, A, 2, IP, B, 1, W, 1, INFO )
         CALL AB_CHKXER( 'AB_AB_ZHETRS_AA', INFOT, NOUT, LERR, OK )
         INFOT = 10
         CALL AB_AB_ZHETRS_AA( 'U', 0, 1, A, 1, IP, B, 1, W, 0, INFO )
         CALL AB_CHKXER( 'AB_AB_ZHETRS_AA', INFOT, NOUT, LERR, OK )
         INFOT = 10
         CALL AB_AB_ZHETRS_AA( 'U', 0, 1, A, 1, IP, B, 1, W, -2, INFO )
         CALL AB_CHKXER( 'AB_AB_ZHETRS_AA', INFOT, NOUT, LERR, OK )
*        
...
*
         SRNAMT = 'AB_AB_AB_ZHETRF_AA_2STAGE'
         INFOT = 1
         CALL AB_AB_AB_ZHETRF_AA_2STAGE( '/', 0, A, 1, A, 1, IP, IP, W, 
     $1,
     $                          INFO )
         CALL AB_CHKXER( 'AB_AB_AB_ZHETRF_AA_2STAGE', INFOT, NOUT, LERR,
     $ OK )
         INFOT = 2
         CALL AB_AB_AB_ZHETRF_AA_2STAGE( 'U', -1, A, 1, A, 1, IP, IP, W,
     $ 1,
     $                           INFO )
         CALL AB_CHKXER( 'AB_AB_AB_ZHETRF_AA_2STAGE', INFOT, NOUT, LERR,
     $ OK )
         INFOT = 4
         CALL AB_AB_AB_ZHETRF_AA_2STAGE( 'U', 2, A, 1, A, 2, IP, IP, W, 
     $1,
     $                           INFO )
         CALL AB_CHKXER( 'AB_AB_AB_ZHETRF_AA_2STAGE', INFOT, NOUT, LERR,
     $ OK )
         INFOT = 6
         CALL AB_AB_AB_ZHETRF_AA_2STAGE( 'U', 2, A, 2, A, 1, IP, IP, W, 
     $1,
     $                           INFO )
         CALL AB_CHKXER( 'AB_AB_AB_ZHETRF_AA_2STAGE', INFOT, NOUT, LERR,
     $ OK )
         INFOT = 10
         CALL AB_AB_AB_ZHETRF_AA_2STAGE( 'U', 2, A, 2, A, 8, IP, IP, W, 
     $0,
     $                           INFO )
         CALL AB_CHKXER( 'AB_AB_AB_ZHETRF_AA_2STAGE', INFOT, NOUT, LERR,
     $ OK )
*
*        AB_AB_AB_ZHETRS_AA_2STAGE
*
         SRNAMT = 'AB_AB_AB_ZHETRS_AA_2STAGE'
         INFOT = 1
         CALL AB_AB_AB_ZHETRS_AA_2STAGE( '/', 0, 0, A, 1, A, 1, IP, IP,
     $                          B, 1, INFO )
         CALL AB_CHKXER( 'AB_AB_AB_ZHETRS_AA_2STAGE', INFOT, NOUT, LERR,
     $ OK )
         INFOT = 2
         CALL AB_AB_AB_ZHETRS_AA_2STAGE( 'U', -1, 0, A, 1, A, 1, IP, IP,
     $                          B, 1, INFO )
         CALL AB_CHKXER( 'AB_AB_AB_ZHETRS_AA_2STAGE', INFOT, NOUT, LERR,
     $ OK )
         INFOT = 3
         CALL AB_AB_AB_ZHETRS_AA_2STAGE( 'U', 0, -1, A, 1, A, 1, IP, IP,
     $                          B, 1, INFO )
         CALL AB_CHKXER( 'AB_AB_AB_ZHETRS_AA_2STAGE', INFOT, NOUT, LERR,
     $ OK )
         INFOT = 5
         CALL AB_AB_AB_ZHETRS_AA_2STAGE( 'U', 2, 1, A, 1, A, 1, IP, IP,
     $                          B, 1, INFO )
         CALL AB_CHKXER( 'AB_AB_AB_ZHETRS_AA_2STAGE', INFOT, NOUT, LERR,
     $ OK )
         INFOT = 7
         CALL AB_AB_AB_ZHETRS_AA_2STAGE( 'U', 2, 1, A, 2, A, 1, IP, IP,
     $                          B, 1, INFO )
         CALL AB_CHKXER( 'AB_AB_AB_ZHETRS_AA_2STAGE', INFOT, NOUT, LERR,
     $ OK )
         INFOT = 11
         CALL AB_AB_AB_ZHETRS_AA_2STAGE( 'U', 2, 1, A, 2, A, 8, IP, IP,
     $                          B, 1, INFO )
         CALL AB_CHKXER( 'AB_AB_ZHETRS_AA_STAGE', INFOT, NOUT, LERR, OK 
     $)
*
