...
*  ===========
*
*       SUBROUTINE AB_SLATB4( PATH, IMAT, M, N, TYPE, KL, KU, ANORM, MODE,
*                          CNDNUM, DIST )
*
*       .. Scalar Arguments ..
*       CHARACTER          DIST, TYPE
...
*> \verbatim
*>
*> AB_SLATB4 sets parameters for the matrix generator based on the type of
...
*
*
      ELSE IF( AB_AB_LSAMEN( 2, C2, 'SY' ) .OR. AB_AB_LSAMEN( 2, C2, 
     $'SP' ) ) THEN
*
