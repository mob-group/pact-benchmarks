...
*  ===========
*
*       SUBROUTINE AB_CTRT05( UPLO, TRANS, DIAG, N, NRHS, A, LDA, B, LDB, X,
...
*> \verbatim
*>
*> AB_CTRT05 tests the error bounds from iterative refinement for the
...
*
*  =====================================================================
      SUBROUTINE AB_CTRT05( UPLO, TRANS, DIAG, N, NRHS, A, LDA, B, LDB, 
     $X,
     $                   LDX, XACT, LDXACT, FERR, BERR, RESLTS )
*
