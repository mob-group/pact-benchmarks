...
*  ===========
*
*       SUBROUTINE AB_ZSYT01( UPLO, N, A, LDA, AFAC, LDAFAC, IPIV, C, LDC,
*                          RWORK, RESID )
*
*       .. Scalar Arguments ..
*       CHARACTER          UPLO
...
*> \verbatim
*>
*> AB_ZSYT01 reconstructs a complex symmetric indefinite matrix A from its
...
*
*     Call AB_ZLAVSY to form the product D * U' (or D * L' ).
*
      CALL AB_ZLAVSY( UPLO, 'Transpose', 'Non-unit', N, N, AFAC, LDAFAC,
     $             IPIV, C, LDC, INFO )
*
*     Call AB_ZLAVSY again to multiply by U (or L ).
*
      CALL AB_ZLAVSY( UPLO, 'No transpose', 'Unit', N, N, AFAC, LDAFAC,
     $             IPIV, C, LDC, INFO )
*
