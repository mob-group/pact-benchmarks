...
*  ===========
*
*       SUBROUTINE AB_AB_CLAVHE_ROOK( UPLO, TRANS, DIAG, N, NRHS, A, LDA, IPIV, B,
*                               LDB, INFO )
*
*       .. Scalar Arguments ..
...
*> \verbatim
*>
*> AB_AB_CLAVHE_ROOK performs one of the matrix-vector operations
*>    x := A*x  or  x := A^H*x,
*> where x is an N element vector and  A is one of the factors
*> from the block U*D*U' or L*D*L' factorization computed by AB_AB_CHETRF_ROOK.
*>
...
*
*  =====================================================================
      SUBROUTINE AB_AB_CLAVHE_ROOK( UPLO, TRANS, DIAG, N, NRHS, A, LDA, 
     $IPIV,
     $                        B, LDB, INFO )
*
...
*
     ...
     $          THEN
      ...
      END IF
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_AB_CLAVHE_ROOK ', -INFO )
         RETURN
      END IF
*
...
*
                  ...
                  CALL AB_CGEMV( 'Conjugate', K-1, NRHS, CONE, B, LDB,
...
*
                  CALL AB_CLACGV( NRHS, B( K, 1 ), LDB )
                  CALL AB_CGEMV( 'Conjugate', K-2, NRHS, CONE, B, LDB,
     $                        A( 1, K ), 1, CONE, B( K, 1 ), LDB )
                  CALL AB_CLACGV( NRHS, B( K, 1 ), LDB )
*
...
*
                  CALL AB_CLACGV( NRHS, B( K, 1 ), LDB )
                  CALL AB_CGEMV( 'Conjugate', N-K, NRHS, CONE, B( K+1, 1
     $ ),
...
*
                  CALL AB_CLACGV( NRHS, B( K+1, 1 ), LDB )
                  CALL AB_CGEMV( 'Conjugate', N-K-1, NRHS, CONE,
