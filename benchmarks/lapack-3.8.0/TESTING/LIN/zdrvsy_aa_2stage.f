*> \brief \b AB_AB_AB_ZDRVSY_AA_2STAGE
*
*  =========== DOCUMENTATION ===========
*
...
*  ===========
*
*       SUBROUTINE AB_AB_AB_ZDRVSY_AA_2STAGE(
...
*> \verbatim
*>
*> AB_AB_AB_ZDRVSY_AA_2STAGE tests the driver routine AB_AB_AB_ZSYSV_AA_2STAGE.
*> \endverbatim
*
*  Arguments:
*  ==========
...
*     .. External Subroutines ..
     ...
     $ZLATMS,
     $                   AB_AB_AB_ZSYSV_AA_2STAGE, AB_AB_ZSYT01_AA, AB_Z
     $SYT02,
...
*
                     SRNAMT = 'AB_AB_AB_ZSYSV_AA_2STAGE '
                     LWORK = MIN(N*NB, 3*NMAX*NMAX)
                     CALL AB_AB_AB_ZSYSV_AA_2STAGE( UPLO, N, NRHS, AFAC,
     $ LDA,
     $                                 AINV, (3*NB+1)*N, 
     $                                 IWORK, IWORK( 1+N ),
...
*
  ...
  100                   CONTINUE
                     ...
                     END IF
*
*                    Check error code from AB_AB_AB_ZSYSV_AA_2STAGE .
*
                     IF( INFO.NE.K ) THEN
                        CALL AB_ALAERH( PATH, 'AB_AB_AB_ZSYSV_AA_2STAGE'
     $, INFO, K,
     $                               UPLO, N, N, -1, -1, NRHS,
...
*
     ...
     $                        CALL AB_ALADHD( NOUT, PATH )
                           WRITE( NOUT, FMT = 9999 )'AB_AB_AB_ZSYSV_AA_2
     $STAGE ',
...
*
 9999 FORMAT( 1X, A, ', UPLO=''', A1, ''', N =', I5, ', type ', I2,
     $      ', test ', I2, ', ratio =', G12.5 )
      RETURN
*
*     End of AB_AB_AB_ZDRVSY_AA_2STAGE
*
      END
