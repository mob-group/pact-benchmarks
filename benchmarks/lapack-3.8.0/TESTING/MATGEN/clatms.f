...
*  ===========
*
*       SUBROUTINE AB_CLATMS( M, N, DIST, ISEED, SYM, D, MODE, COND, DMAX,
...
*> \verbatim
*>
*>    AB_CLATMS generates random matrices with specified singular values
*>    (or hermitian with specified eigenvalues)
*>    for testing LAPACK programs.
*>
*>    AB_CLATMS operates by applying the following sequence of
*>    operations:
*>
...
*>           exit, and can be used in the next call to AB_CLATMS
...
*>
*>           If two calls to AB_CLATMS differ only in the PACK parameter,
...
*     .. External Functions ..
      ...
      REAL               AB_SLARND
      COMPLEX            AB_CLARND
      EXTERNAL           AB_LSAME, AB_SLARND, AB_CLARND
*     ..
*     .. External Subroutines ..
      EXTERNAL           AB_CLAGGE, AB_CLAGHE, AB_CLAGSY, AB_CLAROT, AB_
     $CLARTG, AB_CLASET,
     $                   AB_SLATM1, AB_SSCAL, AB_XERBLA
*     ..
*     .. Intrinsic Functions ..
