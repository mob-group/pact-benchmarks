...
*  ===========
*
*       SUBROUTINE AB_ZLAGSY( N, K, D, A, LDA, ISEED, WORK, INFO )
*
*       .. Scalar Arguments ..
...
*> \verbatim
*>
*> AB_ZLAGSY generates a complex symmetric matrix A, by pre- and post-
...
*     .. External Subroutines ..
      EXTERNAL           AB_XERBLA, AB_ZAXPY, AB_ZGEMV, AB_ZGERC, AB_ZLA
     $CGV, AB_ZLARNV,
     $                   AB_ZSCAL, AB_ZSYMV
*     ..
*     .. External Functions ..
...
*
         CALL AB_ZLACGV( N-I+1, WORK, 1 )
         CALL AB_ZSYMV( 'Lower', N-I+1, TAU, A( I, I ), LDA, WORK, 1, ZE
     $RO,
     $               WORK( N+1 ), 1 )
         CALL AB_ZLACGV( N-I+1, WORK, 1 )
*
...
*
         ALPHA = -HALF*TAU*AB_ZDOTC( N-I+1, WORK, 1, WORK( N+1 ), 1 )
         CALL AB_ZAXPY( N-I+1, ALPHA, WORK, 1, WORK( N+1 ), 1 )
*
*        apply the transformation as a rank-2 update to A(i:n,i:n)
*
*        CALL AB_ZSYR2( 'Lower', N-I+1, -ONE, WORK, 1, WORK( N+1 ), 1,
*        $               A( I, I ), LDA )
*
         DO 50 JJ = I, N
            DO 40 II = JJ, N
...
*        compute  y := tau * A * conjg(u)
*
         CALL AB_ZLACGV( N-K-I+1, A( K+I, I ), 1 )
         CALL AB_ZSYMV( 'Lower', N-K-I+1, TAU, A( K+I, K+I ), LDA,
     $               A( K+I, I ), 1, ZERO, WORK, 1 )
         CALL AB_ZLACGV( N-K-I+1, A( K+I, I ), 1 )
*
*        compute  v := y - 1/2 * tau * ( u, y ) * u
*
         ALPHA = -HALF*TAU*AB_ZDOTC( N-K-I+1, A( K+I, I ), 1, WORK, 1 )
         CALL AB_ZAXPY( N-K-I+1, ALPHA, A( K+I, I ), 1, WORK, 1 )
*
*        apply symmetric rank-2 update to A(k+i:n,k+i:n)
*
*        CALL AB_ZSYR2( 'Lower', N-K-I+1, -ONE, A( K+I, I ), 1, WORK, 1,
*        $               A( K+I, K+I ), LDA )
*
         DO 80 JJ = K + I, N
            DO 70 II = JJ, N
