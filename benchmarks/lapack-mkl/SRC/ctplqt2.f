...
*  ===========
*
*       SUBROUTINE AB_CTPLQT2( M, N, L, A, LDA, B, LDB, T, LDT, INFO )
*
*       .. Scalar Arguments ..
...
*> \verbatim
*>
*> AB_CTPLQT2 computes a LQ a factorization of a complex "triangular-pentagonal"
...
*
      ...
      END IF
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_CTPLQT2', -INFO )
         RETURN
      END IF
*
...
*
         P = N-L+MIN( L, I )
         CALL AB_CLARFG( P+1, A( I, I ), B( I, 1 ), LDB, T( 1, I ) )
         T(1,I)=CONJG(T(1,I))
         IF( I.LT.M ) THEN
            DO J = 1, P
               B( I, J ) = CONJG(B(I,J))
