C> \brief \b AB_ZGEQRF VARIANT: left-looking Level 3 BLAS of the algorit
     $hm.
*
*  =========== DOCUMENTATION ===========
*
...
C>\verbatim
C>
C> AB_ZGEQRF computes a QR factorization of a real M-by-N matrix A:
C> A = Q * R.
C>
...
C>                   NX = MAX( 0, AB_ILAENV( 3, 'AB_ZGEQRF', ' ', M, N, 
     $-1, -1 ) )
C> \endverbatim
C> \verbatim
...
*     .. External Subroutines ..
      EXTERNAL           AB_ZGEQR2, AB_ZLARFB, AB_ZLARFT, AB_XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
*     ..
...
*
               CALL AB_ZLARFB( 'Left', 'Transpose', 'Forward',
...
*           A(I:M,I:I+IB-1)
*
            CALL AB_ZGEQR2( M-I+1, IB, A( I, I ), LDA, TAU( I ),
...
30           CONTINUE
             ...
             CALL AB_ZGEQR2( M-I+1, K-I+1, A( I, I ), LDA, TAU( I ),
     $                   WORK(LBWORK*NB+NT*NT+1),IINFO )
...
*        Use unblocked code to factor the last or only block.
*
         CALL AB_ZGEQR2( M-I+1, N-I+1, A( I, I ), LDA, TAU( I ),
     $               WORK,IINFO )
...
*
          IF ( NT .LE. NB ) THEN
               CALL AB_ZLARFT( 'Forward', 'Columnwise', M-I+1, K-I+1,
