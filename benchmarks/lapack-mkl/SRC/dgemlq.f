...
*>  AB_DLASWLQ (if the matrix is wide-and-short) or AB_DGELQT to compute
*>  the LQ factorization.
*>  This version of AB_DGEMLQ will use either AB_DLAMSWLQ or AB_DGEMLQT to 
*>  multiply matrix Q by another matrix.
*>  Further Details in AB_DLAMSWLQ or AB_DGEMLQT.
*> \endverbatim
*>
*  =====================================================================
...
*     .. External Subroutines ..
      EXTERNAL           AB_DLAMSWLQ, AB_DGEMLQT, AB_XERBLA
*     ..
*     .. Intrinsic Functions ..
