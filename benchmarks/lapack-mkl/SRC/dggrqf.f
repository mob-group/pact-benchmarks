...
*     .. External Subroutines ..
      EXTERNAL           AB_DGEQRF, AB_DGERQF, AB_DORMRQ, AB_XERBLA
*     ..
*     .. External Functions ..
      INTEGER            AB_ILAENV
      EXTERNAL           AB_ILAENV
...
*
      INFO = 0
      NB1 = AB_ILAENV( 1, 'AB_DGERQF', ' ', M, N, -1, -1 )
      NB2 = AB_ILAENV( 1, 'AB_DGEQRF', ' ', P, N, -1, -1 )
...
*
      CALL AB_DGERQF( M, N, A, LDA, TAUA, WORK, LWORK, INFO )
      LOPT = WORK( 1 )
*
*     Update B := B*Q**T
*
...
*
      CALL AB_DGEQRF( P, N, B, LDB, TAUB, WORK, LWORK, INFO )
