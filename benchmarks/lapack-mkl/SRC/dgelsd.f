*> \brief <b> AB_DGELSD computes the minimum-norm solution to a linear least squares problem for GE matrices</b>
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download AB_DGELSD + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_DGELSd.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_DGELSd.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_DGELSd.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_DGELSD( M, N, NRHS, A, LDA, B, LDB, S, RCOND, RANK,
...
*> \verbatim
*>
*> AB_DGELSD computes the minimum-norm solution to a real linear least
*> squares problem:
...
*     .. External Subroutines ..
      EXTERNAL           AB_DGEBRD, AB_DGELQF, AB_DGEQRF, AB_DLABAD, AB_
     $DLACPY, AB_DLALSD,
...
*
      ...
      MINMN = MIN( M, N )
      MAXMN = MAX( M, N )
      MNTHR = AB_ILAENV( 6, 'AB_DGELSD', ' ', M, N, NRHS, -1 )
      LQUERY = ( LWORK.EQ.-1 )
      IF( M.LT.0 ) THEN
         INFO = -1
      ELSE IF( N.LT.0 ) THEN
      ...
      END IF
*
      SMLSIZ = AB_ILAENV( 9, 'AB_DGELSD', ' ', 0, 0, 0, 0 )
*
*     Compute workspace.
...
*
            MM = N
            MAXWRK = MAX( MAXWRK, N+N*AB_ILAENV( 1, 'AB_DGEQRF', ' ', M,
     $ N,
     $               -1, -1 ) )
...
*              than rows.
*
               MAXWRK = M + M*AB_ILAENV( 1, 'AB_DGELQF', ' ', M, N, -1, 
     $-1 )
