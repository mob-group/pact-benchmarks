...
*
*> \htmlonly
*> Download AB_DSYTRS + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_DSYTRS.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_DSYTRS.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_DSYTRS.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
...
*> \verbatim
*>
*> AB_DSYTRS solves a system of linear equations A*X = B with a real
*> symmetric matrix A using the factorization A = U*D*U**T or
*> A = L*D*L**T computed by AB_DSYTRF.
*> \endverbatim
*
*  Arguments:
*  ==========
...
*
            CALL AB_DGER( K-2, NRHS, -ONE, A( 1, K ), 1, B( K, 1 ), LDB,
     $                 B( 1, 1 ), LDB )
...
*           stored in column K of A.
*
            CALL AB_DGEMV( 'Transpose', K-1, NRHS, -ONE, B, LDB, A( 1, K
     $ ),
     $                  1, ONE, B( K, 1 ), LDB )
*
*           Interchange rows K and IPIV(K).
