...
*     .. External Subroutines ..
      EXTERNAL           AB_XERBLA, AB_CHERK, AB_CPOTRF, AB_CTRSM
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MOD
*     ..
...
*
     ...
     $N,
     $                     A( N1 ), N )
               CALL AB_CHERK( 'U', 'N', N2, N1, -ONE, A( N1 ), N, ONE,
     $                     A( N ), N )
...
*
     ...
     $ N,
     $                     A( 0 ), N )
               CALL AB_CHERK( 'U', 'C', N2, N1, -ONE, A( 0 ), N, ONE,
     $                     A( N1 ), N )
...
*
     ...
     $N1,
     $                     A( N1*N1 ), N1 )
               CALL AB_CHERK( 'L', 'C', N2, N1, -ONE, A( N1*N1 ), N1, ON
     $E,
     $                     A( 1 ), N1 )
...
*
     ...
     $ ),
     $                     N2, A( 0 ), N2 )
               CALL AB_CHERK( 'L', 'N', N2, N1, -ONE, A( 0 ), N2, ONE,
     $                     A( N1*N2 ), N2 )
...
*
     ...
     $1,
     $                     A( K+1 ), N+1 )
               CALL AB_CHERK( 'U', 'N', K, K, -ONE, A( K+1 ), N+1, ONE,
     $                     A( 0 ), N+1 )
...
*
     ...
     $                     N+1, A( 0 ), N+1 )
               CALL AB_CHERK( 'U', 'C', K, K, -ONE, A( 0 ), N+1, ONE,
     $                     A( K ), N+1 )
...
*
     ...
     $,
     $                     A( K*( K+1 ) ), K )
               CALL AB_CHERK( 'L', 'C', K, K, -ONE, A( K*( K+1 ) ), K, O
     $NE,
     $                     A( 0 ), K )
...
*
     ...
     $                     A( K*( K+1 ) ), K, A( 0 ), K )
               CALL AB_CHERK( 'L', 'N', K, K, -ONE, A( 0 ), K, ONE,
     $                     A( K*K ), K )
