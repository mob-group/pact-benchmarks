...
*
*> \htmlonly
*> Download AB_CTREVC3 + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_CTREVC3.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_CTREVC3.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_CTREVC3.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_CTREVC3( SIDE, HOWMNY, SELECT, N, T, LDT, VL, LDVL, VR,
...
*> \verbatim
*>
*> AB_CTREVC3 computes some or all of the right and/or left eigenvectors of
...
*> \date November 2017
*
*  @generated from AB_ZTREVC3.f, fortran z -> c, Tue Apr 19 01:47:44 2016
*
...
*>
*  =====================================================================
      SUBROUTINE AB_CTREVC3( SIDE, HOWMNY, SELECT, N, T, LDT, VL, LDVL, 
     $VR,
     $                    LDVR, MM, M, WORK, LWORK, RWORK, LRWORK, INFO)
      IMPLICIT NONE
*
...
*     .. External Subroutines ..
      EXTERNAL           AB_XERBLA, AB_CCOPY, AB_CLASET, AB_CSSCAL, AB_C
     $GEMM, AB_CGEMV,
...
*
      ...
      END IF
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_CTREVC3', -INFO )
         RETURN
      ELSE IF( LQUERY ) THEN
         RETURN
      END IF
...
*                 normalize vectors
                  DO K = IV, NB
                     ...
                     CALL AB_CSSCAL( N, REMAX, WORK( 1 + (NB+K)*N ), 1 )
                  END DO
