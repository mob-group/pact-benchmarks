...
*     .. External Subroutines ..
      EXTERNAL           AB_SAXPY, AB_SSCAL, AB_SSYR2, AB_STRMV, AB_STRS
     $V, AB_XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX
...
*
     ...
     $                        LDA )
                  CALL AB_SSYR2( UPLO, N-K, -ONE, A( K, K+1 ), LDA,
...
*
     ...
     $ )
                  CALL AB_SSYR2( UPLO, N-K, -ONE, A( K+1, K ), 1,
...
*
     ...
     $                     LDB, A( 1, K ), 1 )
               ...
               CALL AB_SSYR2( UPLO, K-1, ONE, A( 1, K ), 1, B( 1, K ), 1
     $,
     $                     A, LDA )
               CALL AB_SAXPY( K-1, CT, B( 1, K ), 1, A( 1, K ), 1 )
...
*
     ...
     $                     A( K, 1 ), LDA )
               ...
               CALL AB_SSYR2( UPLO, K-1, ONE, A( K, 1 ), LDA, B( K, 1 ),
     $                     LDB, A, LDA )
               CALL AB_SAXPY( K-1, CT, B( K, 1 ), LDB, A( K, 1 ), LDA )
