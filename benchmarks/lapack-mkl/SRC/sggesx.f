*> \brief <b> AB_SGGESX computes the eigenvalues, the Schur form, and, optionally, the matrix of Schur vectors for GE matrices</b>
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download AB_SGGESX + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_SGGESx.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_SGGESx.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_SGGESx.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_SGGESX( JOBVSL, JOBVSR, SORT, SELCTG, SENSE, N, A, LDA,
...
*> \verbatim
*>
*> AB_SGGESX computes for a pair of N-by-N real nonsymmetric matrices
...
*>
*  =====================================================================
      SUBROUTINE AB_SGGESX( JOBVSL, JOBVSR, SORT, SELCTG, SENSE, N, A, L
     $DA,
     $                   B, LDB, SDIM, ALPHAR, ALPHAI, BETA, VSL, LDVSL,
     $                   VSR, LDVSR, RCONDE, RCONDV, WORK, LWORK, IWORK,
     $                   LIWORK, BWORK, INFO )
...
*
      IF( INFO.EQ.0 ) THEN
         IF( N.GT.0) THEN
            ...
            MAXWRK = MINWRK - N +
     $               N*AB_ILAENV( 1, 'AB_SGEQRF', ' ', N, 1, N, 0 )
            MAXWRK = MAX( MAXWRK, MINWRK - N +
     $               N*AB_ILAENV( 1, 'AB_SORMQR', ' ', N, 1, N, -1 ) )
            IF( ILVSL ) THEN
               MAXWRK = MAX( MAXWRK, MINWRK - N +
     $                  N*AB_ILAENV( 1, 'AB_SORGQR', ' ', N, 1, N, -1 ) 
     $)
            END IF
            LWRK = MAXWRK
            IF( IJOB.GE.1 )
...
*
         CALL AB_STGSEN( IJOB, ILVSL, ILVSR, BWORK, N, A, LDA, B, LDB,
     $                ALPHAR, ALPHAI, BETA, VSL, LDVSL, VSR, LDVSR,
