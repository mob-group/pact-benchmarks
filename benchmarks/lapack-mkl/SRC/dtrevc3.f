...
*
*> \htmlonly
*> Download AB_DTREVC3 + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_DTREVC3.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_DTREVC3.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_DTREVC3.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_DTREVC3( SIDE, HOWMNY, SELECT, N, T, LDT, VL, LDVL,
...
*> \verbatim
*>
*> AB_DTREVC3 computes some or all of the right and/or left eigenvectors of
...
*     .. External Functions ..
      ...
      EXTERNAL           AB_LSAME, AB_IDAMAX, AB_ILAENV, AB_DDOT, AB_DLAMCH
*     ..
...
*
      ...
      END IF
      IF( INFO.NE.0 ) THEN
         CALL AB_XERBLA( 'AB_DTREVC3', -INFO )
         RETURN
      ELSE IF( LQUERY ) THEN
         RETURN
      END IF
