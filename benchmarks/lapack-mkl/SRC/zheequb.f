...
*
*> \htmlonly
*> Download AB_ZHEEQUB + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_ZHEEQUB.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_ZHEEQUB.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_ZHEEQUB.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_ZHEEQUB( UPLO, N, A, LDA, S, SCOND, AMAX, WORK, INFO )
*
*       .. Scalar Arguments ..
*       INTEGER            INFO, LDA, N
...
*> \verbatim
*>
*> AB_ZHEEQUB computes row and column scalings intended to equilibrate a
...
*
     ...
     $THEN
      ...
      END IF
      IF ( INFO .NE. 0 ) THEN
         CALL AB_XERBLA( 'AB_ZHEEQUB', -INFO )
         RETURN
      END IF
...
*        avg = s^T beta / n
         ...
         END DO
         CALL AB_ZLASSQ( N, WORK( N+1 ), 1, SCALE, SUMSQ )
