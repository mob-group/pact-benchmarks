*> \brief <b> AB_DGGEV3 computes the eigenvalues and, optionally, the left and/or right eigenvectors for GE matrices (blocked algorithm)</b>
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download AB_DGGEV3 + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/AB_DGGEV3.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/AB_DGGEV3.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/AB_DGGEV3.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE AB_DGGEV3( JOBVL, JOBVR, N, A, LDA, B, LDB, ALPHAR,
...
*> \verbatim
*>
*> AB_DGGEV3 computes for a pair of N-by-N real nonsymmetric matrices (A,B)
...
*     .. External Subroutines ..
      EXTERNAL           AB_DGEQRF, AB_DGGBAK, AB_DGGBAL, AB_DGGHD3, AB_
     $DHGEQZ, AB_DLABAD,
...
*
      IF( INFO.EQ.0 ) THEN
         CALL AB_DGEQRF( N, N, B, LDB, WORK, WORK, -1, IERR )
