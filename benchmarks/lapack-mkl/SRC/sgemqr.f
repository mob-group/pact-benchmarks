...
*>  This version of AB_SGEMQR will use either AB_SLAMTSQR or AB_SGEMQRT to 
*>  multiply matrix Q by another matrix.
*>  Further Details in AB_SLAMTSQR or AB_SGEMQRT.
*>
*> \endverbatim
*>
*  =====================================================================
...
*     .. External Subroutines ..
      EXTERNAL           AB_SGEMQRT, AB_SLAMTSQR, AB_XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
     ...
     $     .OR. ( MB.LE.K ) .OR. ( MB.GE.MAX( M, N, K ) ) ) THEN
        CALL AB_SGEMQRT( SIDE, TRANS, M, N, K, NB, A, LDA, T( 6 ),
     $                NB, C, LDC, WORK, INFO )
      ELSE
