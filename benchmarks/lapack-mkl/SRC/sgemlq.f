...
*>                           AB_SLASWLQ or AB_SGELQT
*>
*>  Depending on the matrix dimensions M and N, and row and column
*>  block sizes MB and NB returned by AB_ILAENV, AB_SGELQ will use either
*>  AB_SLASWLQ (if the matrix is wide-and-short) or AB_SGELQT to compute
*>  the LQ factorization.
*>  This version of AB_SGEMLQ will use either AB_SLAMSWLQ or AB_SGEMLQT to 
*>  multiply matrix Q by another matrix.
*>  Further Details in AB_SLAMSWLQ or AB_SGEMLQT.
*> \endverbatim
*>
*  =====================================================================
...
*     .. External Subroutines ..
      EXTERNAL           AB_SLAMSWLQ, AB_SGEMLQT, AB_XERBLA
*     ..
*     .. Intrinsic Functions ..
